var ae=Object.defineProperty;var se=(v,e,t)=>e in v?ae(v,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):v[e]=t;var p=(v,e,t)=>se(v,typeof e!="symbol"?e+"":e,t);(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))i(n);new MutationObserver(n=>{for(const a of n)if(a.type==="childList")for(const s of a.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&i(s)}).observe(document,{childList:!0,subtree:!0});function t(n){const a={};return n.integrity&&(a.integrity=n.integrity),n.referrerPolicy&&(a.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?a.credentials="include":n.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function i(n){if(n.ep)return;n.ep=!0;const a=t(n);fetch(n.href,a)}})();const re="modulepreload",oe=function(v){return"/army-calculator-site/"+v},V={},R=function(e,t,i){let n=Promise.resolve();if(t&&t.length>0){document.getElementsByTagName("link");const s=document.querySelector("meta[property=csp-nonce]"),r=(s==null?void 0:s.nonce)||(s==null?void 0:s.getAttribute("nonce"));n=Promise.allSettled(t.map(o=>{if(o=oe(o),o in V)return;V[o]=!0;const l=o.endsWith(".css"),c=l?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${o}"]${c}`))return;const d=document.createElement("link");if(d.rel=l?"stylesheet":re,l||(d.as="script"),d.crossOrigin="",d.href=o,r&&d.setAttribute("nonce",r),document.head.appendChild(d),l)return new Promise((m,u)=>{d.addEventListener("load",m),d.addEventListener("error",()=>u(new Error(`Unable to preload CSS for ${o}`)))})}))}function a(s){const r=new Event("vite:preloadError",{cancelable:!0});if(r.payload=s,window.dispatchEvent(r),!r.defaultPrevented)throw s}return n.then(s=>{for(const r of s||[])r.status==="rejected"&&a(r.reason);return e().catch(a)})};class f{static isPlayerUnit(e){return e.cost_type!==void 0||e.context==="player"}static isEnemyUnit(e){return e.cost_type===void 0||e.context==="enemy"}static isMortalEnemy(e){return f.isEnemyUnit(e)&&(e.isMortal===!0||e.count!==void 0)}static isImmortalEnemy(e){return f.isEnemyUnit(e)&&!f.isMortalEnemy(e)}static getRemainingEnemyCount(e){return f.isMortalEnemy(e)?e.count:void 0}static getCurrentEnemyHealth(e){return e.currentHealth!==void 0?e.currentHealth:(e.count??1)*e.health}static isMercenary(e){return e.cost_type==="Mercenary"||(e.authority_cost??0)>0}static getPrimaryCost(e){if(!f.isPlayerUnit(e))return 0;switch(e.cost_type){case"Leadership":return e.leadership_cost??0;case"Dominance":return e.dominance_cost??0;case"Authority":case"Mercenary":return e.authority_cost??0;default:return 0}}static getEfficiencyRatio(e){if(f.isPlayerUnit(e)){const t=f.getPrimaryCost(e);return t>0?e.strength/t:0}else return e.health>0?e.strength/e.health:0}static getStrengthPerCost(e){const t=f.getPrimaryCost(e);return t>0?e.strength/t:0}static getHealthPerCost(e){const t=f.getPrimaryCost(e);return t>0?e.health/t:0}static getStrengthPerHealth(e){return e.health>0?e.strength/e.health:0}static getEffectivenessScore(e){if(f.isPlayerUnit(e)){const t=f.getPrimaryCost(e);return t>0?e.strength*e.health/t:0}else return e.strength*e.health/1e3}static hasUnitType(e,t){return e.unit_types.some(i=>i.toLowerCase()===t.toLowerCase())}static getAttackModifierAgainst(e,t){if(!e.attack_modifiers)return 0;const i=e.attack_modifiers.find(n=>n.target_type.toLowerCase()===t.toLowerCase());return i?i.value:0}static getTotalStrengthAgainst(e,t){const i=e.strength,n=f.getAttackModifierAgainst(e,t);return i+n}static createUserEnemyUnit(e){const t=new Date;return{name:e.name??"Unnamed Enemy",unit_types:e.unit_types??["Epic Monster"],health:e.health??1e4,strength:e.strength??5e3,attack_modifiers:e.attack_modifiers??[],context:"enemy",id:`user_enemy_${Date.now()}_${Math.random().toString(36).substr(2,9)}`,createdAt:t,modifiedAt:t}}static updateUserUnit(e,t){return{...e,...t,modifiedAt:new Date}}static validateUnit(e){const t=[],i=[];return(!e.name||e.name.trim()==="")&&t.push("Unit name is required"),(!e.unit_types||!Array.isArray(e.unit_types)||e.unit_types.length===0)&&t.push("At least one unit type is required"),(typeof e.health!="number"||e.health<=0)&&t.push("Health must be a positive number"),(typeof e.strength!="number"||e.strength<=0)&&t.push("Strength must be a positive number"),e.attack_modifiers&&(Array.isArray(e.attack_modifiers)?e.attack_modifiers.forEach((n,a)=>{(!n.target_type||n.target_type.trim()==="")&&t.push(`Attack modifier ${a+1}: target_type is required`),(!n.modifier_type||n.modifier_type.trim()==="")&&t.push(`Attack modifier ${a+1}: modifier_type is required`),(typeof n.value!="number"||n.value<0)&&t.push(`Attack modifier ${a+1}: value must be a non-negative number`)}):t.push("Attack modifiers must be an array")),(e.cost_type||e.context==="player")&&e.cost_type&&!["Leadership","Dominance","Authority","Mercenary"].includes(e.cost_type)&&t.push("Invalid cost_type. Must be Leadership, Dominance, Authority, or Mercenary"),e.health&&e.health>1e7&&i.push("Health value is unusually high"),e.strength&&e.strength>5e6&&i.push("Strength value is unusually high"),{isValid:t.length===0,errors:t,warnings:i.length>0?i:void 0}}static validateEnemyUnit(e){return f.validateUnit(e)}static validateBattleConfiguration(e){const t=[],i=[];return e.playerArmy?(!e.playerArmy.stackingOrder||e.playerArmy.stackingOrder.length===0)&&t.push("Player army must have at least one unit group"):t.push("Player army is required"),e.enemyGroupCount!==void 0&&e.enemyGroupCount<1&&t.push("Enemy group count must be at least 1"),e.enemyUnits!==void 0&&(!Array.isArray(e.enemyUnits)||e.enemyUnits.length===0)&&t.push("At least one enemy unit is required"),e.enemyGroupCount===void 0&&e.enemyUnits===void 0?t.push("Either enemy group count or enemy units must be specified"):e.enemyUnits!==void 0&&e.enemyUnits.length===0&&t.push("Enemy units array is empty - check that enemy army has valid units selected"),{isValid:t.length===0,errors:t,warnings:i.length>0?i:void 0}}}const le=["Human","Beast","Undead","Demon","Elemental","Construct","Melee","Ranged","Magic","Siege","Mounted","Flying","Aquatic","Guardsman","Monster","Mercenary","Specialist","Elite","Heavy","Light","Epic Monster","Giant","Dragon","Fortification"],ce=["Strength"],de=["Melee","Ranged","Flying","Mounted","Beast","Human","Siege","Dragon","Elemental","Giant","Fortification","Undead","Demon"],W="/army-calculator-site/",X={FINAL_UNITS:`${W}final_units.json`,ENEMY_UNITS:`${W}enemy_units.json`};class me{constructor(){p(this,"units",[]);p(this,"unitsByName",new Map);p(this,"unitsByCostType",{Leadership:[],Dominance:[],Authority:[],Mercenary:[]});this.resetData()}async loadPresetUnits(){return this.loadUnits(X.FINAL_UNITS)}async loadUnits(e){try{let t;if(typeof e=="string"){console.log(`Loading units from: ${e}`);const i=await fetch(e);if(!i.ok)throw new Error(`Failed to fetch units: ${i.status} ${i.statusText}`);t=await i.json()}else t=e;if(!Array.isArray(t))throw new Error("Unit data must be an array");return this.units=t.map(i=>this.validateAndNormalizeUnit(i)),this.buildLookups(),console.log(`✅ Loaded ${this.units.length} units successfully`),this.units}catch(t){throw console.error("❌ Error loading units:",t),t}}validateAndNormalizeUnit(e){const t={name:e.name||"Unknown",unit_types:Array.isArray(e.unit_types)?e.unit_types:[],cost_type:e.cost_type||"Leadership",health:Number(e.health)||0,strength:Number(e.strength)||0,leadership_cost:Number(e.leadership_cost)||0,dominance_cost:Number(e.dominance_cost)||0,authority_cost:Number(e.authority_cost)||0,food_consumption:Number(e.food_consumption)||0,carrying_capacity:Number(e.carrying_capacity)||0,revival_cost_gold:Number(e.revival_cost_gold)||0,revival_cost_silver:Number(e.revival_cost_silver)||0,source_file:e.source_file||"",attack_modifiers:Array.isArray(e.attack_modifiers)?e.attack_modifiers:void 0};return["Leadership","Dominance","Authority","Mercenary"].includes(t.cost_type)||(console.warn(`Invalid cost type for unit ${t.name}: ${t.cost_type}`),t.cost_type="Leadership"),t}buildLookups(){this.resetData(),this.unitsByName=new Map(this.units.map(e=>[e.name,e])),this.units.forEach(e=>{f.isMercenary(e)?this.unitsByCostType.Mercenary.push(e):e.cost_type in this.unitsByCostType&&this.unitsByCostType[e.cost_type].push(e)}),Object.keys(this.unitsByCostType).forEach(e=>{this.unitsByCostType[e].sort((t,i)=>t.strength-i.strength)})}resetData(){this.unitsByName.clear(),this.unitsByCostType={Leadership:[],Dominance:[],Authority:[],Mercenary:[]}}getAllUnits(){return[...this.units]}getUnitByName(e){return this.unitsByName.get(e)}getUnitsByCostType(e){return[...this.unitsByCostType[e]]}getAvailableUnits(e){const t=[];for(const i of e){const n=this.getUnitByName(i);n?t.push(n):console.warn(`Unit '${i}' not found in loaded data`)}return t}filterUnits(e){let t=this.units;return e.costType&&(t=t.filter(i=>i.cost_type===e.costType)),e.unitTypes&&e.unitTypes.length>0&&(t=t.filter(i=>e.unitTypes.some(n=>i.unit_types.includes(n)))),e.minStrength!==void 0&&(t=t.filter(i=>i.strength>=e.minStrength)),e.maxCost!==void 0&&(t=t.filter(i=>f.getPrimaryCost(i)<=e.maxCost)),t}searchUnits(e){if(!e.trim())return this.getAllUnits();const t=e.toLowerCase();return this.units.filter(i=>i.name.toLowerCase().includes(t))}getEnhancedUnits(){return this.units.map(e=>({...e,get isMercenary(){return f.isMercenary(e)},get primaryCost(){return f.getPrimaryCost(e)},get strengthPerCost(){return f.getStrengthPerCost(e)},get healthPerCost(){return f.getHealthPerCost(e)}}))}getUnitSummary(){if(this.units.length===0)return{totalUnits:0,byCostType:{Leadership:0,Dominance:0,Authority:0,Mercenary:0},strengthRange:{min:0,max:0},healthRange:{min:0,max:0}};const e=this.units.map(i=>i.strength),t=this.units.map(i=>i.health);return{totalUnits:this.units.length,byCostType:{Leadership:this.unitsByCostType.Leadership.length,Dominance:this.unitsByCostType.Dominance.length,Authority:this.unitsByCostType.Authority.length,Mercenary:this.unitsByCostType.Mercenary.length},strengthRange:{min:Math.min(...e),max:Math.max(...e)},healthRange:{min:Math.min(...t),max:Math.max(...t)}}}getUniqueUnitTypes(){const e=new Set;return this.units.forEach(t=>{t.unit_types.forEach(i=>e.add(i))}),Array.from(e).sort()}getStatistics(){if(this.units.length===0)return{totalUnits:0,costTypeDistribution:{Leadership:0,Dominance:0,Authority:0,Mercenary:0},strengthStats:{min:0,max:0,avg:0},healthStats:{min:0,max:0,avg:0},topUnitsByStrength:[],topUnitsByHealth:[]};const e=this.units.map(i=>i.strength),t=this.units.map(i=>i.health);return{totalUnits:this.units.length,costTypeDistribution:{Leadership:this.unitsByCostType.Leadership.length,Dominance:this.unitsByCostType.Dominance.length,Authority:this.unitsByCostType.Authority.length,Mercenary:this.unitsByCostType.Mercenary.length},strengthStats:{min:Math.min(...e),max:Math.max(...e),avg:Math.round(e.reduce((i,n)=>i+n,0)/e.length)},healthStats:{min:Math.min(...t),max:Math.max(...t),avg:Math.round(t.reduce((i,n)=>i+n,0)/t.length)},topUnitsByStrength:[...this.units].sort((i,n)=>n.strength-i.strength).slice(0,10),topUnitsByHealth:[...this.units].sort((i,n)=>n.health-i.health).slice(0,10)}}}class H{constructor(e){p(this,"availableUnits");p(this,"unitsByName");p(this,"leadershipUnits");p(this,"dominanceUnits");p(this,"mercenaryUnits");this.availableUnits=[...e],this.unitsByName=new Map(e.map(t=>[t.name,t])),this.leadershipUnits=e.filter(t=>t.cost_type==="Leadership").sort((t,i)=>t.strength-i.strength),this.dominanceUnits=e.filter(t=>t.cost_type==="Dominance").sort((t,i)=>t.strength-i.strength),this.mercenaryUnits=e.filter(t=>f.isMercenary(t)).sort((t,i)=>t.strength-i.strength)}async optimizeArmy(e){const t=performance.now();console.log(`🔍 Optimizing army with L:${e.leadershipBudget} D:${e.dominanceBudget} M:${Object.keys(e.mercenaryLimits).length}`),console.log(`📋 Selected units: ${e.availableUnits.join(", ")}`);const i=[],n=this.generateGuaranteedValidCompositions(e);console.log(`Generated ${n.length} guaranteed valid army combinations`);let a=0;for(const m of n){a++;const u=this.evaluateComposition(m);i.push(u)}const s=performance.now();console.log(`Evaluated ${a} combinations, found ${i.length} valid stackings`);const r=this.availableUnits.filter(m=>e.availableUnits.includes(m.name)&&m.cost_type==="Leadership"),o=this.availableUnits.filter(m=>e.availableUnits.includes(m.name)&&m.cost_type==="Dominance"),l=this.availableUnits.filter(m=>e.availableUnits.includes(m.name)&&f.isMercenary(m)),c=i.filter(m=>{const u=r.some(y=>m.units[y.name]&&m.units[y.name]>0),h=o.some(y=>m.units[y.name]&&m.units[y.name]>0),g=l.some(y=>m.units[y.name]&&m.units[y.name]>0);return[r.length>0?u:!0,o.length>0?h:!0,l.length>0?g:!0].every(y=>y)});return c.sort((m,u)=>{const h=m.totalLeadershipCost/e.leadershipBudget+m.totalDominanceCost/e.dominanceBudget;return u.totalLeadershipCost/e.leadershipBudget+u.totalDominanceCost/e.dominanceBudget-h}),{compositions:c.length>0?[c[0]]:i.slice(0,1),totalCombinationsEvaluated:a,validStackingsFound:i.length,executionTimeMs:s-t}}generateGuaranteedValidCompositions(e){const t=[],i=this.availableUnits.filter(s=>e.availableUnits.includes(s.name)&&s.cost_type==="Leadership").sort((s,r)=>r.strength-s.strength),n=this.availableUnits.filter(s=>e.availableUnits.includes(s.name)&&s.cost_type==="Dominance").sort((s,r)=>r.strength-s.strength),a=this.availableUnits.filter(s=>e.availableUnits.includes(s.name)&&f.isMercenary(s));if(console.log(`Selected units: L:${i.length} D:${n.length} M:${a.length}`),console.log("Leadership units:",i.map(s=>s.name)),console.log("Dominance units:",n.map(s=>s.name)),console.log("Mercenary units:",a.map(s=>s.name)),console.log(`🎯 MUST use ALL selected units: L:${i.length} D:${n.length} M:${a.length}`),console.log(`Budgets: Leadership:${e.leadershipBudget} Dominance:${e.dominanceBudget}`),i.length>0&&n.length>0&&a.length>0&&e.leadershipBudget>0&&e.dominanceBudget>0){console.log("🔗 Generating ALL THREE types compositions");const s=[...i,...a];t.push(...this.generateCombinedStackedCompositions(s,n,e.leadershipBudget,e.dominanceBudget,e.mercenaryLimits))}else if(i.length>0&&a.length>0&&n.length===0&&e.leadershipBudget>0){console.log("🤝 Generating Leadership + Mercenary compositions (PROPER STACKING)");const s=[...i,...a],r=this.calculateProperStackingQuantities(s,e.leadershipBudget,e.mercenaryLimits);t.push(r)}else if(n.length>0&&a.length>0&&i.length===0&&e.dominanceBudget>0){console.log("🤝 Generating Dominance + Mercenary compositions (NEW SIMPLE STACKING)");const s=this.calculateProperStackingQuantitiesForDominance(n,e.dominanceBudget),r={};for(const l of a)r[l.name]=e.mercenaryLimits[l.name]||1;const o={...s,...r};t.push(o)}else if(i.length>0&&n.length>0&&a.length===0&&e.leadershipBudget>0&&e.dominanceBudget>0)console.log("🤝 Generating Leadership + Dominance compositions"),t.push(...this.generateCombinedStackedCompositions(i,n,e.leadershipBudget,e.dominanceBudget,{}));else if(i.length>0&&n.length===0&&a.length===0&&e.leadershipBudget>0){console.log("👑 Generating Leadership-only compositions (NEW PROPER STACKING)");const s=this.calculateProperStackingQuantities(i,e.leadershipBudget,{});t.push(s)}else if(n.length>0&&i.length===0&&a.length===0&&e.dominanceBudget>0){console.log("⚡ Generating Dominance-only compositions (NEW SIMPLE STACKING)");const s=this.calculateProperStackingQuantitiesForDominance(n,e.dominanceBudget);t.push(s)}else if(a.length>0&&i.length===0&&n.length===0){console.log("🗡️ Generating Mercenary-only compositions");const s={};for(const r of a){const o=e.mercenaryLimits[r.name]||1;s[r.name]=o}Object.keys(s).length>0&&t.push(s)}else console.log("❌ No valid combination of selected units and budgets");return i.length>0&&a.length>0&&e.leadershipBudget>0&&t.push(...this.generateMercenaryMixedCompositions(i,a,e.leadershipBudget,e.mercenaryLimits,"leadership_cost")),n.length>0&&a.length>0&&e.dominanceBudget>0&&t.push(...this.generateMercenaryMixedCompositions(n,a,e.dominanceBudget,e.mercenaryLimits,"dominance_cost")),t}generateStackedCompositionsWithMercenaries(e,t,i,n){console.log("�🚨🚨 NEW METHOD CALLED! 🚨🚨🚨"),console.log("�🗡️ Generating Leadership + Mercenary stacks (NEW PROPER STACKING)");const a=[...e,...t];console.log(`🚨 About to call calculateProperStackingQuantities with ${a.length} units`);const s=this.calculateProperStackingQuantities(a,i,n);return console.log("🚨 Got composition back:",s),[s]}calculateCleanStackingPattern(e,t){const i={};if(e.length===0)return i;const n=e[0];i[n.name]=1,console.log(`🎯 Starting with 1x ${n.name} (STR: ${n.strength})`);for(let a=1;a<e.length;a++){const s=e[a],r=e[a-1],o=r.health*(i[r.name]||1),l=Math.ceil((o+1)/s.health);i[s.name]=l,console.log(`📋 ${s.name}: need ${l} units (${l*s.health} HP) to exceed ${r.name} (${o} HP)`)}return i}calculateProperStackingQuantities(e,t,i){console.log(`🔧 SIMPLE STACKING: Starting with budget ${t}`);const n={},a=[...e].sort((m,u)=>u.strength-m.strength),s=a.filter(m=>m.cost_type==="Leadership"),r=a.filter(m=>f.isMercenary(m));if(a.length===0)return console.log("🔧 SIMPLE STACKING: No units selected"),n;console.log(`🔧 SIMPLE STACKING: Creating base pattern with ${a.length} units (${s.length} leadership + ${r.length} mercenary)`);const o=a[0],l={};l[o.name]=1;const c=o.health*1;console.log(`🔧 Base: 1x ${o.name} = ${c} HP (strongest)`);for(let m=1;m<a.length;m++){const u=a[m],h=Math.ceil((c+1)/u.health);l[u.name]=h;const g=f.isMercenary(u)?"mercenary":"leadership";console.log(`🔧 Base: ${h}x ${u.name} = ${h*u.health} HP (beats ${c}) [${g}]`)}console.log("🔧 Validating base pattern stacking order...");for(let m=0;m<a.length-1;m++){const u=a[m],h=a[m+1],g=u.health*l[u.name];let b=h.health*l[h.name];if(b<=g)if(f.isMercenary(h))console.log(`🔧 WARNING: ${h.name} mercenary limit (${l[h.name]}) gives ${b} HP, can't beat ${g} HP`);else{const y=Math.ceil((g+1)/h.health);l[h.name]=y,b=h.health*y,console.log(`🔧 Fixed: ${h.name} increased to ${y} units = ${b} HP (now beats ${g})`)}else console.log(`🔧 OK: ${h.name} ${l[h.name]} units = ${b} HP (beats ${g})`)}let d=0;for(const[m,u]of Object.entries(l)){const h=this.unitsByName.get(m);h&&h.cost_type==="Leadership"&&(d+=u*(h.leadership_cost??0))}if(console.log(`🔧 Base pattern leadership cost: ${d}`),d===0){console.log("🔧 No leadership costs, using mercenaries only");for(const[m,u]of Object.entries(l))n[m]=u}else{const m=Math.floor(t/d);console.log(`🔧 Can afford ${m} base stacks (${t} / ${d})`);for(const[u,h]of Object.entries(l)){const g=this.unitsByName.get(u);if(g&&f.isMercenary(g)){const b=h*m,y=i[u]||1;n[u]=Math.min(b,y),b>y?console.log(`🔧 Mercenary ${u}: wanted ${b}, capped at limit ${y}`):console.log(`🔧 Mercenary ${u}: scaled to ${b} (under limit ${y})`)}else n[u]=h*m}}return console.log("🔧 SIMPLE STACKING: Final composition:",n),n}calculateProperStackingQuantitiesForDominance(e,t){console.log(`🔧 DOMINANCE STACKING: Starting with budget ${t}`);const i={},n=[...e].sort((c,d)=>d.strength-c.strength);if(n.length===0)return console.log("🔧 DOMINANCE STACKING: No dominance units selected"),i;console.log(`🔧 DOMINANCE STACKING: Creating base pattern with ${n.length} dominance units`);const a=n[0],s={};s[a.name]=1;const r=a.health*1;console.log(`🔧 Base: 1x ${a.name} = ${r} HP (strongest)`);for(let c=1;c<n.length;c++){const d=n[c],m=Math.ceil((r+1)/d.health);s[d.name]=m,console.log(`🔧 Base: ${m}x ${d.name} = ${m*d.health} HP (beats ${r})`)}console.log("🔧 Validating dominance base pattern stacking order...");for(let c=0;c<n.length-1;c++){const d=n[c],m=n[c+1],u=d.health*s[d.name];let h=m.health*s[m.name];if(h<=u){const g=Math.ceil((u+1)/m.health);s[m.name]=g,h=m.health*g,console.log(`🔧 Fixed: ${m.name} increased to ${g} units = ${h} HP (now beats ${u})`)}else console.log(`🔧 OK: ${m.name} ${s[m.name]} units = ${h} HP (beats ${u})`)}let o=0;for(const[c,d]of Object.entries(s)){const m=this.unitsByName.get(c);m&&m.cost_type==="Dominance"&&(o+=d*m.dominance_cost)}if(console.log(`🔧 Base pattern dominance cost: ${o}`),o===0)return console.log("🔧 No dominance costs found"),i;const l=Math.floor(t/o);console.log(`🔧 Can afford ${l} base stacks (${t} / ${o})`);for(const[c,d]of Object.entries(s))i[c]=d*l;return console.log("🔧 DOMINANCE STACKING: Final composition:",i),i}calculateLeadershipCost(e){return Object.entries(e).reduce((t,[i,n])=>{const a=this.unitsByName.get(i);return a&&a.cost_type==="Leadership"?t+n*a.leadership_cost:t},0)}calculateMaxStacksByMercenaries(e,t){let i=1/0;for(const[n,a]of Object.entries(e)){const s=this.unitsByName.get(n);if(s&&f.isMercenary(s)){const r=t[n]||1,o=Math.floor(r/a);i=Math.min(i,o),console.log(`🗡️ ${n}: limit ${r}, base need ${a}, allows ${o} stacks`)}}return i===1/0?100:i}generateDominanceMercenaryCompositions(e,t,i,n){const a=[];console.log("⚡🗡️ Generating Dominance + Mercenary stacks");const s=[...e,...t].sort((m,u)=>u.strength-m.strength);if(s.length===0)return a;const r=this.calculateCleanStackingPattern(s,n);console.log("📊 Dominance + Mercenary base pattern:",r);const o=Object.entries(r).reduce((m,[u,h])=>{const g=this.unitsByName.get(u);return g&&g.cost_type==="Dominance"?m+h*g.dominance_cost:m},0);if(console.log(`💰 Dominance cost per stack: ${o}`),o>i){console.log("❌ Can't afford mercenary stack, falling back to pure strategies");const m={};for(const u of t)m[u.name]=n[u.name]||1;return a.push(m),e.length>0&&a.push(...this.generateStackedCompositions(e,i,"dominance_cost")),a}const l=Math.floor(i/o),c=this.calculateMaxStacksByMercenaries(r,n),d=Math.min(l,c);console.log(`🔢 Max Dominance+Mercenary stacks: ${d}`);for(let m=1;m<=Math.min(d,5);m++){const u={};for(const[h,g]of Object.entries(r)){const b=this.unitsByName.get(h);b&&f.isMercenary(b)?u[h]=Math.min(g*m,n[h]||1):u[h]=g*m}a.push(u)}if(c<l&&e.length>0){const m=i-d*o,u=this.generateStackedCompositions(e,m,"dominance_cost"),h={};for(const g of t)h[g.name]=n[g.name]||1;for(const g of u.slice(0,3)){const b={...h,...g};a.push(b)}}return a}generateStackedCompositions(e,t,i){const n=[];if(e.length===0||t<=0)return n;const a=e[0];console.log(`🎯 Strongest unit: ${a.name} (STR: ${a.strength})`);const s=this.calculateStackingPattern(e);console.log("📊 Base stacking pattern:",s);const r=Object.entries(s).reduce((l,[c,d])=>{const m=this.unitsByName.get(c);if(m){const u=m[i];return l+d*u}return l},0);if(console.log(`💰 Base pattern cost: ${r}`),r<=0)return n;const o=Math.floor(t/r);console.log(`🔢 Max multiplier: ${o}`);for(let l=1;l<=Math.min(o,10);l++){const c={};for(const[d,m]of Object.entries(s))c[d]=m*l;n.push(c)}return e.length>1&&n.push(...this.generateStackingVariations(e,t,i)),n}calculateStackingPattern(e){const t={};if(e.length===0)return t;const i=e[0];t[i.name]=1;for(let n=1;n<e.length;n++){const a=e[n],s=e[n-1],r=s.health*(t[s.name]||1),o=Math.ceil((r+1)/a.health);t[a.name]=o,console.log(`📋 ${a.name}: need ${o} units (${o*a.health} HP) to exceed ${s.name} (${r} HP)`)}return t}generateCombinedStackedCompositions(e,t,i,n,a={}){const s=[];console.log("🔗 Generating combined Leadership + Mercenary + Dominance stacks");const r=e.filter($=>$.cost_type==="Leadership"),o=e.filter($=>f.isMercenary($));console.log("🗡️ Generating Leadership + Mercenary stacks (proper stacking approach)");const l=[...r,...o],d=[this.calculateProperStackingQuantities(l,i,a)];if(d.length===0)return s;const m=d[d.length-1];if(!m)return s;console.log("🎯 Using maximum Leadership composition for combination");const u=m,h=t[0];console.log(`🎯 Strongest Dominance unit: ${h.name} (STR: ${h.strength})`);const g=this.findClosestStrengthUnit(h,e);if(!g)return console.log("❌ No suitable Leadership unit found for comparison"),s;console.log(`🔍 Comparing to Leadership unit: ${g.name} (STR: ${g.strength})`);const b=u[g.name]||0,y=g.health*b;if(console.log(`📊 Comparison unit total health: ${y} (${b}x ${g.health})`),y<=0)return console.log("❌ Comparison unit not in Leadership composition"),s;const E=h.health;E>=y&&(console.log(`⚠️ Single Dominance unit too strong: ${E} HP >= ${y} HP`),console.log("🔧 Trying constrained Dominance stack anyway (may use weaker Dominance units)")),console.log("🔄 Creating independent Dominance stack to maximize budget usage (NEW SIMPLE STACKING)");const k=[this.calculateProperStackingQuantitiesForDominance(t,n)];if(k.length>0){const $=k[k.length-1],_={...u,...$};s.push(_),console.log("✅ Created independent L+M + D composition maximizing both budgets")}else console.log("⚠️ Using Leadership+Mercenary composition only"),s.push(u);return s}findClosestStrengthUnit(e,t){if(t.length===0)return null;let i=t[0],n=Math.abs(e.strength-i.strength);for(const a of t){const s=Math.abs(e.strength-a.strength);s<n&&(n=s,i=a)}return console.log(`🎯 Closest match: ${i.name} (STR: ${i.strength}) vs ${e.name} (STR: ${e.strength}), diff: ${n}`),i}calculateConstrainedDominanceStack(e,t,i){const n={};if(console.log(`🔒 Calculating Dominance stack with max health constraint: ${i}`),e.length===0||t<=0||i<=0)return n;const a=e[0],s=Math.floor((i-1)/a.health),r=Math.floor(t/a.dominance_cost),o=Math.min(s,r);if(o<=0)return console.log(`❌ Cannot fit any ${a.name} within constraints`),n;for(let l=Math.min(o,3);l>=1;l--){const c={};c[a.name]=l;let d=l*a.dominance_cost,m=l*a.health;console.log(`🧪 Testing ${l}x ${a.name} (${m} HP, ${d} cost)`);for(let h=1;h<e.length&&d<t;h++){const g=e[h],b=t-d,y=Math.ceil((m+1)/g.health),E=Math.floor(b/g.dominance_cost),x=Math.min(y,E);x>0&&(c[g.name]=x,d+=x*g.dominance_cost,console.log(`  ➕ Added ${x}x ${g.name} (${x*g.health} HP)`))}const u=Object.entries(c).reduce((h,[g,b])=>{const y=this.unitsByName.get(g);return y?h+b*y.health:h},0);if(u<i)return console.log(`✅ Valid Dominance stack: ${u} HP < ${i} HP limit`),c;console.log(`❌ Dominance stack too strong: ${u} HP >= ${i} HP limit`)}return console.log("❌ Could not create valid constrained Dominance stack"),n}generateMercenaryMixedCompositions(e,t,i,n,a){const s=[];console.log("🗡️ Generating mixed compositions with mercenaries");const r=this.generateStackedCompositions(e,i,a);if(r.length===0)return s;for(const o of r.slice(0,3)){const l=t.sort((y,E)=>E.strength-y.strength)[0];if(!l)continue;console.log(`🎯 Strongest Mercenary: ${l.name} (STR: ${l.strength})`);const c=this.findClosestStrengthUnit(l,e);if(!c){console.log("❌ No suitable base unit found for comparison");continue}const d=o[c.name]||0,m=c.health*d;if(console.log(`📊 Comparison base unit total health: ${m}`),m<=0){console.log("❌ Comparison unit not in base composition");continue}const u=l.health,h=n[l.name]||1,g=u*h;if(g>=m){console.log(`⚠️ Mercenary too strong: ${g} HP >= ${m} HP`),console.log("🔧 Reducing mercenary quantity to fit stacking order");const y=Math.floor((m-1)/u);if(y>0){console.log(`✅ Using ${y}x ${l.name} instead of ${h}`);const E={...o};E[l.name]=y;for(const x of t)if(x.name!==l.name){const k=n[x.name]||1;E[x.name]=k}s.push(E),console.log("✅ Created mixed composition with reduced mercenaries")}else console.log("❌ Even 1 mercenary too strong, skipping mercenary integration"),s.push(o);continue}const b={...o};for(const y of t){const E=n[y.name]||1;b[y.name]=E}s.push(b),console.log("✅ Created mixed composition with mercenaries")}return s}createAlternativeDominanceStack(e,t,i){const n={};console.log(`🔄 Creating alternative Dominance stack with max health: ${i}`);const a=[...e].sort((o,l)=>o.health-l.health);let s=0,r=0;for(const o of a){const l=Math.floor((i-r-1)/o.health),c=Math.floor((t-s)/o.dominance_cost),d=Math.min(l,c);d>0&&(n[o.name]=d,s+=d*o.dominance_cost,r+=d*o.health,console.log(`➕ Added ${d}x ${o.name} (${d*o.health} HP, ${d*o.dominance_cost} cost)`))}return console.log(`📊 Alternative Dominance stack: ${r} HP total, ${s} cost`),n}calculateMaximizedDominanceStack(e,t,i){console.log(`💰 Maximizing Dominance budget: ${t} with health limit: ${i}`);const n=this.createAlternativeDominanceStack(e,t,i);return Object.keys(n).length>0?n:this.calculateConstrainedDominanceStack(e,t,i)}generateStackingVariations(e,t,i){const n=[],a={},s=e[0],r=s[i];if(r>0){const o=Math.floor(t/r);a[s.name]=Math.min(o,5);let l=t-a[s.name]*r;for(let c=1;c<e.length&&l>0;c++){const d=e[c],m=d[i];if(m>0&&m<=l){const u=Math.floor(l/m/(e.length-c));u>0&&(a[d.name]=u,l-=u*m)}}n.push(a)}return n}generateGuaranteedDiverseCompositions_OLD(e){const t=[],i=this.availableUnits.filter(l=>e.availableUnits.includes(l.name)&&l.cost_type==="Leadership"),n=this.availableUnits.filter(l=>e.availableUnits.includes(l.name)&&l.cost_type==="Dominance"),a=this.availableUnits.filter(l=>e.availableUnits.includes(l.name)&&f.isMercenary(l)),s={};let r=0,o=0;for(const l of i)r+l.leadership_cost<=e.leadershipBudget&&(s[l.name]=1,r+=l.leadership_cost);for(const l of n)o+l.dominance_cost<=e.dominanceBudget&&(s[l.name]=1,o+=l.dominance_cost);for(const l of a){const c=e.mercenaryLimits[l.name]||1;s[l.name]=Math.min(1,c)}if(Object.keys(s).length>0&&t.push(s),i.length>0&&e.leadershipBudget>0){const l=i.sort((d,m)=>d.leadership_cost-m.leadership_cost)[0],c=Math.floor(e.leadershipBudget/l.leadership_cost);if(c>0){const d={};d[l.name]=Math.min(c,20);const m=e.leadershipBudget-d[l.name]*l.leadership_cost;for(const u of i.slice(1,3)){const h=Math.floor(m/u.leadership_cost/2);h>0&&(d[u.name]=h)}t.push(d)}}if(i.length>0||n.length>0){const l={};if(i.length>0&&e.leadershipBudget>0){const c=Math.floor(e.leadershipBudget/i.length);for(const d of i){const m=Math.floor(c/d.leadership_cost);m>0&&(l[d.name]=m)}}if(n.length>0&&e.dominanceBudget>0){const c=Math.floor(e.dominanceBudget/n.length);for(const d of n){const m=Math.floor(c/d.dominance_cost);m>0&&(l[d.name]=m)}}for(const c of a){const d=e.mercenaryLimits[c.name]||1;l[c.name]=Math.max(1,Math.floor(d/2))}Object.keys(l).length>0&&t.push(l)}return t}generateMercenaryCombinations(e){if(Object.keys(e).length===0)return[{}];let t=[{}];for(const[i,n]of Object.entries(e)){if(!this.unitsByName.has(i))continue;const a=[];for(const s of t)for(let r=0;r<=n;r++){const o={...s};r>0&&(o[i]=r),a.push(o)}t=a}return t}evaluateComposition(e){let t=0,i=0,n=0,a=0,s=0;const r=[];for(const[b,y]of Object.entries(e)){const E=this.unitsByName.get(b);if(!E)continue;const x=E.health*y,k=E.strength*y;t+=k,i+=x,n+=E.leadership_cost*y,a+=E.dominance_cost*y,f.isMercenary(E)&&(s+=y),r.push({unit:E,count:y,totalHealth:x,unitStrength:E.strength})}r.sort((b,y)=>b.unitStrength-y.unitStrength);let o=!0;const l=[];for(let b=0;b<r.length;b++){const{unit:y,count:E,totalHealth:x}=r[b];l.push({unitName:y.name,count:E,totalHealth:x,unitStrength:y.strength});for(let k=b+1;k<r.length;k++){const $=r[k].unit,_=r[k].totalHealth;if(y.strength===$.strength){const ne=Math.max(x,_)*.1;if(Math.abs(x-_)<=ne)continue}x<=_&&console.log(`❌ Stacking violation: ${y.name} (STR:${y.strength}, ${x} HP) <= ${$.name} (STR:${$.strength}, ${_} HP)`)}}const c=n+a+s;let d=c>0?t/c:0;d*=1.2;const u=1+(Object.keys(e).length-1)*.05;d*=u;let h=0;n>0&&h++,a>0&&h++,s>0&&h++;const g=1+(h-1)*.1;return d*=g,{units:e,totalStrength:t,totalHealth:i,totalLeadershipCost:n,totalDominanceCost:a,totalMercenaryCount:s,stackingOrder:l,isValidStacking:o,efficiencyScore:d}}explainStacking(e){const t=[],i=[],n=[],a=[];return e.stackingOrder.forEach(s=>{const r=this.unitsByName.get(s.unitName);if(!r)return;const o={name:s.unitName,count:s.count,totalHealth:s.totalHealth,strength:r.strength};f.isMercenary(r)?a.push(o):r.cost_type==="Leadership"?i.push(o):r.cost_type==="Dominance"&&n.push(o)}),t.push("🏆 OPTIMIZED ARMY COMPOSITION"),t.push("═".repeat(60)),t.push(""),t.push("📊 ARMY SUMMARY"),t.push("─".repeat(30)),t.push(`Total Units: ${Object.values(e.units).reduce((s,r)=>s+r,0).toLocaleString()}`),t.push(`Total Strength: ${e.totalStrength.toLocaleString()}`),t.push(`Total Health: ${e.totalHealth.toLocaleString()}`),t.push(`Budget Usage: L:${e.totalLeadershipCost} D:${e.totalDominanceCost} M:${e.totalMercenaryCount}`),t.push(""),a.length>0&&(t.push("🗡️ MERCENARY FORCES"),t.push("─".repeat(30)),a.forEach(s=>{t.push(`${s.count.toLocaleString()}x ${s.name}`),t.push(`   └─ ${s.totalHealth.toLocaleString()} HP total (STR: ${s.strength})`)}),t.push("")),i.length>0&&(t.push("👑 LEADERSHIP FORCES"),t.push("─".repeat(30)),i.sort((s,r)=>r.strength-s.strength),i.forEach(s=>{t.push(`${s.count.toLocaleString()}x ${s.name}`),t.push(`   └─ ${s.totalHealth.toLocaleString()} HP total (STR: ${s.strength})`)}),t.push("")),n.length>0&&(t.push("⚡ DOMINANCE FORCES"),t.push("─".repeat(30)),n.sort((s,r)=>r.strength-s.strength),n.forEach(s=>{t.push(`${s.count.toLocaleString()}x ${s.name}`),t.push(`   └─ ${s.totalHealth.toLocaleString()} HP total (STR: ${s.strength})`)}),t.push("")),t.push("⚔️ BATTLE ORDER (Weakest → Strongest)"),t.push("─".repeat(40)),e.stackingOrder.forEach((s,r)=>{const o=this.unitsByName.get(s.unitName);if(!o)return;const l=f.isMercenary(o)?"🗡️":o.cost_type==="Leadership"?"👑":o.cost_type==="Dominance"?"⚡":"❓";t.push(`${r+1}. ${l} ${s.count.toLocaleString()}x ${s.unitName} (${s.totalHealth.toLocaleString()} HP)`)}),t.join(`
`)}getAvailableUnits(){return[...this.availableUnits]}getUnitsByCostType(){return{Leadership:[...this.leadershipUnits],Dominance:[...this.dominanceUnits],Authority:[],Mercenary:[...this.mercenaryUnits]}}}class w{static formatGroupForLog(e){return`${e.count} ${e.unitName}`}static formatEnemyGroupForLog(e){return`Enemy Group ${e+1}`}static calculateDamageDealt(e){return e.count*e.unitStrength}static createPlayerAttackAction(e,t,i){const n=w.calculateDamageDealt(t);return{turn:e,attacker:w.formatGroupForLog(t),target:w.formatEnemyGroupForLog(i),action:`attack and deal ${n.toLocaleString()} damage`,damageDealt:n,eliminated:!1}}static createEnemyAttackAction(e,t,i){return{turn:e,attacker:w.formatEnemyGroupForLog(t),target:w.formatGroupForLog(i),action:`attack and kill ${w.formatGroupForLog(i)}`,eliminated:!0}}static formatCombatLogForDisplay(e){return e.map(t=>t.eliminated?`${t.attacker} ${t.action}`:`${t.attacker} ${t.action}`)}static calculateBattleStatistics(e,t){const i=e.filter(r=>!r.eliminated),n=e.filter(r=>r.eliminated),a={},s={};return i.forEach(r=>{const o=r.attacker.split(" ").slice(1).join(" "),l=r.damageDealt||0;a[o]=(a[o]||0)+l,s[o]=(s[o]||0)+1}),{totalPlayerAttacks:i.length,totalEnemyAttacks:n.length,averageDamagePerAttack:i.length>0?t/i.length:0,damageByUnitType:a,attacksByUnitType:s,eliminationRate:n.length>0?n.length/e.length:0}}static getBattleSummary(e){const t=e.statistics||w.calculateBattleStatistics(e.combatLog,e.totalDamageDealtToEnemies);return`Battle Summary:
...
- Scenario: ${e.scenario==="best_case"?"Best Case (Player First)":"Worst Case (Enemy First)"}`}}const Z={MAX_BATTLE_TURNS:1e3};class ue{constructor(){p(this,"attackOrderCache",new Map);p(this,"targetOrderCache",new Map)}simulateBattle(e){this.validateConfiguration(e);const t=this.initializeBattleState(e);return this.runBattleLoop(t,e),this.generateBattleResult(t,e)}simulateBothScenarios(e,t){const i=this.simulateBattle({playerArmy:e,enemyGroupCount:t,playerGoesFirst:!0}),n=this.simulateBattle({playerArmy:JSON.parse(JSON.stringify(e)),enemyGroupCount:t,playerGoesFirst:!1}),a={damageDifference:i.totalDamageDealtToEnemies-n.totalDamageDealtToEnemies,survivalDifference:i.playerSurvivalTurns-n.playerSurvivalTurns,averageDamage:(i.totalDamageDealtToEnemies+n.totalDamageDealtToEnemies)/2,averageSurvival:(i.playerSurvivalTurns+n.playerSurvivalTurns)/2};return{bestCase:i,worstCase:n,comparison:a}}calculateAttackOrder(e){const t=this.generateCacheKey(e,"attack"),i=this.attackOrderCache.get(t);if(i)return[...i];const n=[...e].sort((a,s)=>s.unitStrength-a.unitStrength);return this.attackOrderCache.set(t,n),n}calculateEnemyTargetOrder(e){const t=this.generateCacheKey(e,"target"),i=this.targetOrderCache.get(t);if(i)return[...i];const n=[...e].sort((a,s)=>a.totalHealth-s.totalHealth);return this.targetOrderCache.set(t,n),n}shouldBattleEnd(e){return e.playerGroups.length===0||e.currentTurn>=Z.MAX_BATTLE_TURNS||e.battleEnded}processTurn(e,t){t?(this.processPlayerActions(e),this.shouldBattleEnd(e)||this.processEnemyActions(e)):(this.processEnemyActions(e),this.shouldBattleEnd(e)||this.processPlayerActions(e)),e.currentTurn++}validateConfiguration(e){if(!e)throw new Error("Battle configuration is required");if(!e.playerArmy)throw new Error("Player army is required");if(!e.playerArmy.stackingOrder||e.playerArmy.stackingOrder.length===0)throw new Error("Player army must have at least one unit group")}initializeBattleState(e){return{currentTurn:0,playerGroups:[...e.playerArmy.stackingOrder],enemyGroupCount:this.getEnemyGroupCount(e),totalDamageDealt:0,battleEnded:!1,combatLog:[]}}runBattleLoop(e,t){for(;!this.shouldBattleEnd(e);)this.processTurn(e,t.playerGoesFirst??!0)}generateBattleResult(e,t){const i=w.calculateBattleStatistics(e.combatLog,e.totalDamageDealt);return{outcome:"player_eliminated",combatLog:e.combatLog,totalDamageDealtToEnemies:e.totalDamageDealt,battleDuration:e.currentTurn,playerSurvivalTurns:e.currentTurn,scenario:t.playerGoesFirst?"best_case":"worst_case",configuration:t,statistics:i}}generateCacheKey(e,t){return`${t}-${e.map(i=>`${i.unitName}:${i.count}:${i.totalHealth}:${i.unitStrength}`).join("|")}`}}class G extends ue{validateConfiguration(e){super.validateConfiguration(e);const t=f.validateBattleConfiguration({playerArmy:e.playerArmy,enemyGroupCount:e.enemyGroupCount});if(!t.isValid)throw new Error(t.errors[0]);for(const i of e.playerArmy.stackingOrder){if(i.count<=0)throw new Error(`Unit group "${i.unitName}" must have a positive count`);if(i.unitStrength<=0)throw new Error(`Unit group "${i.unitName}" must have positive strength`);if(i.totalHealth<=0)throw new Error(`Unit group "${i.unitName}" must have positive health`)}}getEnemyGroupCount(e){return e.enemyGroupCount}calculateInitialEnemyHealth(e){return 0}simulateBothScenarios(e,t){const i=f.validateBattleConfiguration({playerArmy:e,enemyGroupCount:t});if(!i.isValid)throw new Error(i.errors[0]);this.attackOrderCache.clear(),this.targetOrderCache.clear();const n=super.simulateBothScenarios(e,t);return this.attackOrderCache.clear(),this.targetOrderCache.clear(),n}calculateAttackOrder(e){const t=this.generateCacheKey(e,"attack"),i=this.attackOrderCache.get(t);if(i)return[...i];const n=[...e].sort((a,s)=>{const r=w.calculateDamageDealt(a);return w.calculateDamageDealt(s)-r});return this.attackOrderCache.set(t,n),n}calculateEnemyAttackOrder(e){return Array.from({length:e.enemyGroupCount},(i,n)=>n).reverse()}generateCacheKey(e,t){return`${t}-${e.map(i=>`${i.unitName}:${i.count}:${i.totalHealth}:${i.unitStrength}`).join("|")}`}calculateEnemyTargetOrder(e){const t=this.generateCacheKey(e,"target"),i=this.targetOrderCache.get(t);if(i)return[...i];const n=[...e].sort((a,s)=>s.totalHealth-a.totalHealth);return this.targetOrderCache.set(t,n),n}shouldBattleEnd(e){return e.playerGroups.length===0||e.battleEnded}processTurn(e,t){if(console.log(`🔥 BattleSimulationService.processTurn called - playerGoesFirst: ${t}, turn: ${e.currentTurn}`),e.playerGroups.length===0){e.battleEnded=!0;return}let i=0,n=0;const a=e.enemyGroupCount,s=this.calculateEnemyAttackOrder(e),o=e.playerGroups.length,l=o+a;for(let c=0;c<l&&!this.shouldBattleEnd(e);c++){const d=t?c%2===0:c%2===1;if(d&&i<o&&e.playerGroups.length>0){console.log(`  Action ${c}: PLAYER turn (${i+1}/${o})`);const m=this.calculateAttackOrder(e.playerGroups);if(m.length>0){const u=m[0];console.log(`    → ${u.unitName} attacks (Turn ${e.currentTurn})`),this.processSinglePlayerAttackByGroup(e,u,i)}i++}else if(!d&&n<a&&e.playerGroups.length>0){console.log(`  Action ${c}: ENEMY turn (${n+1}/${a})`);const m=s[n];console.log(`    → Enemy Group ${m+1} attacks (Turn ${e.currentTurn})`),this.processSingleEnemyAttack(e,m),n++}if(e.playerGroups.length===0){e.battleEnded=!0;break}if(i>=o&&n>=a)break}e.currentTurn++}processPlayerActions(e){throw console.error("🚨 ERROR: processPlayerActions called instead of processTurn override!"),new Error("processPlayerActions should not be called - using overridden processTurn instead")}processEnemyActions(e){throw console.error("🚨 ERROR: processEnemyActions called instead of processTurn override!"),new Error("processEnemyActions should not be called - using overridden processTurn instead")}processSinglePlayerAttackByGroup(e,t,i){if(e.playerGroups.length===0)return;const n=i%e.enemyGroupCount,a=w.calculateDamageDealt(t),s=w.createPlayerAttackAction(e.currentTurn,t,n);console.log(`📝 Adding PLAYER action to combat log: ${s.action} (Turn ${s.turn})`),e.combatLog.push(s),e.totalDamageDealt+=a}processSingleEnemyAttack(e,t){if(e.playerGroups.length===0)return;const i=this.calculateEnemyTargetOrder(e.playerGroups);if(i.length===0)return;const n=i[0],a=w.createEnemyAttackAction(e.currentTurn,t,n);console.log(`📝 Adding ENEMY action to combat log: ${a.action} (Turn ${a.turn})`),e.combatLog.push(a);const s=e.playerGroups.findIndex(r=>r.unitName===n.unitName&&r.count===n.count&&r.totalHealth===n.totalHealth);s!==-1&&e.playerGroups.splice(s,1),e.playerGroups.length===0&&(e.battleEnded=!0)}}class he{constructor(e,t){p(this,"battleSimulator");p(this,"algorithm");p(this,"unitLoader",null);this.battleSimulator=e||new G,this.algorithm=t||new pe}initialize(e){this.unitLoader=e}setAlgorithm(e){this.algorithm=e}reportProgress(e,t){e.onProgress&&e.onProgress(t)}checkCancellation(e){var t;if((t=e.signal)!=null&&t.aborted)throw new Error("Operation was cancelled by user")}async optimizeForDamage(e,t){const i=performance.now(),n=12e4;console.log(`🎯 Starting damage optimization with ${this.algorithm.name}`),console.log(`📊 Constraints: L:${e.leadershipBudget} D:${e.dominanceBudget} vs ${e.enemyGroupCount} enemies`),console.log(`⏱️ Maximum processing time: ${n/1e3} seconds`),this.reportProgress(e,{phase:"initializing",progress:0,message:"Initializing damage optimizer...",elapsedMs:0}),this.validateOptimizationConstraints(e),this.reportProgress(e,{phase:"generating",progress:10,message:"Generating army combinations...",elapsedMs:performance.now()-i});const a=await this.algorithm.generateCombinations(e,t);console.log(`🔄 Generated ${a.length} army combinations to evaluate`),this.reportProgress(e,{phase:"evaluating",progress:20,message:"Evaluating army combinations...",combinationsGenerated:a.length,totalCombinations:a.length,combinationsEvaluated:0,totalToEvaluate:a.length,elapsedMs:performance.now()-i});const s=[];let r=0;for(let d=0;d<a.length;d++){this.checkCancellation(e);const m=performance.now();if(m-i>n){console.warn(`⏱️ Optimization timeout after ${(m-i)/1e3}s - stopping at ${r} combinations`);break}const u=a[d];try{const h=await this.evaluateArmyComposition(u,e.enemyGroupCount,t,e.specificEnemyUnits);s.push(h),r++}catch(h){console.warn("⚠️ Failed to evaluate army composition:",h)}if(r%3===0&&await new Promise(h=>setTimeout(h,0)),r%10===0||r===a.length){const h=performance.now()-i,g=20+Math.floor(r/a.length*60),b=r>0?h/r*(a.length-r):void 0;this.reportProgress(e,{phase:"evaluating",progress:g,message:`Evaluating combinations... (${r}/${a.length})`,combinationsGenerated:a.length,totalCombinations:a.length,combinationsEvaluated:r,totalToEvaluate:a.length,elapsedMs:h,estimatedRemainingMs:b})}if(r%25===0){const h=(performance.now()-i)/1e3;console.log(`📊 Progress: ${r}/${a.length} combinations (${h.toFixed(1)}s elapsed)`)}}this.reportProgress(e,{phase:"finalizing",progress:90,message:"Finalizing results...",combinationsGenerated:a.length,totalCombinations:a.length,combinationsEvaluated:r,totalToEvaluate:a.length,elapsedMs:performance.now()-i});const o=s.sort((d,m)=>{const u=m.averageDamagePerBattle-d.averageDamagePerBattle;return Math.abs(u)>.01?u:m.damageEfficiencyScore-d.damageEfficiencyScore}),c=performance.now()-i;return console.log(`✅ Optimization complete: ${o.length} valid results in ${c.toFixed(2)}ms`),this.reportProgress(e,{phase:"finalizing",progress:100,message:"Optimization complete!",combinationsGenerated:a.length,totalCombinations:a.length,combinationsEvaluated:r,totalToEvaluate:a.length,elapsedMs:c}),{rankedResults:o,combinationsEvaluated:r,optimizationTimeMs:c,algorithmUsed:this.algorithm.name,wasTruncated:a.length>(e.maxCombinations||50)}}async evaluateArmyComposition(e,t,i,n){let a;if(n&&n.length>0){const{optimizedBattleSimulationService:h}=await R(async()=>{const{optimizedBattleSimulationService:g}=await Promise.resolve().then(()=>Ee);return{optimizedBattleSimulationService:g}},void 0);this.unitLoader&&h.initialize(this.unitLoader),a=h.simulateBothScenariosWithEnemyUnits(e,n)}else a=this.battleSimulator.simulateBothScenarios(e,t);const s=this.calculateSilverCost(e,i),r=this.calculateFoodConsumption(e,i),o=this.calculateRevivalCost(e,i),l=a.bestCase.totalDamageDealtToEnemies,c=a.worstCase.totalDamageDealtToEnemies,d=(l+c)/2,m=e.totalLeadershipCost+e.totalDominanceCost+s,u=m>0?d/m:0;return{armyComposition:e,battleAnalysis:a,totalSilverCost:s,totalFoodConsumption:r,totalRevivalCost:o,averageDamagePerBattle:d,damageEfficiencyScore:u}}calculateSilverCost(e,t){const i=new Map(t.map(a=>[a.name,a]));let n=0;for(const[a,s]of Object.entries(e.units)){const r=i.get(a);r&&(n+=(r.revival_cost_silver??0)*s)}return n}calculateFoodConsumption(e,t){const i=new Map(t.map(a=>[a.name,a]));let n=0;for(const[a,s]of Object.entries(e.units)){const r=i.get(a);r&&(n+=(r.food_consumption??0)*s)}return n}calculateRevivalCost(e,t){return this.calculateSilverCost(e,t)}validateOptimizationConstraints(e){if(e.enemyGroupCount<1||e.enemyGroupCount>100)throw new Error("Enemy group count must be between 1 and 100");if(e.leadershipBudget<0)throw new Error("Leadership budget cannot be negative");if(e.dominanceBudget<0)throw new Error("Dominance budget cannot be negative");if(!e.availableUnits||e.availableUnits.length===0)throw new Error("At least one unit type must be available for optimization");if(e.maxCombinations&&e.maxCombinations<1)throw new Error("Maximum combinations must be at least 1")}}class pe{constructor(){p(this,"name","Systematic Combination Testing")}async generateCombinations(e,t){const i=performance.now(),n=6e4;console.log("🔍 Generating combinations using systematic testing algorithm");const a=t.filter(l=>e.availableUnits.includes(l.name));console.log(`📋 Available units for optimization: ${a.length}`);const s=e.maxCombinations||50,r=this.generateUnitCombinations(a.map(l=>l.name),s);console.log(`🔄 Testing ${r.length} different unit combinations (user requested: ${s})`);const o=[];for(let l=0;l<r.length;l++){const c=performance.now();if(c-i>n){console.warn(`⏱️ Generation timeout after ${(c-i)/1e3}s - stopping at ${l} combinations`);break}const d=r[l];try{const m=await this.testCombinationWithStackingAlgorithm(d,e,t);m&&o.push(m)}catch(m){console.warn(`⚠️ Failed to test combination [${d.join(", ")}]:`,m)}if(l%5===0&&await new Promise(m=>setTimeout(m,0)),l%20===0&&l>0){const m=(performance.now()-i)/1e3;console.log(`🔄 Generation progress: ${l}/${r.length} combinations tested (${m.toFixed(1)}s)`)}}return console.log(`✅ Generated ${o.length} valid army combinations for evaluation`),o}generateUnitCombinations(e,t){const i=Math.pow(2,e.length)-1;if(console.log(`📊 Total possible combinations: ${i}, user requested: ${t}`),i>t)return this.generateLimitedCombinations(e,t);const n=[];for(let a=1;a<=i;a++){const s=[];for(let r=0;r<e.length;r++)a&1<<r&&s.push(e[r]);n.push(s)}return n.sort((a,s)=>s.length-a.length),console.log(`🎯 Generated all ${n.length} combinations, ordered largest to smallest`),console.log(`   User requested: ${t} combinations (all possible combinations fit within limit)`),n}generateLimitedCombinations(e,t){const i=[];i.push([...e]);for(let n=0;n<e.length&&i.length<t;n++){const a=e.filter((s,r)=>r!==n);i.push(a)}for(let n=0;n<e.length&&i.length<t;n++)for(let a=n+1;a<e.length&&i.length<t;a++){const s=e.filter((r,o)=>o!==n&&o!==a);s.length>0&&i.push(s)}for(let n=0;n<e.length&&i.length<t;n++)for(let a=n+1;a<e.length&&i.length<t;a++)for(let s=a+1;s<e.length&&i.length<t;s++){const r=e.filter((o,l)=>l!==n&&l!==a&&l!==s);r.length>0&&i.push(r)}if(i.length<t){const n=Math.floor(e.length/2);for(let s=0;s<10&&i.length<t;s++){const r=this.getRandomCombination(e,n);i.some(o=>o.length===r.length&&o.every(l=>r.includes(l)))||i.push(r)}const a=Math.max(1,Math.floor(e.length/4));for(let s=0;s<5&&i.length<t;s++){const r=this.getRandomCombination(e,a);i.some(o=>o.length===r.length&&o.every(l=>r.includes(l)))||i.push(r)}}return console.log(`🎯 Generated ${i.length} top-down combinations from ${e.length} units`),console.log(`   Strategy: Started with all ${e.length} units, then systematically removed units`),console.log(`   User requested: ${t} combinations (time-based limits still apply)`),i}getRandomCombination(e,t){return[...e].sort(()=>Math.random()-.5).slice(0,t)}async testCombinationWithStackingAlgorithm(e,t,i){try{const n=new H(i),a={leadershipBudget:t.leadershipBudget,dominanceBudget:t.dominanceBudget,mercenaryLimits:t.mercenaryLimits,availableUnits:e},s=await n.optimizeArmy(a);return s.compositions&&s.compositions.length>0?s.compositions[0]:null}catch(n){return console.warn(`Failed to test combination [${e.join(", ")}]:`,n),null}}}class ge{constructor(){p(this,"unitLoader",null)}initialize(e){this.unitLoader=e}getUnitTypes(e){if(!this.unitLoader)throw new Error("Unit loader not initialized");const t=this.unitLoader.getUnitByName(e);return t?t.unit_types||[]:(console.warn(`Unit not found: ${e}`),[])}getUnit(e){if(!this.unitLoader)throw new Error("Unit loader not initialized");return this.unitLoader.getUnitByName(e)}getFullUnitData(e){return this.getUnit(e)}hasUnitType(e,t){return this.getUnitTypes(e).some(n=>n.toLowerCase()===t.toLowerCase())}getAllUnitTypes(){if(!this.unitLoader)throw new Error("Unit loader not initialized");return this.unitLoader.getUniqueUnitTypes()}validateStackingGroups(e){const t=[],i=[];for(const n of e){const a=this.getUnit(n.unitName);a?(!a.unit_types||a.unit_types.length===0)&&i.push(`Unit ${n.unitName} has no unit types defined`):t.push(n.unitName)}return{isValid:t.length===0,missingUnits:t,warnings:i}}}const P=new ge;class ye{applyDamage(e,t){if(!e.count||e.count<=0)return{eliminated:!1,actualDamage:0,remainingHealth:0,remainingCount:0,isDefeated:!0};const i=e.currentHealth??e.count*e.health,n=Math.min(t,i),a=Math.max(0,i-n),s=Math.floor(n/e.health),r=Math.max(0,e.count-s);e.currentHealth=a,e.count=r;const o=r===0||a===0;return{eliminated:s>0,actualDamage:n,remainingHealth:a,remainingCount:r,isDefeated:o}}canAttack(e){return(e.count??0)>0&&(e.currentHealth??e.health)>0}getAttackStrength(e){return(e.count??1)>0?e.strength:0}createAttackAction(e,t,i){return{turn:i,attacker:this.getDisplayName(e),target:`${t.count} ${t.unitName}`,action:`attack and kill ${t.count} ${t.unitName}`,eliminated:!0}}createDamageAction(e,t,i,n){const a=Math.floor(i/e.health),s=a>0?`attack ${this.getDisplayName(e)} and kill ${a} units (${i.toLocaleString()} damage)`:`attack ${this.getDisplayName(e)} and deal ${i.toLocaleString()} damage`;return{turn:n,attacker:`${t.count} ${t.unitName}`,target:this.getDisplayName(e),action:s,damageDealt:i,eliminated:!1}}getDisplayName(e){const t=e.count??0;return t>0?`${t} ${e.name}`:e.name}}class fe{applyDamage(e,t){return{eliminated:!1,actualDamage:t,remainingHealth:e.health,remainingCount:void 0,isDefeated:!1}}canAttack(e){return!0}getAttackStrength(e){return e.strength}createAttackAction(e,t,i){return{turn:i,attacker:this.getDisplayName(e),target:`${t.count} ${t.unitName}`,action:`attack and kill ${t.count} ${t.unitName}`,eliminated:!0}}createDamageAction(e,t,i,n){return{turn:n,attacker:`${t.count} ${t.unitName}`,target:this.getDisplayName(e),action:`attack ${this.getDisplayName(e)} and deal ${i.toLocaleString()} damage`,damageDealt:i,eliminated:!1}}getDisplayName(e){return e.name}}class L{static getBehavior(e){return e.isMortal===!0||e.count!==void 0?this.mortalBehavior:this.immortalBehavior}static initializeEnemyForBattle(e){const t={...e};return e.count!==void 0?(t.isMortal=!0,t.currentHealth=e.count*e.health):(t.isMortal=!1,t.count=void 0,t.currentHealth=e.health),t}}p(L,"mortalBehavior",new ye),p(L,"immortalBehavior",new fe);class ee{constructor(){p(this,"unitLoader",null);p(this,"coreBattleService");this.coreBattleService=new G}initialize(e){this.unitLoader=e,P.initialize(e)}simulateBattle(e){return this.coreBattleService.simulateBattle(e)}simulateBothScenarios(e,t){return this.coreBattleService.simulateBothScenarios(e,t)}calculatePlayerAttackOrderWithEnemies(e,t){const i=e.map((n,a)=>{const s=n.count*n.unitStrength;let r=s;try{const o=this.unitLoader?this.unitLoader.getUnitByName(n.unitName):null;if(o&&o.attack_modifiers){for(const l of o.attack_modifiers)if(t.some(d=>d.unit_types.some(m=>m.toLowerCase()===l.target_type.toLowerCase()))){const d=s*(l.value/100),m=s+d;m>r&&(r=m)}}}catch(o){console.warn("Unit type lookup failed for player unit:",n.unitName,o)}return{index:a,group:n,baseDamage:s,maxDamage:r}});return i.sort((n,a)=>a.maxDamage-n.maxDamage),console.log("🎯 Player Attack Order by Max Damage:"),i.forEach((n,a)=>{if(console.log(`  ${a+1}. ${n.group.unitName}: ${n.maxDamage.toLocaleString()} damage`),n.maxDamage>n.baseDamage){const s=n.maxDamage-n.baseDamage;console.log(`     (${n.baseDamage.toLocaleString()} base + ${s.toLocaleString()} bonus)`)}}),i.map(n=>n.group)}calculateEnemyAttackOrderWithUnits(e,t){const i=e.map((n,a)=>{const s=(n.count??1)*n.strength;let r=s;return n.attack_modifiers&&n.attack_modifiers.length>0&&n.attack_modifiers.forEach(o=>{if(t.stackingOrder.some(c=>this.playerUnitMatchesModifierTarget(c.unitName,o.target_type))){const c=s*(o.value/100),d=s+c;d>r&&(r=d)}}),{index:a,enemy:n,baseDamage:s,maxDamage:r}});return i.sort((n,a)=>a.maxDamage-n.maxDamage),console.log("🎯 Enemy Attack Order by Max Damage:"),i.forEach((n,a)=>{if(console.log(`  ${a+1}. ${n.enemy.name}: ${n.maxDamage.toLocaleString()} damage`),n.maxDamage>n.baseDamage){const s=n.maxDamage-n.baseDamage;console.log(`     (${n.baseDamage.toLocaleString()} base + ${s.toLocaleString()} bonus)`)}}),i.map(n=>n.index)}playerUnitMatchesModifierTarget(e,t){const i=e.toLowerCase();switch(t.toLowerCase()){case"mounted":return i.includes("rider")||i.includes("knight");case"melee":return i.includes("spearman")||i.includes("knight")||i.includes("guardian");case"ranged":return i.includes("archer")||i.includes("hunter");case"flying":return i.includes("dragon")||i.includes("phoenix")||i.includes("griffen");case"magic":return i.includes("magic")||i.includes("phoenix");default:return!1}}calculateAttackOrder(e){return this.coreBattleService.calculateAttackOrder(e)}calculateEnemyTargetOrder(e){return this.coreBattleService.calculateEnemyTargetOrder(e)}shouldBattleEnd(e){return this.coreBattleService.shouldBattleEnd(e)}processTurn(e,t){return this.coreBattleService.processTurn(e,t)}simulateBattleWithEnemyUnits(e){var s;this.validateEnemyUnitBattleConfiguration(e),console.log("🎯 Enemy Battle Simulation Debug:",{playerGoesFirst:e.playerGoesFirst,playerGroups:((s=e.playerArmy.stackingOrder)==null?void 0:s.length)||0,enemyUnits:e.enemyUnits.length,useEnemyModifiers:e.useEnemyModifiers,mortalEnemies:e.enemyUnits.filter(r=>f.isMortalEnemy(r)).length,immortalEnemies:e.enemyUnits.filter(r=>f.isImmortalEnemy(r)).length});const t=e.enemyUnits.map(r=>L.initializeEnemyForBattle(r)),n=this.calculateEnemyAttackOrderWithUnits(t,e.playerArmy).map(r=>t[r]);if(n.some(r=>f.isMortalEnemy(r)))return this.simulateMortalEnemyBattle(e,n);{const r={playerArmy:e.playerArmy,enemyGroupCount:n.length,playerGoesFirst:e.playerGoesFirst},o=this.coreBattleService.simulateBattle(r),l=this.enhanceCombatLogWithEnemyUnits(o.combatLog,n,e.playerArmy,e.useEnemyModifiers!==!1);return{...o,combatLog:l}}}simulateMortalEnemyBattle(e,t){var o,l;const i={currentTurn:0,playerGroups:[...e.playerArmy.stackingOrder],enemyGroupCount:t.length,enemyUnits:[...t],totalDamageDealt:0,totalEnemiesEliminated:0,battleEnded:!1,combatLog:[]};for(;!this.shouldMortalEnemyBattleEnd(i)&&i.currentTurn<Z.MAX_BATTLE_TURNS;)this.processMortalEnemyTurn(i,e.playerGoesFirst,e.useEnemyModifiers!==!1);const n=((o=i.enemyUnits)==null?void 0:o.filter(c=>f.isMortalEnemy(c)&&!L.getBehavior(c).canAttack(c)).length)??0,a=((l=i.enemyUnits)==null?void 0:l.every(c=>f.isImmortalEnemy(c)||!L.getBehavior(c).canAttack(c)))??!1;let s;i.playerGroups.length===0?s="player_eliminated":a?s="player_victory":s="stalemate";const r={playerArmy:e.playerArmy,enemyGroupCount:t.length,playerGoesFirst:e.playerGoesFirst};return this.coreBattleService.simulateBattle(r),{outcome:s,combatLog:i.combatLog,totalDamageDealtToEnemies:i.totalDamageDealt,battleDuration:i.currentTurn,playerSurvivalTurns:i.currentTurn,scenario:e.playerGoesFirst?"best_case":"worst_case",configuration:{playerArmy:e.playerArmy,enemyGroupCount:t.length,playerGoesFirst:e.playerGoesFirst},statistics:w.calculateBattleStatistics(i.combatLog,i.totalDamageDealt),totalEnemiesEliminated:i.totalEnemiesEliminated,mortalEnemiesDefeated:n}}shouldMortalEnemyBattleEnd(e){if(e.playerGroups.length===0)return!0;if(e.enemyUnits){const t=e.enemyUnits.filter(n=>f.isMortalEnemy(n)&&L.getBehavior(n).canAttack(n)),i=e.enemyUnits.filter(n=>f.isImmortalEnemy(n)&&L.getBehavior(n).canAttack(n));if(t.length===0&&i.length===0)return!0}return!1}processMortalEnemyTurn(e,t,i){if(!e.enemyUnits||e.enemyUnits.length===0)return;const n=new Set,a=new Set,s=e.enemyUnits.filter(m=>L.getBehavior(m).canAttack(m)),r=e.playerGroups.length,o=s.length,l=r+o;let c=0,d=0;for(let m=0;m<l&&!this.shouldMortalEnemyBattleEnd(e);m++){const u=t?m%2===0:m%2===1;if(u&&c<r&&e.playerGroups.length>0){const h=e.playerGroups.filter(g=>!n.has(g.unitName));if(h.length>0){const g=this.selectBestPlayerAttacker(h,e.enemyUnits,i);this.processDynamicPlayerAttack(e,g,i),n.add(g.unitName),c++}}else if(!u&&d<o&&e.playerGroups.length>0){const h=e.enemyUnits.filter((g,b)=>L.getBehavior(g).canAttack(g)&&!a.has(b));if(h.length>0){const g=this.selectBestEnemyAttacker(h,e.playerGroups);this.processDynamicEnemyAttack(e,g,i),a.add(g),d++}}if(e.playerGroups.length===0||this.shouldMortalEnemyBattleEnd(e))break}e.currentTurn++}processMortalPlayerAttack(e,t,i){if(!e.enemyUnits||e.playerGroups.length===0)return;const n=i&&e.enemyUnits?this.calculatePlayerAttackOrderWithEnemies(e.playerGroups,e.enemyUnits):this.calculateAttackOrder(e.playerGroups);if(n.length===0)return;const a=n[0],s=e.enemyUnits.filter(u=>L.getBehavior(u).canAttack(u));if(s.length===0)return;const r=s[t%s.length],o=L.getBehavior(r);let c=w.calculateDamageDealt(a);const d=o.applyDamage(r,c),m=o.createDamageAction(r,a,d.actualDamage,e.currentTurn);e.combatLog.push(m),e.totalDamageDealt+=d.actualDamage,d.isDefeated&&(e.totalEnemiesEliminated=(e.totalEnemiesEliminated??0)+1)}processMortalEnemyAttack(e,t,i){if(!e.enemyUnits||e.playerGroups.length===0)return;const n=e.enemyUnits.filter(d=>L.getBehavior(d).canAttack(d));if(n.length===0||t>=n.length)return;const a=n[t],s=L.getBehavior(a),r=this.calculateEnemyTargetOrder(e.playerGroups);if(r.length===0)return;const o=r[0],l=s.createAttackAction(a,o,e.currentTurn);e.combatLog.push(l);const c=e.playerGroups.findIndex(d=>d.unitName===o.unitName&&d.count===o.count&&d.totalHealth===o.totalHealth);c!==-1&&e.playerGroups.splice(c,1)}selectBestPlayerAttacker(e,t,i){return i?e.map(a=>{const s=a.count*a.unitStrength;let r=s;try{const o=this.unitLoader?this.unitLoader.getUnitByName(a.unitName):null;if(o&&o.attack_modifiers){for(const l of o.attack_modifiers)if(t.some(d=>d.unit_types.some(m=>m.toLowerCase()===l.target_type.toLowerCase()))){const d=s*(l.value/100),m=s+d;m>r&&(r=m)}}}catch(o){console.warn("Unit lookup failed for player unit:",a.unitName,o)}return{group:a,maxDamage:r}}).reduce((a,s)=>s.maxDamage>a.maxDamage?s:a).group:e.reduce((a,s)=>s.count*s.unitStrength>a.count*a.unitStrength?s:a)}selectBestEnemyAttacker(e,t){return e.map(n=>{const a=(n.count??1)*n.strength;let s=a;return n.attack_modifiers&&n.attack_modifiers.length>0&&n.attack_modifiers.forEach(r=>{if(t.some(l=>this.playerUnitMatchesModifierTarget(l.unitName,r.target_type))){const l=a*(r.value/100),c=a+l;c>s&&(s=c)}}),{enemy:n,maxDamage:s}}).reduce((n,a)=>a.maxDamage>n.maxDamage?a:n).enemy,0}processDynamicPlayerAttack(e,t,i){if(!e.enemyUnits||e.enemyUnits.length===0)return;const n=e.enemyUnits.filter(c=>L.getBehavior(c).canAttack(c));if(n.length===0)return;const a=n[0],s=L.getBehavior(a);let r=t.count*t.unitStrength;if(i)try{const c=this.unitLoader?this.unitLoader.getUnitByName(t.unitName):null;if(c&&c.attack_modifiers){for(const d of c.attack_modifiers)if(a.unit_types.some(m=>m.toLowerCase()===d.target_type.toLowerCase())){const m=r*(d.value/100);r+=m;break}}}catch(c){console.warn("Unit lookup failed for damage calculation:",t.unitName,c)}const o=s.applyDamage(a,r),l=s.createDamageAction(a,t,o.actualDamage,e.currentTurn);e.combatLog.push(l),e.totalDamageDealt+=o.actualDamage,o.isDefeated&&(e.totalEnemiesEliminated=(e.totalEnemiesEliminated??0)+1)}processDynamicEnemyAttack(e,t,i){if(!e.enemyUnits||e.playerGroups.length===0||t>=e.enemyUnits.length)return;const n=e.enemyUnits[t],a=L.getBehavior(n),s=this.calculateEnemyTargetOrder(e.playerGroups);if(s.length===0)return;const r=s[0],o=a.createAttackAction(n,r,e.currentTurn);e.combatLog.push(o);const l=e.playerGroups.findIndex(c=>c.unitName===r.unitName&&c.count===r.count&&c.totalHealth===r.totalHealth);l!==-1&&e.playerGroups.splice(l,1)}simulateBothScenariosWithEnemyUnits(e,t,i=!0){var c,d,m,u,h,g,b,y,E;console.log("🔄 simulateBothScenariosWithEnemyUnits called with:",{playerStackingGroups:((c=e.stackingOrder)==null?void 0:c.length)||0,enemyUnitsCount:t.length,useEnemyModifiers:i});const n=f.validateBattleConfiguration({playerArmy:e,enemyUnits:t});if(!n.isValid)throw new Error(n.errors[0]);(m=(d=this.coreBattleService.attackOrderCache)==null?void 0:d.clear)==null||m.call(d),(h=(u=this.coreBattleService.targetOrderCache)==null?void 0:u.clear)==null||h.call(u);const a={playerArmy:e,enemyUnits:t,playerGoesFirst:!0,useEnemyModifiers:i},s=this.simulateBattleWithEnemyUnits(a);(b=(g=this.coreBattleService.attackOrderCache)==null?void 0:g.clear)==null||b.call(g),(E=(y=this.coreBattleService.targetOrderCache)==null?void 0:y.clear)==null||E.call(y);const r={playerArmy:JSON.parse(JSON.stringify(e)),enemyUnits:JSON.parse(JSON.stringify(t)),playerGoesFirst:!1,useEnemyModifiers:i},o=this.simulateBattleWithEnemyUnits(r),l={damageDifference:s.totalDamageDealtToEnemies-o.totalDamageDealtToEnemies,survivalDifference:s.playerSurvivalTurns-o.playerSurvivalTurns,averageDamage:(s.totalDamageDealtToEnemies+o.totalDamageDealtToEnemies)/2,averageSurvival:(s.playerSurvivalTurns+o.playerSurvivalTurns)/2};return{bestCase:s,worstCase:o,comparison:l}}enhanceCombatLogWithEnemyUnits(e,t,i,n){return e.map((a,s)=>{const r={...a},o=!a.eliminated,l=a.eliminated;if(o){const c=this.extractEnemyGroupIndex(a.target);if(c>=0&&c<t.length){const d=t[c];r.enemyUnit=d;const m=this.extractUnitNameFromAttacker(a.attacker),u=a.damageDealt||0;if(n&&m){const{enhancedDamage:h,modifiersApplied:g}=this.calculatePlayerModifiers(m,d,u);if(h!==u){r.damageDealt=h,r.modifiersApplied=g;const b=Math.floor(h/d.health);let y=`attack ${d.name} and deal ${h.toLocaleString()} damage`;if(b>0&&(y+=` (${b} ${d.name}${b>1?"s":""} killed)`),g.length>0){const E=g.map(x=>{const k=Math.round(x.value/u*100);return`+${Math.round(x.value)} bonus damage (+${k}%) vs ${x.type}`}).join(", ");y+=` (${E})`}r.action=y}else r.target=d.name,r.action=a.action.replace(/Enemy Group \d+/,d.name)}else r.target=d.name,r.action=a.action.replace(/Enemy Group \d+/,d.name)}}else if(l){const c=this.extractEnemyGroupIndex(a.attacker);if(c>=0&&c<t.length){const d=t[c];if(r.enemyUnit=d,r.effectiveStrength=d.strength,n&&d.attack_modifiers){const m=this.extractUnitNameFromTarget(a.target);if(m){const{enhancedStrength:u,modifiersApplied:h}=this.calculateEnemyModifiers(d,m);if(u!==d.strength){r.effectiveStrength=u,r.modifiersApplied=h;let g=`attack and kill ${a.target}`;if(h.length>0){const b=h.map(y=>{const E=Math.round(y.value/d.strength*100);return`+${Math.round(y.value)} bonus damage (+${E}%) vs ${y.type}`}).join(", ");g+=` (${b})`}r.action=g}}}r.attacker=d.name}}return r})}calculatePlayerModifiers(e,t,i){let n=i;const a=[];try{const s=this.unitLoader?this.unitLoader.getUnitByName(e):null;if(s&&s.attack_modifiers){for(const r of s.attack_modifiers)if(t.unit_types.some(o=>o.toLowerCase()===r.target_type.toLowerCase())){const o=i*(r.value/100);n+=o,a.push({type:r.target_type,value:o})}}}catch(s){console.warn("Unit type lookup failed for player unit:",e,s)}return{enhancedDamage:n,modifiersApplied:a}}calculateEnemyModifiers(e,t){let i=e.strength;const n=[];try{const a=P.getUnitTypes(t);for(const s of e.attack_modifiers||[])if(a.includes(s.target_type)){const r=e.strength*(s.value/100);i+=r,n.push({type:s.target_type,value:r})}}catch(a){console.warn("Unit type lookup failed for target unit:",t,a)}return{enhancedStrength:i,modifiersApplied:n}}extractEnemyGroupIndex(e){const t=e.match(/Enemy Group (\d+)/);return t?parseInt(t[1])-1:-1}extractUnitNameFromAttacker(e){const t=e.match(/^\d+\s+(.+)$/);return t?t[1]:null}extractUnitNameFromTarget(e){const t=e.match(/^\d+\s+(.+)$/);return t?t[1]:null}validateEnemyUnitBattleConfiguration(e){if(!e)throw new Error("Battle configuration is required");const t=f.validateBattleConfiguration({playerArmy:e.playerArmy,enemyUnits:e.enemyUnits});if(!t.isValid)throw new Error(t.errors[0]);for(const i of e.playerArmy.stackingOrder){if(!i.unitName||i.unitName.trim()==="")throw new Error("All unit groups must have a valid name");if(i.count<=0)throw new Error(`Unit group "${i.unitName}" must have a positive count`);if(i.unitStrength<=0)throw new Error(`Unit group "${i.unitName}" must have positive strength`);if(i.totalHealth<=0)throw new Error(`Unit group "${i.unitName}" must have positive health`)}for(const i of e.enemyUnits){if(!i.name||i.name.trim()==="")throw new Error("All enemy units must have a valid name");if(i.health<=0)throw new Error(`Enemy unit "${i.name}" must have positive health`);if(i.strength<0)throw new Error(`Enemy unit "${i.name}" cannot have negative strength`)}}getEnemyUnitBattleStatistics(e){const t=w.calculateBattleStatistics(e.combatLog,e.totalDamageDealtToEnemies),i=e.combatLog.filter(r=>r.enemyUnit!==void 0),n={},a={},s={};return i.forEach(r=>{if(r.enemyUnit){const o=r.enemyUnit.name;if(r.eliminated)a[o]=(a[o]||0)+1,r.modifiersApplied&&r.modifiersApplied.forEach(l=>{const c=`${o} vs ${l.type}`;s[c]=(s[c]||0)+l.value});else{const l=r.damageDealt||0;n[o]=(n[o]||0)+l}}}),{...t,damageByEnemyUnit:n,attacksByEnemyUnit:a,modifiersUsed:s,totalEnemyUnitsInvolved:Object.keys(a).length,totalModifierApplications:Object.keys(s).length}}}class A{static isPlayerUnit(e){return"unitName"in e&&"count"in e}static isEnemyUnit(e){return"name"in e&&"unit_types"in e&&!("count"in e)}static getUnitName(e){return A.isPlayerUnit(e)?e.unitName:e.name}static getUnitTypes(e,t){return A.isEnemyUnit(e)?e.unit_types:t?t.unitTypes[e.unitName]||[]:[]}static getBaseStrength(e){return A.isPlayerUnit(e)?e.unitStrength:e.strength}static getHealth(e){return A.isPlayerUnit(e)?e.totalHealth:e.health}static calculateTotalHealth(e){return A.isPlayerUnit(e)?e.totalHealth*e.count:e.health}static calculateBaseDamage(e){return A.isPlayerUnit(e)?e.count*e.unitStrength:e.strength}static formatForDisplay(e){return A.isPlayerUnit(e)?`${e.count} ${e.unitName}`:e.name}}const O={optimizePlayerOrder:!0,optimizeEnemyOrder:!0,useUnitModifiers:!0,maxCalculationTimeMs:5e3,enableCaching:!0,algorithm:"greedy"},K={MAX_UNITS_FOR_EXACT_OPTIMIZATION:50,MAX_CACHE_SIZE:1e4};class be{constructor(){p(this,"damageCalculationCache",new Map);p(this,"modifierCache",new Map);p(this,"metrics",this.initializeMetrics())}initializeMetrics(){return{totalUnitsProcessed:0,totalCalculations:0,cacheHitRate:0,memoryUsageBytes:0,timeBreakdown:{damageCalculation:0,matrixGeneration:0,optimization:0,caching:0}}}async optimizeBidirectional(e,t,i=O){const n=performance.now();this.metrics=this.initializeMetrics();let a,s;i.optimizePlayerOrder?a=await this.optimizeAttackOrder(e,t,"player",i):a=this.createNoOptimizationResult(e,t,"player"),i.optimizeEnemyOrder?s=await this.optimizeAttackOrder(t,e,"enemy",i):s=this.createNoOptimizationResult(t,e,"enemy");const r=performance.now()-n;return{playerOptimization:a,enemyOptimization:s,combinedMetrics:{totalDamageImprovement:a.optimizedTotalDamage-a.originalTotalDamage+s.optimizedTotalDamage-s.originalTotalDamage,averageImprovementPercentage:(a.improvementPercentage+s.improvementPercentage)/2,totalOptimizationTimeMs:r}}}async optimizeAttackOrder(e,t,i,n){const a=performance.now(),s=await this.generateDamageMatrix(e,t,i,n),r=this.calculateTotalDamage(e,t,s),o=this.optimizeOrder(e,t,s,n),l=this.calculateTotalDamage(o,t,s),c=performance.now()-a,d=r>0?(l-r)/r*100:0;return{originalOrder:[...e],optimizedOrder:o,damageMatrix:s,originalTotalDamage:r,optimizedTotalDamage:l,improvementPercentage:d,side:i,optimizationTimeMs:c}}async generateDamageMatrix(e,t,i,n){const a=performance.now(),s=[];for(let o=0;o<e.length;o++){s[o]=[];for(let l=0;l<t.length;l++){const c=e[o],d=t[l];s[o][l]=await this.calculateEffectiveDamage(c,d,i,i==="player"?"enemy":"player",n),this.metrics.totalCalculations++}}const r=performance.now()-a;return this.metrics.timeBreakdown.matrixGeneration+=r,{calculations:s,attackers:[...e],targets:[...t],calculationTimeMs:r}}async calculateEffectiveDamage(e,t,i,n,a){const s=performance.now(),r=A.calculateBaseDamage(e);let o=r;const l=[];if(a.useUnitModifiers){const m=await this.applyUnitModifiers(e,t,r);o=m.modifiedValue,l.push(...m.appliedModifiers)}const c=A.calculateTotalHealth(t),d=Math.min(o,c);return this.metrics.timeBreakdown.damageCalculation+=performance.now()-s,{attacker:e,target:t,baseDamage:r,effectiveDamage:d,modifiersApplied:l,attackerSide:i,targetSide:n}}async applyUnitModifiers(e,t,i){const n=A.getUnitName(e),a=A.getUnitName(t),s=`${n}:${a}:${i}`;if(this.modifierCache.has(s))return this.modifierCache.get(s);let r=i;const o=[],l=A.isEnemyUnit(t)?t.unit_types:this.getPlayerUnitTypes(t.unitName);if(A.isEnemyUnit(e)){const d=e;if(d.attack_modifiers){for(const m of d.attack_modifiers)if(l.some(u=>u.toLowerCase()===m.target_type.toLowerCase())){const u=m.value;r+=u,o.push({type:`vs ${m.target_type}`,value:u,source:d.name})}}}else if(A.isEnemyUnit(t)){const d=await this.getPlayerUnitData(e.unitName);if(d&&d.attack_modifiers){for(const m of d.attack_modifiers)if(l.some(u=>u.toLowerCase()===m.target_type.toLowerCase())){const u=m.value;r+=u,o.push({type:`vs ${m.target_type}`,value:u,source:e.unitName})}}}r=Math.max(0,r);const c={baseValue:i,modifiedValue:r,appliedModifiers:o,hasModifiers:o.length>0};return this.modifierCache.size<K.MAX_CACHE_SIZE&&this.modifierCache.set(s,c),c}optimizeOrder(e,t,i,n){const a=performance.now();let s;switch(n.algorithm){case"greedy":s=this.greedyOptimization(e,t,i);break;case"dynamic":s=this.dynamicOptimization(e,t,i);break;case"heuristic":s=this.heuristicOptimization(e,t,i);break;default:s=this.greedyOptimization(e,t,i)}return this.metrics.timeBreakdown.optimization+=performance.now()-a,s}greedyOptimization(e,t,i){const n=[],a=[...e];for(;a.length>0;){let s=-1,r=0;for(let o=0;o<a.length;o++){const l=e.indexOf(a[o]);let c=0;for(let d=0;d<t.length;d++)c+=i.calculations[l][d].effectiveDamage;c>s&&(s=c,r=o)}n.push(a[r]),a.splice(r,1)}return n}dynamicOptimization(e,t,i){return this.greedyOptimization(e,t,i)}heuristicOptimization(e,t,i){return e.length>K.MAX_UNITS_FOR_EXACT_OPTIMIZATION?[...e].sort((n,a)=>A.calculateBaseDamage(a)-A.calculateBaseDamage(n)):this.greedyOptimization(e,t,i)}calculateTotalDamage(e,t,i){let n=0;for(let a=0;a<e.length;a++){const s=i.attackers.indexOf(e[a]);if(s>=0)for(let r=0;r<t.length;r++)n+=i.calculations[s][r].effectiveDamage}return n}createNoOptimizationResult(e,t,i){const n={calculations:[],attackers:[...e],targets:[...t],calculationTimeMs:0};return{originalOrder:[...e],optimizedOrder:[...e],damageMatrix:n,originalTotalDamage:0,optimizedTotalDamage:0,improvementPercentage:0,side:i,optimizationTimeMs:0}}getMetrics(){const e=this.metrics.totalCalculations,t=this.damageCalculationCache.size+this.modifierCache.size;return this.metrics.cacheHitRate=e>0?t/e:0,this.metrics.memoryUsageBytes=this.damageCalculationCache.size*64+this.modifierCache.size*128,{...this.metrics}}clearCache(){this.damageCalculationCache.clear(),this.modifierCache.clear()}getPlayerUnitTypes(e){return P.getUnitTypes(e)}async getPlayerUnitData(e){return P.getFullUnitData(e)}initialize(e){P.initialize(e)}}const q=new be;class j extends ee{constructor(){super(...arguments);p(this,"optimizationCache",new Map)}initialize(t){super.initialize(t),q.initialize(t)}simulateOptimizedBattle(t){if(!t.useOptimization)return{...this.simulateBattle(t),optimizationUsed:!1};const i=Array.from({length:t.enemyGroupCount},(n,a)=>({name:`Enemy Group ${a+1}`,unit_types:["Generic"],health:1e6,strength:1e3,attack_modifiers:[]}));return this.simulateOptimizedBattleWithEnemyUnits({...t,enemyUnits:i,optimizationConfig:t.optimizationConfig||O,useOptimization:!0})}simulateOptimizedBattleWithEnemyUnits(t){if(!t.useOptimization)return{...this.simulateBattleWithEnemyUnits(t),optimizationUsed:!1};const i=t.optimizationConfig||O,n=this.createOptimizationCacheKey(t.playerArmy.stackingOrder,t.enemyUnits,i);let a;if(this.optimizationCache.has(n))a=this.optimizationCache.get(n);else try{a=this.performSynchronousOptimization(t.playerArmy.stackingOrder,t.enemyUnits,i),this.optimizationCache.size<100&&this.optimizationCache.set(n,a)}catch(l){return console.warn("Attack order optimization failed, falling back to standard simulation:",l),{...this.simulateBattleWithEnemyUnits(t),optimizationUsed:!1}}const s={...t,playerArmy:{...t.playerArmy,stackingOrder:(a==null?void 0:a.playerOptimization.optimizedOrder)||t.playerArmy.stackingOrder}},r=this.simulateBattleWithEnemyUnits(s),o=q.getMetrics();return{...r,optimizationResult:a,optimizationUsed:!0,optimizationMetrics:o}}performSynchronousOptimization(t,i,n){const a=this.optimizePlayerOrder(t,i,n),s=this.optimizeEnemyOrder(i,t,n);return{playerOptimization:a,enemyOptimization:s,combinedMetrics:{totalDamageImprovement:a.optimizedTotalDamage-a.originalTotalDamage+s.optimizedTotalDamage-s.originalTotalDamage,averageImprovementPercentage:(a.improvementPercentage+s.improvementPercentage)/2,totalOptimizationTimeMs:a.optimizationTimeMs+s.optimizationTimeMs}}}optimizePlayerOrder(t,i,n){const a=performance.now();if(!n.optimizePlayerOrder)return this.createNoOptimizationResult(t,"player",a);const s=[...t].sort((c,d)=>{const m=this.calculateSimpleDamage(c,i);return this.calculateSimpleDamage(d,i)-m}),r=this.calculateTotalSimpleDamage(t,i),o=this.calculateTotalSimpleDamage(s,i),l=r>0?(o-r)/r*100:0;return{originalOrder:[...t],optimizedOrder:s,damageMatrix:{calculations:[],attackers:[],targets:[],calculationTimeMs:0},originalTotalDamage:r,optimizedTotalDamage:o,improvementPercentage:l,side:"player",optimizationTimeMs:performance.now()-a}}optimizeEnemyOrder(t,i,n){const a=performance.now();if(!n.optimizeEnemyOrder)return this.createNoOptimizationResult(t,"enemy",a);const s=[...t].sort((c,d)=>d.strength-c.strength),r=t.reduce((c,d)=>c+d.strength,0),o=s.reduce((c,d)=>c+d.strength,0);return{originalOrder:[...t],optimizedOrder:s,damageMatrix:{calculations:[],attackers:[],targets:[],calculationTimeMs:0},originalTotalDamage:r,optimizedTotalDamage:o,improvementPercentage:0,side:"enemy",optimizationTimeMs:performance.now()-a}}calculateSimpleDamage(t,i){const n=t.count*t.unitStrength;let a=0;for(const s of i){let r=n;const o=this.unitLoader?this.unitLoader.getUnitByName(t.unitName):null;if(o&&o.attack_modifiers)for(const l of o.attack_modifiers)s.unit_types.some(c=>c.toLowerCase()===l.target_type.toLowerCase())&&(r+=l.value*t.count);a+=Math.max(0,r)}return a}calculateTotalSimpleDamage(t,i){return t.reduce((n,a)=>n+this.calculateSimpleDamage(a,i),0)}createNoOptimizationResult(t,i,n){return{originalOrder:[...t],optimizedOrder:[...t],damageMatrix:{calculations:[],attackers:[],targets:[],calculationTimeMs:0},originalTotalDamage:0,optimizedTotalDamage:0,improvementPercentage:0,side:i,optimizationTimeMs:performance.now()-n}}createOptimizationCacheKey(t,i,n){const a=t.map(o=>`${o.unitName}:${o.count}:${o.unitStrength}`).join("|"),s=i.map(o=>`${o.name}:${o.strength}`).join("|"),r=`${n.optimizePlayerOrder}:${n.optimizeEnemyOrder}:${n.useUnitModifiers}`;return`${a}::${s}::${r}`}calculateOptimizedAttackOrder(t,i,n=O){if(!n.optimizePlayerOrder||!i||i.length===0)return this.calculateAttackOrder(t);try{return this.optimizePlayerOrder(t,i,n).optimizedOrder}catch(a){return console.warn("Attack order optimization failed, using standard calculation:",a),this.calculateAttackOrder(t)}}compareOptimizationBenefit(t,i,n=O){var u;const a={playerArmy:t,enemyUnits:i,playerGoesFirst:!0,useEnemyModifiers:!0},s=this.simulateBattleWithEnemyUnits(a),r={...a,useOptimization:!0,optimizationConfig:n},o=this.simulateOptimizedBattleWithEnemyUnits(r),l=o.totalDamageDealtToEnemies-s.totalDamageDealtToEnemies,c=s.totalDamageDealtToEnemies>0?l/s.totalDamageDealtToEnemies*100:0,d=o.playerSurvivalTurns-s.playerSurvivalTurns,m=((u=o.optimizationResult)==null?void 0:u.combinedMetrics.totalOptimizationTimeMs)||0;return{standardResult:s,optimizedResult:o,improvement:{damageIncrease:l,damageIncreasePercentage:c,survivalIncrease:d,optimizationTimeMs:m}}}simulateBothScenariosWithEnemyUnits(t,i,n=!0){const a={playerArmy:t,enemyUnits:i,playerGoesFirst:!0,useEnemyModifiers:n,useOptimization:!0,optimizationConfig:O},s=this.simulateOptimizedBattleWithEnemyUnits({...a,playerGoesFirst:!0}),r=this.simulateOptimizedBattleWithEnemyUnits({...a,playerGoesFirst:!1}),o=s.totalDamageDealtToEnemies-r.totalDamageDealtToEnemies,l=s.playerSurvivalTurns-r.playerSurvivalTurns,c=(s.totalDamageDealtToEnemies+r.totalDamageDealtToEnemies)/2,d=(s.playerSurvivalTurns+r.playerSurvivalTurns)/2;return{bestCase:s,worstCase:r,comparison:{damageDifference:o,survivalDifference:l,averageDamage:c,averageSurvival:d}}}clearOptimizationCache(){this.optimizationCache.clear(),q.clearCache()}}const ve=new j,Ee=Object.freeze(Object.defineProperty({__proto__:null,OptimizedBattleSimulationService:j,optimizedBattleSimulationService:ve},Symbol.toStringTag,{value:"Module"}));class te{constructor(){p(this,"enemyUnits",[]);p(this,"enemyUnitsByName",new Map);p(this,"enemyUnitsByType",new Map);this.resetData()}async loadPresetEnemyUnits(){return this.loadEnemyUnits(X.ENEMY_UNITS)}async loadEnemyUnits(e){try{let t;if(typeof e=="string"){console.log(`Loading enemy units from: ${e}`);const i=await fetch(e);if(!i.ok)throw new Error(`Failed to fetch enemy units: ${i.status} ${i.statusText}`);t=await i.json()}else t=e;if(!Array.isArray(t))throw new Error("Enemy unit data must be an array");return this.enemyUnits=t.map(i=>this.validateAndNormalizeEnemyUnit(i)),this.buildLookups(),console.log(`✅ Loaded ${this.enemyUnits.length} enemy units successfully`),this.enemyUnits}catch(t){throw console.error("❌ Error loading enemy units:",t),t}}validateAndNormalizeEnemyUnit(e){const t={name:e.name||"Unknown Enemy",unit_types:Array.isArray(e.unit_types)?e.unit_types:[],health:Number(e.health)||0,strength:Number(e.strength)||0,attack_modifiers:Array.isArray(e.attack_modifiers)?e.attack_modifiers:[]};return(!Array.isArray(t.unit_types)||t.unit_types.length===0)&&(console.warn(`Enemy unit ${t.name} has no unit types, adding 'Unknown'`),t.unit_types=["Unknown"]),t.health<=0&&(console.warn(`Enemy unit ${t.name} has invalid health: ${t.health}`),t.health=1),t.strength<0&&(console.warn(`Enemy unit ${t.name} has negative strength: ${t.strength}`),t.strength=0),t.attack_modifiers&&Array.isArray(t.attack_modifiers)&&(t.attack_modifiers=t.attack_modifiers.filter(i=>!i||typeof i!="object"?(console.warn(`Enemy unit ${t.name} has invalid attack modifier object`),!1):!i.target_type||typeof i.value!="number"?(console.warn(`Enemy unit ${t.name} has invalid attack modifier: ${JSON.stringify(i)}`),!1):!0)),t}buildLookups(){this.resetData(),this.enemyUnitsByName=new Map(this.enemyUnits.map(e=>[e.name,e])),this.enemyUnits.forEach(e=>{e.unit_types.forEach(t=>{this.enemyUnitsByType.has(t)||this.enemyUnitsByType.set(t,[]),this.enemyUnitsByType.get(t).push(e)})}),this.enemyUnitsByType.forEach(e=>{e.sort((t,i)=>i.strength-t.strength)})}resetData(){this.enemyUnitsByName.clear(),this.enemyUnitsByType.clear()}getAllEnemyUnits(){return[...this.enemyUnits]}getEnemyUnitByName(e){return this.enemyUnitsByName.get(e)}getEnemyUnitsByType(e){return[...this.enemyUnitsByType.get(e)||[]]}getUniqueEnemyUnitTypes(){return Array.from(this.enemyUnitsByType.keys()).sort()}filterEnemyUnits(e){let t=this.enemyUnits;return e.unitTypes&&e.unitTypes.length>0&&(t=t.filter(i=>e.unitTypes.some(n=>i.unit_types.includes(n)))),e.minStrength!==void 0&&(t=t.filter(i=>i.strength>=e.minStrength)),e.maxStrength!==void 0&&(t=t.filter(i=>i.strength<=e.maxStrength)),e.minHealth!==void 0&&(t=t.filter(i=>i.health>=e.minHealth)),e.maxHealth!==void 0&&(t=t.filter(i=>i.health<=e.maxHealth)),t}searchEnemyUnits(e){if(!e.trim())return this.getAllEnemyUnits();const t=e.toLowerCase();return this.enemyUnits.filter(i=>i.name.toLowerCase().includes(t))}getEnhancedEnemyUnits(){return this.enemyUnits.map(e=>({...e,get strengthPerHealth(){return f.getStrengthPerHealth(e)},get effectivenessScore(){return f.getEffectivenessScore(e)}}))}getEnemyUnitSummary(){if(this.enemyUnits.length===0)return{totalUnits:0,byUnitType:{},strengthRange:{min:0,max:0,average:0},healthRange:{min:0,max:0,average:0}};const e=this.enemyUnits.map(n=>n.strength),t=this.enemyUnits.map(n=>n.health),i={};return this.enemyUnitsByType.forEach((n,a)=>{i[a]=n.length}),{totalUnits:this.enemyUnits.length,byUnitType:i,strengthRange:{min:Math.min(...e),max:Math.max(...e),average:Math.round(e.reduce((n,a)=>n+a,0)/e.length)},healthRange:{min:Math.min(...t),max:Math.max(...t),average:Math.round(t.reduce((n,a)=>n+a,0)/t.length)}}}getStatistics(){if(this.enemyUnits.length===0)return{totalUnits:0,unitTypeDistribution:{},strengthStats:{min:0,max:0,avg:0},healthStats:{min:0,max:0,avg:0},topUnitsByStrength:[],topUnitsByHealth:[],unitsWithAttackModifiers:0};const e=this.enemyUnits.map(a=>a.strength),t=this.enemyUnits.map(a=>a.health),i={};this.enemyUnitsByType.forEach((a,s)=>{i[s]=a.length});const n=this.enemyUnits.filter(a=>a.attack_modifiers&&Array.isArray(a.attack_modifiers)&&a.attack_modifiers.length>0).length;return{totalUnits:this.enemyUnits.length,unitTypeDistribution:i,strengthStats:{min:Math.min(...e),max:Math.max(...e),avg:Math.round(e.reduce((a,s)=>a+s,0)/e.length)},healthStats:{min:Math.min(...t),max:Math.max(...t),avg:Math.round(t.reduce((a,s)=>a+s,0)/t.length)},topUnitsByStrength:[...this.enemyUnits].sort((a,s)=>s.strength-a.strength).slice(0,10),topUnitsByHealth:[...this.enemyUnits].sort((a,s)=>s.health-a.health).slice(0,10),unitsWithAttackModifiers:n}}getEnemyUnitsWithModifiersAgainst(e){return this.enemyUnits.filter(t=>!t.attack_modifiers||!Array.isArray(t.attack_modifiers)?!1:e.some(i=>t.attack_modifiers.some(n=>n.target_type.toLowerCase()===i.toLowerCase())))}getMostEffectiveAgainst(e,t=5){return this.enemyUnits.map(i=>({unit:i,effectiveness:this.calculateEffectivenessAgainst(i,e)})).sort((i,n)=>n.effectiveness-i.effectiveness).slice(0,t).map(i=>i.unit)}calculateEffectivenessAgainst(e,t){let i=f.getEffectivenessScore(e);return e.attack_modifiers&&Array.isArray(e.attack_modifiers)&&t.forEach(n=>{const a=f.getAttackModifierAgainst(e,n);i+=a*.1}),i}}class T{static validateEnemyUnit(e){return f.validateEnemyUnit(e)}static validateUserEnemyUnit(e){const t=f.validateEnemyUnit(e),i=[...t.errors],n=[...t.warnings||[]];return(!e.id||typeof e.id!="string"||e.id.trim()==="")&&i.push("User enemy unit must have a valid ID"),(!e.createdAt||!(e.createdAt instanceof Date))&&i.push("User enemy unit must have a valid creation date"),(!e.modifiedAt||!(e.modifiedAt instanceof Date))&&i.push("User enemy unit must have a valid modification date"),e.createdAt&&e.modifiedAt&&e.createdAt instanceof Date&&e.modifiedAt instanceof Date&&e.modifiedAt<e.createdAt&&i.push("Modification date cannot be before creation date"),{isValid:i.length===0,errors:i,warnings:n.length>0?n:void 0}}static validateName(e){if(!e||typeof e!="string")return{isValid:!1,error:"Name must be a non-empty string"};const t=e.trim();return t.length===0?{isValid:!1,error:"Name cannot be empty or only whitespace"}:t.length>100?{isValid:!1,error:"Name cannot exceed 100 characters"}:/[<>\"'&]/.test(t)?{isValid:!1,error:`Name contains invalid characters (<, >, ", ', &)`}:{isValid:!0}}static validateUnitTypes(e){const t=[];if(!Array.isArray(e))return{isValid:!1,error:"Unit types must be an array"};if(e.length===0)return{isValid:!1,error:"At least one unit type is required"};if(e.length>10)return{isValid:!1,error:"Cannot have more than 10 unit types"};for(let n=0;n<e.length;n++){const a=e[n];if(typeof a!="string"||a.trim()==="")return{isValid:!1,error:`Unit type ${n+1} must be a non-empty string`};le.includes(a)||t.push(`Unit type '${a}' is not a standard type`)}return new Set(e).size!==e.length?{isValid:!1,error:"Unit types cannot contain duplicates"}:{isValid:!0,warnings:t.length>0?t:void 0}}static validateHealth(e){const t=[];return typeof e!="number"?{isValid:!1,error:"Health must be a number"}:Number.isFinite(e)?e<=0?{isValid:!1,error:"Health must be greater than 0"}:e>5e7?{isValid:!1,error:"Health cannot exceed 50,000,000"}:(e<100&&t.push("Health value is unusually low (less than 100)"),e>1e7&&t.push("Health value is unusually high (greater than 10,000,000)"),{isValid:!0,warnings:t.length>0?t:void 0}):{isValid:!1,error:"Health must be a finite number"}}static validateStrength(e){const t=[];return typeof e!="number"?{isValid:!1,error:"Strength must be a number"}:Number.isFinite(e)?e<0?{isValid:!1,error:"Strength cannot be negative"}:e>25e6?{isValid:!1,error:"Strength cannot exceed 25,000,000"}:(e===0&&t.push("Strength value of 0 means this unit cannot deal damage"),e<50&&t.push("Strength value is unusually low (less than 50)"),e>5e6&&t.push("Strength value is unusually high (greater than 5,000,000)"),{isValid:!0,warnings:t.length>0?t:void 0}):{isValid:!1,error:"Strength must be a finite number"}}static validateAttackModifiers(e){const t=[];if(e==null)return{isValid:!0};if(!Array.isArray(e))return{isValid:!1,error:"Attack modifiers must be an array"};if(e.length>20)return{isValid:!1,error:"Cannot have more than 20 attack modifiers"};for(let a=0;a<e.length;a++){const s=e[a];if(!s||typeof s!="object")return{isValid:!1,error:`Attack modifier ${a+1} must be an object`};if(!s.target_type||typeof s.target_type!="string")return{isValid:!1,error:`Attack modifier ${a+1}: target_type is required and must be a string`};if(de.includes(s.target_type)||t.push(`Attack modifier ${a+1}: '${s.target_type}' is not a standard target type`),!s.modifier_type||!ce.includes(s.modifier_type))return{isValid:!1,error:`Attack modifier ${a+1}: modifier_type must be 'Strength'`};if(typeof s.value!="number"||!Number.isFinite(s.value))return{isValid:!1,error:`Attack modifier ${a+1}: value must be a finite number`};if(s.value<0)return{isValid:!1,error:`Attack modifier ${a+1}: value cannot be negative`};if(s.value>1e7)return{isValid:!1,error:`Attack modifier ${a+1}: value cannot exceed 10,000,000`};s.value>1e6&&t.push(`Attack modifier ${a+1}: value is unusually high (${s.value})`)}const i=e.map(a=>{var s;return(s=a.target_type)==null?void 0:s.toLowerCase()}).filter(Boolean);return new Set(i).size!==i.length?{isValid:!1,error:"Attack modifiers cannot have duplicate target types"}:{isValid:!0,warnings:t.length>0?t:void 0}}static validateForImport(e){const t=[],i=[];if(!e||typeof e!="object")return{isValid:!1,errors:["Data must be an object"]};const n=this.validateName(e.name);n.isValid||t.push(n.error);const a=this.validateUnitTypes(e.unit_types);a.isValid?a.warnings&&i.push(...a.warnings):t.push(a.error);const s=this.validateHealth(e.health);s.isValid?s.warnings&&i.push(...s.warnings):t.push(s.error);const r=this.validateStrength(e.strength);r.isValid?r.warnings&&i.push(...r.warnings):t.push(r.error);const o=this.validateAttackModifiers(e.attack_modifiers);return o.isValid?o.warnings&&i.push(...o.warnings):t.push(o.error),{isValid:t.length===0,errors:t,warnings:i.length>0?i:void 0}}static validateMultipleUnits(e){if(!Array.isArray(e))return{isValid:!1,results:[],summary:{total:0,valid:0,invalid:0,warnings:0}};const t=e.map((n,a)=>({index:a,validation:this.validateForImport(n)})),i={total:e.length,valid:t.filter(n=>n.validation.isValid).length,invalid:t.filter(n=>!n.validation.isValid).length,warnings:t.filter(n=>n.validation.warnings&&n.validation.warnings.length>0).length};return{isValid:i.invalid===0,results:t,summary:i}}static sanitizeEnemyUnit(e){const t={name:typeof e.name=="string"?e.name.trim():"Unknown Enemy",unit_types:Array.isArray(e.unit_types)?e.unit_types.filter(i=>typeof i=="string"&&i.trim()!==""):["Epic Monster"],health:typeof e.health=="number"&&e.health>0?Math.min(e.health,5e7):1e4,strength:typeof e.strength=="number"&&e.strength>=0?Math.min(e.strength,25e6):5e3,attack_modifiers:Array.isArray(e.attack_modifiers)?e.attack_modifiers.filter(i=>i&&typeof i=="object"&&typeof i.target_type=="string"&&typeof i.value=="number"&&i.value>=0).map(i=>({target_type:i.target_type,modifier_type:"Strength",value:Math.min(i.value,1e7)})):[]};return t.name.length===0&&(t.name="Unknown Enemy"),t.unit_types.length===0&&(t.unit_types=["Epic Monster"]),t}}const I=class I{constructor(e={}){p(this,"storageKey");p(this,"metadataKey");p(this,"maxUnits");p(this,"validateOnLoad");this.storageKey=e.storagePrefix?`${e.storagePrefix}_user_enemy_units`:I.DEFAULT_STORAGE_KEY,this.metadataKey=e.storagePrefix?`${e.storagePrefix}_enemy_units_metadata`:I.METADATA_KEY,this.maxUnits=e.maxUnits||I.DEFAULT_MAX_UNITS,this.validateOnLoad=e.validateOnLoad!==!1}isStorageAvailable(){try{const e="__storage_test__";return localStorage.setItem(e,e),localStorage.removeItem(e),!0}catch{return!1}}getAllUserEnemyUnits(){if(!this.isStorageAvailable())return console.warn("localStorage is not available"),[];try{const e=localStorage.getItem(this.storageKey);if(!e)return[];const i=JSON.parse(e).map(n=>({...n,createdAt:new Date(n.createdAt),modifiedAt:new Date(n.modifiedAt)}));return this.validateOnLoad?i.filter(n=>{const a=T.validateUserEnemyUnit(n);return a.isValid?!0:(console.warn(`Invalid stored enemy unit removed: ${n.name}`,a.errors),!1)}):i}catch(e){return console.error("Error loading user enemy units from storage:",e),[]}}saveAllUserEnemyUnits(e){if(!this.isStorageAvailable())return console.warn("localStorage is not available"),!1;try{return localStorage.setItem(this.storageKey,JSON.stringify(e)),this.updateMetadata(),!0}catch(t){return console.error("Error saving user enemy units to storage:",t),!1}}addUserEnemyUnit(e){const t=T.validateEnemyUnit(e);if(!t.isValid)return{success:!1,error:`Validation failed: ${t.errors.join(", ")}`};const i=this.getAllUserEnemyUnits();if(i.length>=this.maxUnits)return{success:!1,error:`Maximum number of units (${this.maxUnits}) reached`};if(i.some(s=>s.name.toLowerCase()===e.name.toLowerCase()))return{success:!1,error:`A unit with the name "${e.name}" already exists`};const n=f.createUserEnemyUnit(e);return i.push(n),this.saveAllUserEnemyUnits(i)?{success:!0,unit:n}:{success:!1,error:"Failed to save unit to storage"}}updateUserEnemyUnit(e,t){const i=this.getAllUserEnemyUnits(),n=i.findIndex(c=>c.id===e);if(n===-1)return{success:!1,error:"Unit not found"};const a=i[n],s={...a,...t},r=T.validateUserEnemyUnit(s);if(!r.isValid)return{success:!1,error:`Validation failed: ${r.errors.join(", ")}`};if(t.name&&i.some((c,d)=>d!==n&&c.name.toLowerCase()===t.name.toLowerCase()))return{success:!1,error:`A unit with the name "${t.name}" already exists`};const o=f.updateUserEnemyUnit(a,t);return i[n]=o,this.saveAllUserEnemyUnits(i)?{success:!0,unit:o}:{success:!1,error:"Failed to save updated unit to storage"}}deleteUserEnemyUnit(e){const t=this.getAllUserEnemyUnits(),i=t.findIndex(a=>a.id===e);return i===-1?{success:!1,error:"Unit not found"}:(t.splice(i,1),this.saveAllUserEnemyUnits(t)?{success:!0}:{success:!1,error:"Failed to save changes to storage"})}getUserEnemyUnitById(e){return this.getAllUserEnemyUnits().find(i=>i.id===e)||null}searchUserEnemyUnits(e){const t=this.getAllUserEnemyUnits();if(!e.trim())return t;const i=e.toLowerCase();return t.filter(n=>n.name.toLowerCase().includes(i))}clearAllUserEnemyUnits(){if(!this.isStorageAvailable())return{success:!1,error:"localStorage is not available"};try{return localStorage.removeItem(this.storageKey),localStorage.removeItem(this.metadataKey),{success:!0}}catch{return{success:!1,error:"Failed to clear storage"}}}exportUserEnemyUnits(){try{const e=this.getAllUserEnemyUnits(),t={version:"1.0",exportDate:new Date().toISOString(),units:e.map(i=>{var n,a;return{name:i.name,unit_types:i.unit_types,health:i.health,strength:i.strength,attack_modifiers:i.attack_modifiers,createdAt:((n=i.createdAt)==null?void 0:n.toISOString())??new Date().toISOString(),modifiedAt:((a=i.modifiedAt)==null?void 0:a.toISOString())??new Date().toISOString()}})};return{success:!0,data:JSON.stringify(t,null,2)}}catch{return{success:!1,error:"Failed to export units"}}}importUserEnemyUnits(e,t={}){try{const i=JSON.parse(e);if(!i.units||!Array.isArray(i.units))return{success:!1,errors:["Invalid import format: units array not found"]};const n=t.replace?[]:this.getAllUserEnemyUnits(),a=[];let s=0,r=0;for(const l of i.units){const c=T.validateForImport(l);if(!c.isValid){a.push(`Unit "${l.name||"Unknown"}": ${c.errors.join(", ")}`),r++;continue}if(n.some(u=>u.name.toLowerCase()===l.name.toLowerCase()))if(t.skipDuplicates){r++;continue}else{a.push(`Unit "${l.name}" already exists`),r++;continue}if(n.length>=this.maxUnits){a.push(`Maximum number of units (${this.maxUnits}) reached`);break}const m=f.createUserEnemyUnit({name:l.name,unit_types:l.unit_types,health:l.health,strength:l.strength,attack_modifiers:l.attack_modifiers||[]});n.push(m),s++}return this.saveAllUserEnemyUnits(n)?{success:!0,imported:s,skipped:r,errors:a.length>0?a:void 0}:{success:!1,errors:["Failed to save imported units to storage"]}}catch{return{success:!1,errors:["Invalid JSON format"]}}}getStorageStats(){var s;const e=this.getAllUserEnemyUnits(),t=new Date;t.setHours(0,0,0,0);const i=e.filter(r=>r.createdAt&&r.createdAt>=t).length;let n=null;e.length>0&&(n=new Date(Math.max(...e.map(r=>{var o;return((o=r.modifiedAt)==null?void 0:o.getTime())??0}))));const a=this.isStorageAvailable()?(((s=localStorage.getItem(this.storageKey))==null?void 0:s.length)||0)*2:0;return{totalUnits:e.length,storageSize:a,lastModified:n,unitsCreatedToday:i}}updateMetadata(){if(this.isStorageAvailable())try{const e={lastModified:new Date().toISOString(),version:"1.0"};localStorage.setItem(this.metadataKey,JSON.stringify(e))}catch(e){console.warn("Failed to update metadata:",e)}}getAvailableSpace(){return Math.max(0,this.maxUnits-this.getAllUserEnemyUnits().length)}isNearCapacity(e=.9){return this.getAllUserEnemyUnits().length>=this.maxUnits*e}};p(I,"DEFAULT_STORAGE_KEY","army_calculator_user_enemy_units"),p(I,"METADATA_KEY","army_calculator_enemy_units_metadata"),p(I,"DEFAULT_MAX_UNITS",100);let N=I;class ie{constructor(e){p(this,"container",null);p(this,"props");p(this,"loader");p(this,"storage");p(this,"presetUnits",[]);p(this,"userUnits",[]);p(this,"filteredUnits",[]);p(this,"currentFilter","");p(this,"currentCategory","all");p(this,"currentSelectedUnits",[]);this.props=e,this.loader=new te,this.storage=new N,this.currentSelectedUnits=e.selectedUnits?[...e.selectedUnits]:[]}async mount(e){this.container=e,await this.loadData(),this.render(),this.attachEventListeners()}async loadData(){try{this.presetUnits=await this.loader.loadPresetEnemyUnits(),this.userUnits=this.storage.getAllUserEnemyUnits(),this.updateFilteredUnits()}catch(e){console.error("Error loading enemy unit data:",e),this.presetUnits=[],this.userUnits=[],this.filteredUnits=[]}}updateFilteredUnits(){let e=[];switch(this.currentCategory){case"preset":e=[...this.presetUnits];break;case"user":e=[...this.userUnits];break;case"all":default:e=[...this.presetUnits,...this.userUnits];break}if(this.currentFilter.trim()){const t=this.currentFilter.toLowerCase();this.filteredUnits=e.filter(i=>i.name.toLowerCase().includes(t)||i.unit_types.some(n=>n.toLowerCase().includes(t)))}else this.filteredUnits=e;this.filteredUnits.sort((t,i)=>t.name.localeCompare(i.name))}render(){if(!this.container)return;const e=this.props.title||"Select Enemy Unit";this.container.innerHTML=`
    ...
    `,this.addStyles()}renderUnitList(){return this.filteredUnits.length===0?`
      ...
      `:this.filteredUnits.map(e=>{var n;const t=this.props.mode==="multiple"?this.currentSelectedUnits.some(a=>a.name===e.name):((n=this.props.selectedUnit)==null?void 0:n.name)===e.name,i="id"in e;return`
    ...
    `,this.addBattleSimulationStyles())}attachEventListeners(){const e=document.getElementById("run-simulation-btn"),t=document.getElementById("clear-simulation-btn"),i=document.getElementById("enemy-groups"),n=document.getElementById("select-enemy-btn"),a=document.getElementById("clear-enemy-btn");e&&e.addEventListener("click",()=>this.runSimulation()),t&&t.addEventListener("click",()=>this.clearResults()),i&&i.addEventListener("input",()=>this.validateInput()),n&&n.addEventListener("click",()=>this.openEnemyUnitSelector()),a&&a.addEventListener("click",()=>this.clearSelectedEnemyUnit()),document.querySelectorAll('input[name="enemy-type"]').forEach(r=>{r.addEventListener("change",o=>this.handleEnemyTypeChange(o))}),this.attachTooltipListeners()}handleEnemyTypeChange(e){const i=e.target.value,n=document.getElementById("generic-enemy-input"),a=document.getElementById("specific-enemy-input");i==="generic"?(n==null||n.classList.remove("hidden"),a==null||a.classList.add("hidden")):i==="specific"&&(n==null||n.classList.add("hidden"),a==null||a.classList.remove("hidden")),this.validateInput()}async openEnemyUnitSelector(){const e=document.createElement("div");e.id="enemy-unit-selector-modal",document.body.appendChild(e),this.enemyUnitSelector=new ie({onSelect:t=>{this.selectedEnemyUnit=t,this.displaySelectedEnemyUnit(),this.validateInput(),this.closeEnemyUnitSelector()},onCancel:()=>{this.closeEnemyUnitSelector()},selectedUnit:this.selectedEnemyUnit,mode:"single",title:"Select Enemy Unit for Battle"}),await this.enemyUnitSelector.mount(e)}closeEnemyUnitSelector(){this.enemyUnitSelector&&(this.enemyUnitSelector.unmount(),this.enemyUnitSelector=null);const e=document.getElementById("enemy-unit-selector-modal");e&&e.remove()}clearSelectedEnemyUnit(){this.selectedEnemyUnit=null,this.displaySelectedEnemyUnit(),this.validateInput()}displaySelectedEnemyUnit(){const e=document.getElementById("no-enemy-selected"),t=document.getElementById("selected-enemy-info"),i=document.getElementById("clear-enemy-btn");if(!(!e||!t||!i))if(!this.selectedEnemyUnit)e.classList.remove("hidden"),t.classList.add("hidden"),i.style.display="none";else{e.classList.add("hidden"),t.classList.remove("hidden"),i.style.display="inline-block";const n=this.selectedEnemyUnit,a=n.attack_modifiers&&Object.keys(n.attack_modifiers).length>0?Object.entries(n.attack_modifiers).map(([s,r])=>`+${r} vs ${s}`).join(", "):"None";t.innerHTML=`
        <div class="enemy-unit-card">
          <div class="enemy-unit-header">
            <h5 class="enemy-unit-name">${n.name}</h5>
            <div class="enemy-unit-types">
              ${n.unit_types.map(s=>`<span class="unit-type-tag">${s}</span>`).join("")}
            </div>
          </div>
    ...
    `,i.classList.remove("hidden")}resetPlayerSelection(){var i,n;this.playerUnitSelection=this.createEmptySelection();const e=(i=this.container)==null?void 0:i.querySelector("#player-unit-select"),t=(n=this.container)==null?void 0:n.querySelector("#player-quantity");e&&(e.value=""),t&&(t.value="1")}resetEnemySelection(){var n,a,s;this.enemyUnitSelection=this.createEmptySelection();const e=(n=this.container)==null?void 0:n.querySelector("#enemy-unit-select"),t=(a=this.container)==null?void 0:a.querySelector("#enemy-quantity"),i=(s=this.container)==null?void 0:s.querySelector("#enemy-infinite");e&&(e.value=""),t&&(t.value="1",t.disabled=!1),i&&(i.checked=!1)}addStyles(){const e="dual-army-input-styles";if(document.getElementById(e))return;const t=document.createElement("style");t.id=e,t.textContent=`
      .dual-army-input {
        max-width: 1200px;
        margin: 0 auto;
      }
...
`)}`),alert(n)}}handleClearAll(){if(this.userUnits.length===0){alert("No units to clear.");return}if(confirm(`Are you sure you want to delete ALL ${this.userUnits.length} custom enemy units? This action cannot be undone.`)){const e=this.storage.clearAllUserEnemyUnits();e.success?(this.selectedUnits.clear(),this.loadData(),this.refreshUnitsList(),alert("All custom enemy units have been deleted.")):alert(`Failed to clear units: ${e.error}`)}}downloadJson(e,t){const i=new Blob([e],{type:"application/json"}),n=URL.createObjectURL(i),a=document.createElement("a");a.href=n,a.download=t,document.body.appendChild(a),a.click(),document.body.removeChild(a),URL.revokeObjectURL(n)}refreshUnitsList(){const e=document.getElementById("units-list");e&&(e.innerHTML=this.renderUnitsList(),document.querySelectorAll(".unit-select-checkbox").forEach(i=>{i.addEventListener("change",this.handleCheckboxChange.bind(this))}),document.querySelectorAll("[data-action]").forEach(i=>{i.addEventListener("click",this.handleUnitAction.bind(this))}));const t=document.querySelector(".results-info");t&&(t.textContent=`Showing ${this.filteredUnits.length} of ${this.userUnits.length} units${this.selectedUnits.size>0?` (${this.selectedUnits.size} selected)`:""}`)}refreshSelectionUI(){document.querySelectorAll(".unit-select-checkbox").forEach(n=>{const a=n,s=a.dataset.unitId;s&&(a.checked=this.selectedUnits.has(s))}),document.querySelectorAll(".unit-item").forEach(n=>{const a=n.dataset.unitId;a&&(this.selectedUnits.has(a)?n.classList.add("selected"):n.classList.remove("selected"))});const e=document.getElementById("bulk-actions-btn");e&&(e.textContent=`📋 Bulk Actions (${this.selectedUnits.size})`,e.disabled=this.selectedUnits.size===0);const t=document.getElementById("select-none");t&&(t.disabled=this.selectedUnits.size===0);const i=document.querySelector(".results-info");i&&(i.textContent=`Showing ${this.filteredUnits.length} of ${this.userUnits.length} units${this.selectedUnits.size>0?` (${this.selectedUnits.size} selected)`:""}`)}unmount(){this.container&&(this.container.innerHTML="")}}const J={tabletSmall:768,tabletLarge:1024};class we{constructor(){p(this,"currentMode","desktop");p(this,"listeners",[]);this.updateLayoutMode(),this.setupResizeListener()}getCurrentMode(){return this.currentMode}isMobile(){return this.currentMode==="mobile"}isTablet(){return this.currentMode==="tablet"}isDesktop(){return this.currentMode==="desktop"}isTouchDevice(){return"ontouchstart"in window||navigator.maxTouchPoints>0}getViewportWidth(){return window.innerWidth}addLayoutChangeListener(e){this.listeners.push(e)}removeLayoutChangeListener(e){const t=this.listeners.indexOf(e);t>-1&&this.listeners.splice(t,1)}updateLayoutMode(){const e=this.getViewportWidth();let t;e<J.tabletSmall?t="mobile":e<J.tabletLarge?t="tablet":t="desktop",t!==this.currentMode&&(this.currentMode=t,this.notifyListeners())}setupResizeListener(){let e;window.addEventListener("resize",()=>{clearTimeout(e),e=window.setTimeout(()=>{this.updateLayoutMode()},150)})}notifyListeners(){this.listeners.forEach(e=>e(this.currentMode))}}class F{static addSwipeSupport(e,t,i,n=50){if(!("ontouchstart"in window))return;let a=0,s=0,r=0;e.addEventListener("touchstart",o=>{const l=o.touches[0];a=l.clientX,s=l.clientY,r=Date.now()},{passive:!0}),e.addEventListener("touchend",o=>{if(o.changedTouches.length===0)return;const l=o.changedTouches[0],c=l.clientX,d=l.clientY,m=Date.now(),u=c-a,h=d-s;m-r<500&&Math.abs(u)>n&&Math.abs(h)<Math.abs(u)*.5&&(u>0&&i?(o.preventDefault(),i()):u<0&&t&&(o.preventDefault(),t()))},{passive:!1})}static addTouchSupport(e,t){if(e.addEventListener("click",t),"ontouchstart"in window){let i;e.addEventListener("touchstart",n=>{i=Date.now(),e.classList.add("touch-active")}),e.addEventListener("touchend",n=>{e.classList.remove("touch-active"),Date.now()-i<200&&(n.preventDefault(),t())}),e.addEventListener("touchcancel",()=>{e.classList.remove("touch-active")})}}static optimizeScrolling(e){e.style.webkitOverflowScrolling="touch",e.style.scrollBehavior="smooth",e.classList.add("scroll-momentum")}static addHapticFeedback(e){e.addEventListener("touchstart",()=>{e.style.transform="scale(0.98)",e.style.transition="transform 0.1s ease"}),e.addEventListener("touchend",()=>{e.style.transform="scale(1)"}),e.addEventListener("touchcancel",()=>{e.style.transform="scale(1)"})}static addPullToRefresh(e,t,i=80){if(!("ontouchstart"in window))return;let n=0,a=0,s=!1,r=null;const o=()=>{r||(r=document.createElement("div"),r.className="pull-refresh-indicator",r.innerHTML=`
    ...
    `,document.head.appendChild(e)}static cleanup(){this.observers.forEach(e=>e.disconnect()),this.observers.clear(),this.rafId&&(cancelAnimationFrame(this.rafId),this.rafId=null)}}p(D,"metrics",{renderTime:0,interactionTime:0,scrollPerformance:0}),p(D,"observers",new Map),p(D,"rafId",null);S.isMobile()&&document.addEventListener("DOMContentLoaded",()=>{D.initialize(),D.addMobileCSSOptimizations()});S.addLayoutChangeListener(v=>{v!=="mobile"?D.cleanup():(D.initialize(),D.addMobileCSSOptimizations())});class B{static initialize(){this.createScreenReaderAnnouncer(),this.setupFocusManagement(),this.enhanceTabNavigation(),this.addTouchAccessibility(),this.setupKeyboardNavigation()}static createScreenReaderAnnouncer(){this.announcer||(this.announcer=document.createElement("div"),this.announcer.setAttribute("aria-live","polite"),this.announcer.setAttribute("aria-atomic","true"),this.announcer.className="sr-only",this.announcer.style.cssText=`
      ...
      border: 0 !important;
    `,document.body.appendChild(this.announcer))}static announce(e,t="polite"){this.announcer||this.createScreenReaderAnnouncer(),this.announcer.setAttribute("aria-live",t),this.announcer.textContent=e,setTimeout(()=>{this.announcer&&(this.announcer.textContent="")},1e3)}static setupFocusManagement(){document.addEventListener("focusin",e=>{this.focusTracker=e.target}),document.addEventListener("visibilitychange",()=>{document.visibilityState==="visible"&&S.isMobile()&&this.restoreFocus()})}static restoreFocus(){if(this.focusTracker&&document.contains(this.focusTracker))this.focusTracker.focus();else{const e=document.querySelector(".main-content > :not(.hidden)");if(e){const t=e.querySelector('button, input, select, textarea, [tabindex]:not([tabindex="-1"])');t&&t.focus()}}}static enhanceTabNavigation(){const e=document.querySelector(".mobile-tab-navigation");if(!e)return;e.setAttribute("role","tablist"),e.setAttribute("aria-label","Main navigation");const t=e.querySelectorAll(".tab-nav-item");t.forEach((i,n)=>{i.setAttribute("role","tab"),i.setAttribute("aria-selected",n===0?"true":"false"),i.setAttribute("tabindex",n===0?"0":"-1");const a=i.getAttribute("data-section");a&&(i.setAttribute("aria-controls",a),i.id=`tab-${a}`),i.addEventListener("keydown",s=>{this.handleTabKeydown(s,t,n)}),i.addEventListener("click",()=>{var r;const s=((r=i.querySelector(".tab-label"))==null?void 0:r.textContent)||"Section";this.announce(`Switched to ${s} section`),this.updateTabAria(t,n)})})}static handleTabKeydown(e,t,i){let n=i;switch(e.key){case"ArrowLeft":e.preventDefault(),n=i>0?i-1:t.length-1;break;case"ArrowRight":e.preventDefault(),n=i<t.length-1?i+1:0;break;case"Home":e.preventDefault(),n=0;break;case"End":e.preventDefault(),n=t.length-1;break;case"Enter":case" ":e.preventDefault(),t[i].click();return}n!==i&&(this.updateTabAria(t,n),t[n].focus())}static updateTabAria(e,t){e.forEach((i,n)=>{i.setAttribute("aria-selected",n===t?"true":"false"),i.setAttribute("tabindex",n===t?"0":"-1")})}static addTouchAccessibility(){document.addEventListener("touchstart",t=>{const i=t.target;i.matches("button, .unit-card, .tab-nav-item")&&i.setAttribute("aria-pressed","true")},{passive:!0}),document.addEventListener("touchend",t=>{const i=t.target;i.matches("button, .unit-card, .tab-nav-item")&&i.removeAttribute("aria-pressed")},{passive:!0});let e=0;document.addEventListener("touchend",t=>{const i=new Date().getTime(),n=i-e;n<500&&n>0&&t.target.matches(".unit-card, .army-composition")&&this.announce("Double tap to activate","assertive"),e=i})}static setupKeyboardNavigation(){this.addSkipLinks(),document.addEventListener("keydown",e=>{if(e.key==="Escape"){const t=document.querySelector(".bottom-sheet.visible, .mobile-loading-overlay.visible");if(t){e.preventDefault(),this.announce("Modal closed");const i=t.querySelector(".bottom-sheet-close");i&&i.click()}}})}static addSkipLinks(){const e=document.createElement("div");e.className="skip-links",e.innerHTML=`
      <a href="#main-content" class="skip-link">Skip to main content</a>
      <a href="#mobile-navigation" class="skip-link">Skip to navigation</a>
    `,document.body.insertBefore(e,document.body.firstChild);const t=document.querySelector(".main-content");t&&!t.id&&(t.id="main-content");const i=document.querySelector(".mobile-tab-navigation");i&&!i.id&&(i.id="mobile-navigation")}static enhanceFormAccessibility(){document.querySelectorAll("form").forEach(t=>{t.querySelectorAll("input, select, textarea").forEach(n=>{var s;if(!t.querySelector(`label[for="${n.id}"]`)&&n.id){const r=document.createElement("label");r.setAttribute("for",n.id),r.textContent=n.getAttribute("placeholder")||"Input field",r.className="sr-only",(s=n.parentNode)==null||s.insertBefore(r,n)}n.hasAttribute("required")&&(n.setAttribute("aria-required","true"),n.addEventListener("invalid",()=>{this.announce("Required field is empty","assertive")}))}),t.addEventListener("submit",()=>{this.announce("Form submitted")})})}static addDynamicLabels(){document.querySelectorAll(".unit-card").forEach(n=>{var s;const a=(s=n.querySelector(".unit-name"))==null?void 0:s.textContent;a&&!n.getAttribute("aria-label")&&(n.setAttribute("aria-label",`Unit: ${a}`),n.setAttribute("role","button"))}),document.querySelectorAll(".army-composition").forEach((n,a)=>{n.getAttribute("aria-label")||(n.setAttribute("aria-label",`Army composition ${a+1}`),n.setAttribute("role","article"))}),document.querySelectorAll(".combat-action").forEach((n,a)=>{var s;if(!n.getAttribute("aria-label")){const r=((s=n.textContent)==null?void 0:s.substring(0,50))||"Combat action";n.setAttribute("aria-label",`Combat action ${a+1}: ${r}`)}})}static cleanup(){this.announcer&&this.announcer.parentNode&&(this.announcer.parentNode.removeChild(this.announcer),this.announcer=null);const e=document.querySelector(".skip-links");e&&e.parentNode&&e.parentNode.removeChild(e)}}p(B,"focusTracker",null),p(B,"announcer",null);S.isMobile()&&document.addEventListener("DOMContentLoaded",()=>{B.initialize()});S.addLayoutChangeListener(v=>{v!=="mobile"?B.cleanup():B.initialize()});class ke{constructor(){p(this,"container",null);p(this,"unitLoader");p(this,"optimizer",null);p(this,"damageOptimizer",null);p(this,"selectedUnits",new Set);p(this,"mercenaryLimits",{});p(this,"battleSimulation",null);p(this,"manualBattleSimulation",null);p(this,"currentOptimizedArmy",null);p(this,"currentMode","stacking");p(this,"enemyUnitManager",null);p(this,"selectedEnemyUnits",[]);p(this,"currentEnemyUnitSelector",null);p(this,"currentEnemyUnitSelectorContainer",null);p(this,"optimizationAbortController",null);p(this,"optimizationStartTime",0);p(this,"progressUpdateInterval",null);this.unitLoader=new me}async mount(e){this.container=e,this.render(),this.attachEventListeners(),await this.loadInitialData(),this.initializeMobileOptimizations(),C.initialize(),this.initializeAdvancedMobileFeatures()}render(){this.container&&(this.container.innerHTML=`
    ...
    `,i}createSubCategoryHTML(e,t,i){const n=Object.values(i).reduce((s,r)=>s+r.length,0),a=Object.values(i).reduce((s,r)=>s+r.filter(o=>this.selectedUnits.has(o.name)).length,0);return`
      <div class="sub-category" data-category="${e}" data-subcategory="${t}">
        ...
        <div class="sub-category-content collapsed">
          ${Object.entries(i).map(([s,r])=>this.createUnitFamilyHTML(s,r)).join("")}
        </div>
      </div>
    ...
    `}attachAllEventListeners(e){document.querySelectorAll(".main-category").forEach((t,i)=>{const a=Object.keys(e)[i];if(a){const s=e[a];this.attachMainCategoryListeners(t,a,s)}}),document.querySelectorAll(".sub-category").forEach(t=>{var a;const i=t.getAttribute("data-category"),n=t.getAttribute("data-subcategory");if(i&&n&&((a=e[i])!=null&&a[n])){const s=e[i][n];this.attachSubCategoryListeners(t,s)}}),document.querySelectorAll(".unit-family").forEach(t=>{const i=t.getAttribute("data-family");let n=[];Object.values(e).forEach(a=>{Object.values(a).forEach(s=>{s[i]&&(n=s[i])})}),n.length>0&&this.attachUnitFamilyListeners(t,n)})}countUnitsInCategory(e){return Object.values(e).reduce((t,i)=>t+Object.values(i).reduce((n,a)=>n+a.length,0),0)}countSelectedUnitsInCategory(e){return Object.values(e).reduce((t,i)=>t+Object.values(i).reduce((n,a)=>n+a.filter(s=>this.selectedUnits.has(s.name)).length,0),0)}attachMainCategoryListeners(e,t,i){const n=e.querySelector(".main-category-header"),a=e.querySelector(".main-category-content"),s=e.querySelector(".expand-icon");if(!n||!a||!s){console.warn("Missing main-category elements for",t,{header:!!n,content:!!a,expandIcon:!!s});return}n.addEventListener("click",l=>{if(l.target.classList.contains("btn")){l.stopPropagation();return}console.log("Main category header clicked:",t,"collapsed:",a.classList.contains("collapsed")),a.classList.toggle("collapsed"),s.textContent=a.classList.contains("collapsed")?"▼":"▲"});const r=e.querySelector(".select-category"),o=e.querySelector(".deselect-category");r&&r.addEventListener("click",l=>{l.stopPropagation(),this.selectAllInCategory(i)}),o&&o.addEventListener("click",l=>{l.stopPropagation(),this.deselectAllInCategory(i)})}attachSubCategoryListeners(e,t){const i=e.querySelector(".sub-category-header"),n=e.querySelector(".sub-category-content"),a=e.querySelector(".expand-icon");if(!i||!n||!a){console.warn("Missing sub-category elements:",{header:!!i,content:!!n,expandIcon:!!a});return}i.addEventListener("click",o=>{if(o.target.classList.contains("btn")){o.stopPropagation();return}console.log("Sub-category header clicked, toggling:",n.classList.contains("collapsed")),n.classList.toggle("collapsed"),a.textContent=n.classList.contains("collapsed")?"▼":"▲"});const s=e.querySelector(".select-subcategory"),r=e.querySelector(".deselect-subcategory");s&&s.addEventListener("click",o=>{o.stopPropagation(),this.selectAllInFamilies(t)}),r&&r.addEventListener("click",o=>{o.stopPropagation(),this.deselectAllInFamilies(t)})}attachUnitFamilyListeners(e,t){const i=e.querySelector(".unit-family-header"),n=e.querySelector(".unit-family-content"),a=e.querySelector(".expand-icon");i.addEventListener("click",l=>{l.target.classList.contains("btn")||(n.classList.toggle("collapsed"),a.textContent=n.classList.contains("collapsed")?"▼":"▲")});const s=e.querySelector(".select-family"),r=e.querySelector(".deselect-family");s&&s.addEventListener("click",l=>{l.stopPropagation(),this.selectAllUnits(t)}),r&&r.addEventListener("click",l=>{l.stopPropagation(),this.deselectAllUnits(t)}),e.querySelectorAll(".unit-card").forEach(l=>{l.addEventListener("click",()=>{const c=l.getAttribute("data-unit");if(c){const d=this.unitLoader.getUnitByName(c);d&&this.toggleUnitSelection(d)}})})}getUnitCost(e){switch(e.cost_type){case"Leadership":return e.leadership_cost??0;case"Dominance":return e.dominance_cost??0;case"Authority":case"Mercenary":return e.authority_cost??0;default:return 0}}toggleUnitSelection(e){this.selectedUnits.has(e.name)?(this.selectedUnits.delete(e.name),(e.cost_type==="Mercenary"||e.cost_type==="Authority")&&delete this.mercenaryLimits[e.name]):(this.selectedUnits.add(e.name),(e.cost_type==="Mercenary"||e.cost_type==="Authority")&&(this.mercenaryLimits[e.name]=1)),this.updateSelectionDisplay(),this.updateMercenaryLimits(),this.updateOptimizeButton(),S.isMobile()&&this.addFloatingActionButton()}updateSelectionDisplay(){document.querySelectorAll(".unit-card").forEach(e=>{const t=e.getAttribute("data-unit");t&&(this.selectedUnits.has(t)?e.classList.add("selected"):e.classList.remove("selected"))}),this.updateAllCounters(),this.updateSelectedSummary()}updateAllCounters(){document.querySelectorAll(".main-category").forEach((e,t)=>{const i=e.querySelector(".category-title h3");if(i){const a=["Guardsmen","Specialists","Engineer Corps","Monsters","Mercenaries"][t];if(a){const{selected:s,total:r}=this.countUnitsInMainCategory(a),l=(i.textContent||"").replace(/\s*\(\d+\/\d+\)/,"");i.textContent=`${l} (${s}/${r})`}}}),document.querySelectorAll(".sub-category").forEach(e=>{const t=e.querySelector(".subcategory-title h4"),i=e.getAttribute("data-category"),n=e.getAttribute("data-subcategory");if(t&&i&&n){const{selected:a,total:s}=this.countUnitsInSubCategory(i,n),o=(t.textContent||"").replace(/\s*\(\d+\/\d+\)/,"");t.textContent=`${o} (${a}/${s})`}}),document.querySelectorAll(".unit-family").forEach(e=>{const t=e.querySelector(".family-title h5"),i=e.getAttribute("data-family");if(t&&i){const{selected:n,total:a}=this.countUnitsInFamily(i),r=(t.textContent||"").replace(/\s*\(\d+\/\d+\)/,"");t.textContent=`${r} (${n}/${a})`}})}countUnitsInMainCategory(e){const i=this.unitLoader.getAllUnits().filter(a=>this.getMainCategory(a)===e);return{selected:i.filter(a=>this.selectedUnits.has(a.name)).length,total:i.length}}countUnitsInSubCategory(e,t){const n=this.unitLoader.getAllUnits().filter(s=>this.getMainCategory(s)===e&&this.getSubCategory(s)===t);return{selected:n.filter(s=>this.selectedUnits.has(s.name)).length,total:n.length}}countUnitsInFamily(e){const i=this.unitLoader.getAllUnits().filter(a=>this.getUnitFamily(a)===e);return{selected:i.filter(a=>this.selectedUnits.has(a.name)).length,total:i.length}}updateSelectedSummary(){const e=document.getElementById("selected-count");e&&(e.textContent=`${this.selectedUnits.size} units selected`)}selectAllVisible(){document.querySelectorAll(".unit-card").forEach(t=>{const i=t.getAttribute("data-unit");if(i){const n=this.unitLoader.getUnitByName(i);n&&(this.selectedUnits.add(n.name),(n.cost_type==="Mercenary"||n.cost_type==="Authority")&&(this.mercenaryLimits[n.name]=1))}}),this.filterAndDisplayUnits(),this.updateMercenaryLimits(),this.updateOptimizeButton()}selectAllInCategory(e){Object.values(e).forEach(t=>{this.selectAllInFamilies(t)})}deselectAllInCategory(e){Object.values(e).forEach(t=>{this.deselectAllInFamilies(t)})}selectAllInFamilies(e){Object.values(e).forEach(t=>{this.selectAllUnits(t)})}deselectAllInFamilies(e){Object.values(e).forEach(t=>{this.deselectAllUnits(t)})}selectAllUnits(e){e.forEach(t=>{this.selectedUnits.add(t.name),(t.cost_type==="Mercenary"||t.cost_type==="Authority")&&(this.mercenaryLimits[t.name]=1)}),this.updateSelectionDisplay(),this.updateMercenaryLimits(),this.updateOptimizeButton()}deselectAllUnits(e){e.forEach(t=>{this.selectedUnits.delete(t.name),(t.cost_type==="Mercenary"||t.cost_type==="Authority")&&delete this.mercenaryLimits[t.name]}),this.updateSelectionDisplay(),this.updateMercenaryLimits(),this.updateOptimizeButton()}updateMercenaryLimits(){const e=document.getElementById("mercenary-limits");if(!e)return;const t=Array.from(this.selectedUnits).map(i=>this.unitLoader.getUnitByName(i)).filter(i=>i&&(i.cost_type==="Mercenary"||i.cost_type==="Authority"));if(t.length===0){e.innerHTML='<p class="text-muted">Select mercenary units to set limits</p>';return}e.innerHTML="",t.forEach(i=>{if(!i)return;const n=document.createElement("div");n.className="mercenary-item";const a=i.cost_type==="Authority"?"⚔️":"🗡️",s=i.cost_type==="Authority"?`AUTH: ${i.authority_cost}`:`AUTH: ${i.authority_cost}`;n.innerHTML=`
        <div class="mercenary-label">
          <span class="unit-name">${a} ${i.name}</span>
          <span class="unit-stats">(STR: ${i.strength}, HP: ${i.health}, ${s})</span>
        </div>
      ...
      `,n.querySelector("input").addEventListener("change",o=>{const l=o.target;this.mercenaryLimits[l.dataset.unit]=parseInt(l.value)||1}),e.appendChild(n)})}updateOptimizeButton(){const e=document.getElementById("optimize-btn"),t=document.getElementById("leadership-budget"),i=document.getElementById("dominance-budget");if(!e||!t||!i)return;const n=this.selectedUnits.size>0,a=parseInt(t.value)>0||parseInt(i.value)>0||Object.keys(this.mercenaryLimits).length>0;e.disabled=!n||!a}async optimizeArmy(){try{this.currentMode==="stacking"?(this.showLoadingModal(),await this.optimizeForStacking(),this.hideLoadingModal()):await this.optimizeForDamage()}catch(e){console.error("Optimization failed:",e),alert("Optimization failed. Please check your inputs and try again."),this.hideLoadingModal(),this.hideProgressModal()}}async optimizeForStacking(){const e=this.unitLoader.getAvailableUnits(Array.from(this.selectedUnits));this.optimizer=new H(e);const t=document.getElementById("leadership-budget"),i=document.getElementById("dominance-budget"),n={leadershipBudget:parseInt(t.value)||0,dominanceBudget:parseInt(i.value)||0,mercenaryLimits:{...this.mercenaryLimits},availableUnits:Array.from(this.selectedUnits)},a=await this.optimizer.optimizeArmy(n);this.displayStackingResults(a)}async optimizeForDamage(){const e=this.unitLoader.getAvailableUnits(Array.from(this.selectedUnits)),t=document.getElementById("leadership-budget"),i=document.getElementById("dominance-budget"),n=document.getElementById("enemy-count"),a=document.getElementById("max-combinations"),s={leadershipBudget:parseInt(t.value)||0,dominanceBudget:parseInt(i.value)||0,mercenaryLimits:{...this.mercenaryLimits},availableUnits:Array.from(this.selectedUnits),enemyGroupCount:parseInt(n.value)||5,maxCombinations:parseInt(a.value)||50,specificEnemyUnits:this.selectedEnemyUnits.length>0?[...this.selectedEnemyUnits]:void 0};await this.runDamageOptimizationWithProgress(s,e)}async runDamageOptimizationWithProgress(e,t){this.optimizationAbortController=new AbortController,S.isMobile()?M.showMobileLoading("Optimizing army composition..."):this.showProgressModal();try{this.damageOptimizer||(this.damageOptimizer=new he,this.damageOptimizer.initialize(this.unitLoader));const i={...e,signal:this.optimizationAbortController.signal,onProgress:a=>{this.updateProgressModal(a.progress,a.message,{combinationsEvaluated:a.combinationsEvaluated,totalToEvaluate:a.totalToEvaluate,phase:a.phase,estimatedRemainingMs:a.estimatedRemainingMs})}},n=await this.damageOptimizer.optimizeForDamage(i,t);await this.delay(500),S.isMobile()?M.hideMobileLoading():this.hideProgressModal(),this.displayDamageResults(n)}catch(i){S.isMobile()?M.hideMobileLoading():this.hideProgressModal(),i instanceof Error&&i.message.includes("cancelled")?console.log("Optimization cancelled by user"):(console.error("Damage optimization failed:",i),alert(`Optimization failed: ${i instanceof Error?i.message:"Unknown error"}`))}}delay(e){return new Promise(t=>setTimeout(t,e))}displayStackingResults(e){const t=document.getElementById("optimization-stats"),i=document.getElementById("army-compositions"),n=document.getElementById("results-section"),a=document.getElementById("stacking-results"),s=document.getElementById("damage-results");!t||!i||!n||(a&&a.classList.remove("hidden"),s&&s.classList.add("hidden"),t.innerHTML=`
      <div class="stat-card">
    ...
    `,i.innerHTML="",e.rankedResults.length===0?i.innerHTML='<p class="text-center text-muted">No valid army compositions found. Try adjusting your constraints.</p>':e.rankedResults.slice(0,10).forEach((o,l)=>{const c=this.createDamageArmyElement(o,l+1);i.appendChild(c)}),n.classList.remove("hidden"),C.showSection("results-section"),S.isMobile()||setTimeout(()=>{n.scrollIntoView({behavior:"smooth",block:"start"})},100)}showBattleSimulationWithResults(e){const t=document.getElementById("battle-simulation-container");!t||!this.currentOptimizedArmy||(t.classList.remove("hidden"),C.showSection("battle-simulation-container"),this.battleSimulation||(this.battleSimulation=new Y,this.battleSimulation.initialize(this.unitLoader),this.battleSimulation.mount(t,this.currentOptimizedArmy)),this.battleSimulation.displayPreCalculatedResults(e),S.isMobile()||t.scrollIntoView({behavior:"smooth",block:"nearest"}))}showBattleSimulation(){if(!this.currentOptimizedArmy)return;const e=document.getElementById("battle-simulation-container");e&&(e.classList.remove("hidden"),this.battleSimulation||(this.battleSimulation=new Y,this.battleSimulation.initialize(this.unitLoader)),this.battleSimulation.mount(e,this.currentOptimizedArmy),C.showSection("battle-simulation-container"),S.isMobile()||setTimeout(()=>{e.scrollIntoView({behavior:"smooth",block:"start"})},100))}createCompositionElement(e,t){var l;const i=document.createElement("div");i.className="army-composition";const n=((l=this.optimizer)==null?void 0:l.explainStacking(e))||"No stacking explanation available",a=`
...
`).map(c=>c.includes("🏆 OPTIMIZED ARMY COMPOSITION")?`<h3 class="army-title">${c}</h3>`:c.includes("═".repeat(60))?'<hr class="title-divider">':c.includes("📊 ARMY SUMMARY")||c.includes("🗡️ MERCENARY FORCES")||c.includes("👑 LEADERSHIP FORCES")||c.includes("⚡ DOMINANCE FORCES")||c.includes("⚔️ BATTLE ORDER")?`<h4 class="section-header">${c}</h4>`:c.includes("─".repeat(30))||c.includes("─".repeat(40))?'<hr class="section-divider">':c.includes("└─")?`<div class="unit-detail">${c}</div>`:c.trim()&&!c.includes("═")&&!c.includes("─")?`<div class="unit-line">${c}</div>`:c.trim()===""?'<div class="spacing"></div>':"").filter(c=>c!=="").join(""),r=`
    ...
    `;i.innerHTML=a+'<div class="composition-content">'+s+"</div>"+r;const o=i.querySelector(".simulate-btn");return o&&o.addEventListener("click",()=>{this.currentOptimizedArmy=e,this.showBattleSimulation()}),i}createDamageArmyElement(e,t){const i=document.createElement("div");i.className="damage-army-card",i.setAttribute("data-army-index",(t-1).toString());const n=e.armyComposition.totalDominanceCost===0?"Leadership":e.armyComposition.totalLeadershipCost===0?"Dominance":"Mixed",a=n==="Leadership"?"🛡️":n==="Dominance"?"👹":"⚔️";return i.addEventListener("click",()=>this.selectDamageArmy(e,t-1)),i.innerHTML=`
    ...
    `,i}selectDamageArmy(e,t){document.querySelectorAll(".damage-army-card").forEach((n,a)=>{n.classList.toggle("selected",a===t)}),this.showSelectedArmyDetails(e),this.currentOptimizedArmy=e.armyComposition,this.showBattleSimulationWithResults(e.battleAnalysis)}showSelectedArmyDetails(e){const t=document.getElementById("selected-army-details"),i=document.getElementById("selected-army-composition");if(!t||!i)return;const n=e.armyComposition,a=this.unitLoader.getAvailableUnits(Object.keys(n.units)),r=new H(a).explainStacking(n);i.innerHTML=`
...
`).map(o=>o.trim()===""?'<div class="spacing"></div>':o.includes("Total")||o.includes("Budget")?`<div class="summary-line"><strong>${o}</strong></div>`:o.includes("→")?`<div class="unit-line">${o}</div>`:o.includes("✓")||o.includes("Valid")?`<div class="validation-line success">${o}</div>`:`<div class="explanation-line">${o}</div>`).join("")}
    ...
    `,t.classList.remove("hidden"),t.scrollIntoView({behavior:"smooth",block:"nearest"})}formatCombatLog(e){return!e||e.length===0?'<div class="no-combat-log">No combat actions recorded</div>':e.map((t,i)=>{const n=t.attacker&&!t.attacker.includes("Enemy");return`
      ...
      `,document.body.appendChild(e);const t=document.getElementById("cancel-optimization-btn");t&&t.addEventListener("click",()=>{this.cancelOptimization()})}e.classList.remove("hidden"),this.optimizationStartTime=performance.now(),this.updateProgressModal(0,"Initializing..."),this.startProgressTimer()}updateProgressModal(e,t,i){const n=document.getElementById("progress-fill"),a=document.getElementById("progress-text"),s=document.getElementById("progress-percentage"),r=document.getElementById("progress-combinations"),o=document.getElementById("progress-phase"),l=document.getElementById("progress-remaining");if(n&&(n.style.width=`${e}%`),a&&(a.textContent=t),s&&(s.textContent=`${Math.round(e)}%`),r&&i){const c=i.combinationsEvaluated||0,d=i.totalToEvaluate||0;r.textContent=`${c.toLocaleString()} / ${d.toLocaleString()} combinations`}if(o&&(i!=null&&i.phase)&&(o.textContent=i.phase.charAt(0).toUpperCase()+i.phase.slice(1)),l&&(i!=null&&i.estimatedRemainingMs)){const c=Math.ceil(i.estimatedRemainingMs/1e3),d=Math.floor(c/60),m=c%60;l.textContent=`(~${d}:${m.toString().padStart(2,"0")} remaining)`}else l&&(l.textContent="")}startProgressTimer(){this.progressUpdateInterval=window.setInterval(()=>{const e=performance.now()-this.optimizationStartTime,t=Math.floor(e/1e3),i=Math.floor(t/60),n=t%60,a=document.getElementById("progress-elapsed");a&&(a.textContent=`${i.toString().padStart(2,"0")}:${n.toString().padStart(2,"0")}`)},1e3)}stopProgressTimer(){this.progressUpdateInterval&&(clearInterval(this.progressUpdateInterval),this.progressUpdateInterval=null)}cancelOptimization(){this.optimizationAbortController&&(this.optimizationAbortController.abort(),this.hideProgressModal(),alert("Optimization cancelled by user."))}hideProgressModal(){const e=document.getElementById("progress-modal");e&&e.classList.add("hidden"),this.stopProgressTimer(),this.optimizationAbortController=null}initializeMobileOptimizations(){z.optimizeCombatLogs(),z.optimizeUnitCards(),this.addTouchSupportToUnitCards(),S.addLayoutChangeListener(e=>{this.handleLayoutModeChange(e)})}addTouchSupportToUnitCards(){document.querySelectorAll(".unit-card").forEach(t=>{t instanceof HTMLElement&&F.addHapticFeedback(t)})}handleLayoutModeChange(e){setTimeout(()=>{z.optimizeCombatLogs(),z.optimizeUnitCards(),this.addTouchSupportToUnitCards(),e==="mobile"&&this.initializeAdvancedMobileFeatures()},100)}initializeAdvancedMobileFeatures(){S.isMobile()&&(D.initialize(),B.initialize(),this.addPullToRefresh(),this.addFloatingActionButton(),B.enhanceFormAccessibility(),setTimeout(()=>{B.addDynamicLabels()},500))}addPullToRefresh(){const e=document.querySelector(".main-content");e&&F.addPullToRefresh(e,async()=>{B.announce("Refreshing data..."),await new Promise(t=>setTimeout(t,1e3)),z.optimizeCombatLogs(),z.optimizeUnitCards(),B.addDynamicLabels(),B.announce("Data refreshed")})}addFloatingActionButton(){this.selectedUnits.size>0?M.showFloatingActionButton({icon:"⚡",label:"Quick Optimize",onClick:()=>{B.announce("Starting quick optimization"),this.optimizeArmy()},position:"bottom-right",color:"primary"}):M.hideFloatingActionButton()}initializeEnemyUnitsManager(){const e=document.getElementById("enemy-units-container");e&&(this.enemyUnitManager||(this.enemyUnitManager=new Ae({mode:"embedded"})),this.enemyUnitManager.mount(e))}async initializeManualBattleSimulation(){const e=document.getElementById("manual-battle-container");e&&(this.manualBattleSimulation||(this.manualBattleSimulation=new Ce({unitLoader:this.unitLoader,onBattleComplete:t=>{console.log("Manual battle completed:",t)}})),await this.manualBattleSimulation.mount(e))}openEnemyUnitSelector(){const e=document.getElementById("enemy-count"),t=parseInt((e==null?void 0:e.value)||"5");R(async()=>{const{EnemyUnitSelector:i}=await Promise.resolve().then(()=>Se);return{EnemyUnitSelector:i}},void 0).then(({EnemyUnitSelector:i})=>{const n=document.createElement("div");n.id="enemy-unit-selector-modal",n.style.position="fixed",n.style.top="0",n.style.left="0",n.style.right="0",n.style.bottom="0",n.style.zIndex="2000",document.body.appendChild(n);const a=new i({onSelect:s=>{this.handleEnemyUnitSelected(s)},onCancel:()=>{this.closeEnemyUnitSelector(n,a)},mode:"multiple",title:`Select Enemy Units for Battle Optimization (${this.selectedEnemyUnits.length}/${t} selected)`,maxSelections:t,selectedUnits:[...this.selectedEnemyUnits]});this.currentEnemyUnitSelector=a,this.currentEnemyUnitSelectorContainer=n,a.mount(n)}).catch(i=>{console.error("Failed to load EnemyUnitSelector:",i),alert("Failed to open enemy unit selector. Please try again.")})}handleEnemyUnitSelected(e){const t=document.getElementById("enemy-count"),i=parseInt((t==null?void 0:t.value)||"5"),n=this.selectedEnemyUnits.findIndex(a=>a.name===e.name);n>=0?this.selectedEnemyUnits.splice(n,1):this.selectedEnemyUnits.length<i?this.selectedEnemyUnits.push(e):(this.selectedEnemyUnits.shift(),this.selectedEnemyUnits.push(e)),this.updateEnemyUnitDisplay(),this.updateEnemyUnitSelectorTitle()}closeEnemyUnitSelector(e,t){try{t&&typeof t.unmount=="function"&&t.unmount(),e&&e.parentNode&&e.parentNode.removeChild(e),this.currentEnemyUnitSelector=null,this.currentEnemyUnitSelectorContainer=null}catch(i){console.error("Error closing enemy unit selector:",i)}}updateEnemyUnitSelectorTitle(){if(this.currentEnemyUnitSelector&&typeof this.currentEnemyUnitSelector.updateTitle=="function"){const e=document.getElementById("enemy-count"),t=parseInt((e==null?void 0:e.value)||"5"),i=`Select Enemy Units for Battle Optimization (${this.selectedEnemyUnits.length}/${t} selected)`;this.currentEnemyUnitSelector.updateTitle(i),typeof this.currentEnemyUnitSelector.updateSelectedUnits=="function"&&this.currentEnemyUnitSelector.updateSelectedUnits(this.selectedEnemyUnits)}}handleEnemyGroupsChange(){if(this.currentMode==="damage"){const e=document.getElementById("enemy-count"),t=e&&parseInt(e.value)||1;this.selectedEnemyUnits.length>t&&(this.selectedEnemyUnits=this.selectedEnemyUnits.slice(0,t)),this.updateEnemyUnitDisplay(),this.updateEnemyUnitSelectorTitle()}}updateEnemyUnitDisplay(){const e=document.getElementById("select-enemy-units-btn");if(e){const t=document.getElementById("enemy-count"),i=parseInt((t==null?void 0:t.value)||"5");if(this.selectedEnemyUnits.length===0)e.innerHTML=`
          👹 Select Enemy Units
        ...
        `,e.classList.add("enemy-selected")}}}document.addEventListener("DOMContentLoaded",()=>{const v=document.getElementById("app");if(!v)throw new Error("App container not found");new ke().mount(v),window.addEventListener("error",t=>{console.error("Global error:",t.error)}),window.addEventListener("unhandledrejection",t=>{console.error("Unhandled promise rejection:",t.reason)}),"serviceWorker"in navigator&&window.addEventListener("load",()=>{console.log("Service worker support detected")}),console.log("TotalBattle Army Calculator initialized")});export{ee as E,U as M};
//# sourceMappingURL=main-DzGpN4Zf.js.map
