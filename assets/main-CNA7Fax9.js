var X=Object.defineProperty;var Z=(b,t,e)=>t in b?X(b,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):b[t]=e;var u=(b,t,e)=>Z(b,typeof t!="symbol"?t+"":t,e);(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))n(i);new MutationObserver(i=>{for(const a of i)if(a.type==="childList")for(const s of a.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&n(s)}).observe(document,{childList:!0,subtree:!0});function e(i){const a={};return i.integrity&&(a.integrity=i.integrity),i.referrerPolicy&&(a.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?a.credentials="include":i.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function n(i){if(i.ep)return;i.ep=!0;const a=e(i);fetch(i.href,a)}})();const tt="modulepreload",et=function(b){return"/army-calculator-site/"+b},q={},V=function(t,e,n){let i=Promise.resolve();if(e&&e.length>0){document.getElementsByTagName("link");const s=document.querySelector("meta[property=csp-nonce]"),r=(s==null?void 0:s.nonce)||(s==null?void 0:s.getAttribute("nonce"));i=Promise.allSettled(e.map(o=>{if(o=et(o),o in q)return;q[o]=!0;const l=o.endsWith(".css"),c=l?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${o}"]${c}`))return;const m=document.createElement("link");if(m.rel=l?"stylesheet":tt,l||(m.as="script"),m.crossOrigin="",m.href=o,r&&m.setAttribute("nonce",r),document.head.appendChild(m),l)return new Promise((d,h)=>{m.addEventListener("load",d),m.addEventListener("error",()=>h(new Error(`Unable to preload CSS for ${o}`)))})}))}function a(s){const r=new Event("vite:preloadError",{cancelable:!0});if(r.payload=s,window.dispatchEvent(r),!r.defaultPrevented)throw s}return i.then(s=>{for(const r of s||[])r.status==="rejected"&&a(r.reason);return t().catch(a)})};class f{static isPlayerUnit(t){return t.cost_type!==void 0||t.context==="player"}static isEnemyUnit(t){return t.cost_type===void 0||t.context==="enemy"}static isMortalEnemy(t){return f.isEnemyUnit(t)&&(t.isMortal===!0||t.count!==void 0)}static isImmortalEnemy(t){return f.isEnemyUnit(t)&&!f.isMortalEnemy(t)}static getRemainingEnemyCount(t){return f.isMortalEnemy(t)?t.count:void 0}static getCurrentEnemyHealth(t){return t.currentHealth!==void 0?t.currentHealth:(t.count??1)*t.health}static isMercenary(t){return t.cost_type==="Mercenary"||(t.authority_cost??0)>0}static getPrimaryCost(t){if(!f.isPlayerUnit(t))return 0;switch(t.cost_type){case"Leadership":return t.leadership_cost??0;case"Dominance":return t.dominance_cost??0;case"Authority":case"Mercenary":return t.authority_cost??0;default:return 0}}static getEfficiencyRatio(t){if(f.isPlayerUnit(t)){const e=f.getPrimaryCost(t);return e>0?t.strength/e:0}else return t.health>0?t.strength/t.health:0}static getStrengthPerCost(t){const e=f.getPrimaryCost(t);return e>0?t.strength/e:0}static getHealthPerCost(t){const e=f.getPrimaryCost(t);return e>0?t.health/e:0}static getStrengthPerHealth(t){return t.health>0?t.strength/t.health:0}static getEffectivenessScore(t){if(f.isPlayerUnit(t)){const e=f.getPrimaryCost(t);return e>0?t.strength*t.health/e:0}else return t.strength*t.health/1e3}static hasUnitType(t,e){return t.unit_types.some(n=>n.toLowerCase()===e.toLowerCase())}static getAttackModifierAgainst(t,e){if(!t.attack_modifiers)return 0;const n=t.attack_modifiers.find(i=>i.target_type.toLowerCase()===e.toLowerCase());return n?n.value:0}static getTotalStrengthAgainst(t,e){const n=t.strength,i=f.getAttackModifierAgainst(t,e);return n+i}static createUserEnemyUnit(t){const e=new Date;return{name:t.name??"Unnamed Enemy",unit_types:t.unit_types??["Epic Monster"],health:t.health??1e4,strength:t.strength??5e3,attack_modifiers:t.attack_modifiers??[],context:"enemy",id:`user_enemy_${Date.now()}_${Math.random().toString(36).substr(2,9)}`,createdAt:e,modifiedAt:e}}static updateUserUnit(t,e){return{...t,...e,modifiedAt:new Date}}static validateUnit(t){const e=[],n=[],i=f.validateName(t.name);i.isValid||e.push(i.error);const a=f.validateUnitTypes(t.unit_types);a.isValid?a.warnings&&n.push(...a.warnings):e.push(a.error);const s=f.validateHealth(t.health);s.isValid?s.warnings&&n.push(...s.warnings):e.push(s.error);const r=f.validateStrength(t.strength);r.isValid?r.warnings&&n.push(...r.warnings):e.push(r.error);const o=f.validateAttackModifiers(t.attack_modifiers);return o.isValid?o.warnings&&n.push(...o.warnings):e.push(o.error),(t.cost_type||t.context==="player")&&t.cost_type&&!["Leadership","Dominance","Authority","Mercenary"].includes(t.cost_type)&&e.push("Invalid cost_type. Must be Leadership, Dominance, Authority, or Mercenary"),{isValid:e.length===0,errors:e,warnings:n.length>0?n:void 0}}static validateEnemyUnit(t){return f.validateUnit(t)}static validateName(t){if(!t||typeof t!="string")return{isValid:!1,error:"Name must be a non-empty string"};const e=t.trim();return e.length===0?{isValid:!1,error:"Name cannot be empty or only whitespace"}:e.length>100?{isValid:!1,error:"Name cannot exceed 100 characters"}:/[<>"'&]/.test(e)?{isValid:!1,error:`Name contains invalid characters (<, >, ", ', &)`}:{isValid:!0}}static validateUnitTypes(t){const e=[];if(!Array.isArray(t))return{isValid:!1,error:"Unit types must be an array"};if(t.length===0)return{isValid:!1,error:"At least one unit type is required"};if(t.length>10)return{isValid:!1,error:"Cannot have more than 10 unit types"};for(let i=0;i<t.length;i++){const a=t[i];if(typeof a!="string"||a.trim()==="")return{isValid:!1,error:`Unit type ${i+1} must be a non-empty string`};nt.includes(a)||e.push(`Unit type '${a}' is not a standard type`)}return new Set(t).size!==t.length?{isValid:!1,error:"Unit types cannot contain duplicates"}:{isValid:!0,warnings:e.length>0?e:void 0}}static validateHealth(t){const e=[];return typeof t!="number"?{isValid:!1,error:"Health must be a number"}:Number.isFinite(t)?t<=0?{isValid:!1,error:"Health must be greater than 0"}:t>5e7?{isValid:!1,error:"Health cannot exceed 50,000,000"}:(t<100&&e.push("Health value is unusually low (less than 100)"),t>1e7&&e.push("Health value is unusually high (greater than 10,000,000)"),{isValid:!0,warnings:e.length>0?e:void 0}):{isValid:!1,error:"Health must be a finite number"}}static validateStrength(t){const e=[];return typeof t!="number"?{isValid:!1,error:"Strength must be a number"}:Number.isFinite(t)?t<0?{isValid:!1,error:"Strength cannot be negative"}:t>25e6?{isValid:!1,error:"Strength cannot exceed 25,000,000"}:(t===0&&e.push("Strength value of 0 means this unit cannot deal damage"),t<50&&e.push("Strength value is unusually low (less than 50)"),t>5e6&&e.push("Strength value is unusually high (greater than 5,000,000)"),{isValid:!0,warnings:e.length>0?e:void 0}):{isValid:!1,error:"Strength must be a finite number"}}static validateAttackModifiers(t){const e=[];if(t==null)return{isValid:!0};if(!Array.isArray(t))return{isValid:!1,error:"Attack modifiers must be an array"};if(t.length>20)return{isValid:!1,error:"Cannot have more than 20 attack modifiers"};for(let a=0;a<t.length;a++){const s=t[a];if(!s||typeof s!="object")return{isValid:!1,error:`Attack modifier ${a+1} must be an object`};if(!s.target_type||typeof s.target_type!="string")return{isValid:!1,error:`Attack modifier ${a+1}: target_type is required and must be a string`};if(at.includes(s.target_type)||e.push(`Attack modifier ${a+1}: '${s.target_type}' is not a standard target type`),!s.modifier_type||!it.includes(s.modifier_type))return{isValid:!1,error:`Attack modifier ${a+1}: modifier_type must be 'Strength'`};if(typeof s.value!="number"||!Number.isFinite(s.value))return{isValid:!1,error:`Attack modifier ${a+1}: value must be a finite number`};if(s.value<0)return{isValid:!1,error:`Attack modifier ${a+1}: value cannot be negative`};if(s.value>1e7)return{isValid:!1,error:`Attack modifier ${a+1}: value cannot exceed 10,000,000`};s.value>1e6&&e.push(`Attack modifier ${a+1}: value is unusually high (${s.value})`)}const n=t.map(a=>{var s;return(s=a.target_type)==null?void 0:s.toLowerCase()}).filter(Boolean);return new Set(n).size!==n.length?{isValid:!1,error:"Attack modifiers cannot have duplicate target types"}:{isValid:!0,warnings:e.length>0?e:void 0}}static validateUserEnemyUnit(t){const e=f.validateUnit(t),n=[...e.errors],i=[...e.warnings||[]];return(!t.id||typeof t.id!="string"||t.id.trim()==="")&&n.push("User enemy unit must have a valid ID"),(!t.createdAt||!(t.createdAt instanceof Date))&&n.push("User enemy unit must have a valid creation date"),(!t.modifiedAt||!(t.modifiedAt instanceof Date))&&n.push("User enemy unit must have a valid modification date"),t.createdAt&&t.modifiedAt&&t.createdAt instanceof Date&&t.modifiedAt instanceof Date&&t.modifiedAt<t.createdAt&&n.push("Modification date cannot be before creation date"),{isValid:n.length===0,errors:n,warnings:i.length>0?i:void 0}}static validateForImport(t){const e=[],n=[];if(!t||typeof t!="object")return{isValid:!1,errors:["Data must be an object"]};const i=f.validateName(t.name);i.isValid||e.push(i.error);const a=f.validateUnitTypes(t.unit_types);a.isValid?a.warnings&&n.push(...a.warnings):e.push(a.error);const s=f.validateHealth(t.health);s.isValid?s.warnings&&n.push(...s.warnings):e.push(s.error);const r=f.validateStrength(t.strength);r.isValid?r.warnings&&n.push(...r.warnings):e.push(r.error);const o=f.validateAttackModifiers(t.attack_modifiers);return o.isValid?o.warnings&&n.push(...o.warnings):e.push(o.error),{isValid:e.length===0,errors:e,warnings:n.length>0?n:void 0}}static validateMultipleUnits(t){if(!Array.isArray(t))return{isValid:!1,results:[],summary:{total:0,valid:0,invalid:0,warnings:0}};const e=t.map((i,a)=>({index:a,validation:f.validateForImport(i)})),n={total:t.length,valid:e.filter(i=>i.validation.isValid).length,invalid:e.filter(i=>!i.validation.isValid).length,warnings:e.filter(i=>i.validation.warnings&&i.validation.warnings.length>0).length};return{isValid:n.invalid===0,results:e,summary:n}}static sanitizeEnemyUnit(t){const e={name:typeof t.name=="string"?t.name.trim():"Unknown Enemy",unit_types:Array.isArray(t.unit_types)?t.unit_types.filter(n=>typeof n=="string"&&n.trim()!==""):["Epic Monster"],health:typeof t.health=="number"&&t.health>0?Math.min(t.health,5e7):1e4,strength:typeof t.strength=="number"&&t.strength>=0?Math.min(t.strength,25e6):5e3,attack_modifiers:Array.isArray(t.attack_modifiers)?t.attack_modifiers.filter(n=>n&&typeof n=="object"&&typeof n.target_type=="string"&&typeof n.value=="number"&&n.value>=0).map(n=>({target_type:n.target_type,modifier_type:"Strength",value:Math.min(n.value,1e7)})):[]};return e.name.length===0&&(e.name="Unknown Enemy"),e.unit_types.length===0&&(e.unit_types=["Epic Monster"]),e}static validateBattleConfiguration(t){const e=[],n=[];return t.playerArmy?(!t.playerArmy.stackingOrder||t.playerArmy.stackingOrder.length===0)&&e.push("Player army must have at least one unit group"):e.push("Player army is required"),t.enemyGroupCount!==void 0&&t.enemyGroupCount<1&&e.push("Enemy group count must be at least 1"),t.enemyUnits!==void 0&&(!Array.isArray(t.enemyUnits)||t.enemyUnits.length===0)&&e.push("At least one enemy unit is required"),t.enemyGroupCount===void 0&&t.enemyUnits===void 0?e.push("Either enemy group count or enemy units must be specified"):t.enemyUnits!==void 0&&t.enemyUnits.length===0&&e.push("Enemy units array is empty - check that enemy army has valid units selected"),{isValid:e.length===0,errors:e,warnings:n.length>0?n:void 0}}}const nt=["Human","Beast","Undead","Demon","Elemental","Construct","Melee","Ranged","Magic","Siege","Mounted","Flying","Aquatic","Guardsman","Monster","Mercenary","Specialist","Elite","Heavy","Light","Epic Monster","Giant","Dragon","Fortification"],it=["Strength"],at=["Melee","Ranged","Flying","Mounted","Beast","Human","Siege","Dragon","Elemental","Giant","Fortification","Undead","Demon"];class U{}u(U,"validateEnemyUnit",f.validateUnit),u(U,"validateUserEnemyUnit",f.validateUserEnemyUnit),u(U,"validateName",f.validateName),u(U,"validateUnitTypes",f.validateUnitTypes),u(U,"validateHealth",f.validateHealth),u(U,"validateStrength",f.validateStrength),u(U,"validateAttackModifiers",f.validateAttackModifiers),u(U,"validateForImport",f.validateForImport),u(U,"validateMultipleUnits",f.validateMultipleUnits),u(U,"sanitizeEnemyUnit",f.sanitizeEnemyUnit);const R="/army-calculator-site/",Y={FINAL_UNITS:`${R}final_units.json`,ENEMY_UNITS:`${R}enemy_units.json`};class st{constructor(){u(this,"units",[]);u(this,"unitsByName",new Map);u(this,"unitsByCostType",{Leadership:[],Dominance:[],Authority:[],Mercenary:[]});this.resetData()}async loadPresetUnits(){return this.loadUnits(Y.FINAL_UNITS)}async loadUnits(t){try{let e;if(typeof t=="string"){console.log(`Loading units from: ${t}`);const n=await fetch(t);if(!n.ok)throw new Error(`Failed to fetch units: ${n.status} ${n.statusText}`);e=await n.json()}else e=t;if(!Array.isArray(e))throw new Error("Unit data must be an array");return this.units=e.map(n=>this.validateAndNormalizeUnit(n)),this.buildLookups(),console.log(`✅ Loaded ${this.units.length} units successfully`),this.units}catch(e){throw console.error("❌ Error loading units:",e),e}}validateAndNormalizeUnit(t){const e={name:t.name||"Unknown",unit_types:Array.isArray(t.unit_types)?t.unit_types:[],cost_type:t.cost_type||"Leadership",health:Number(t.health)||0,strength:Number(t.strength)||0,leadership_cost:Number(t.leadership_cost)||0,dominance_cost:Number(t.dominance_cost)||0,authority_cost:Number(t.authority_cost)||0,food_consumption:Number(t.food_consumption)||0,carrying_capacity:Number(t.carrying_capacity)||0,revival_cost_gold:Number(t.revival_cost_gold)||0,revival_cost_silver:Number(t.revival_cost_silver)||0,source_file:t.source_file||"",attack_modifiers:Array.isArray(t.attack_modifiers)?t.attack_modifiers:void 0};return["Leadership","Dominance","Authority","Mercenary"].includes(e.cost_type)||(console.warn(`Invalid cost type for unit ${e.name}: ${e.cost_type}`),e.cost_type="Leadership"),e}buildLookups(){this.resetData(),this.unitsByName=new Map(this.units.map(t=>[t.name,t])),this.units.forEach(t=>{f.isMercenary(t)?this.unitsByCostType.Mercenary.push(t):t.cost_type in this.unitsByCostType&&this.unitsByCostType[t.cost_type].push(t)}),Object.keys(this.unitsByCostType).forEach(t=>{this.unitsByCostType[t].sort((e,n)=>e.strength-n.strength)})}resetData(){this.unitsByName.clear(),this.unitsByCostType={Leadership:[],Dominance:[],Authority:[],Mercenary:[]}}getAllUnits(){return[...this.units]}getUnitByName(t){return this.unitsByName.get(t)}getUnitsByCostType(t){return[...this.unitsByCostType[t]]}getAvailableUnits(t){const e=[];for(const n of t){const i=this.getUnitByName(n);i?e.push(i):console.warn(`Unit '${n}' not found in loaded data`)}return e}filterUnits(t){let e=this.units;return t.costType&&(e=e.filter(n=>n.cost_type===t.costType)),t.unitTypes&&t.unitTypes.length>0&&(e=e.filter(n=>t.unitTypes.some(i=>n.unit_types.includes(i)))),t.minStrength!==void 0&&(e=e.filter(n=>n.strength>=t.minStrength)),t.maxCost!==void 0&&(e=e.filter(n=>f.getPrimaryCost(n)<=t.maxCost)),e}searchUnits(t){if(!t.trim())return this.getAllUnits();const e=t.toLowerCase();return this.units.filter(n=>n.name.toLowerCase().includes(e))}getEnhancedUnits(){return this.units.map(t=>({...t,get isMercenary(){return f.isMercenary(t)},get primaryCost(){return f.getPrimaryCost(t)},get strengthPerCost(){return f.getStrengthPerCost(t)},get healthPerCost(){return f.getHealthPerCost(t)}}))}getUnitSummary(){if(this.units.length===0)return{totalUnits:0,byCostType:{Leadership:0,Dominance:0,Authority:0,Mercenary:0},strengthRange:{min:0,max:0},healthRange:{min:0,max:0}};const t=this.units.map(n=>n.strength),e=this.units.map(n=>n.health);return{totalUnits:this.units.length,byCostType:{Leadership:this.unitsByCostType.Leadership.length,Dominance:this.unitsByCostType.Dominance.length,Authority:this.unitsByCostType.Authority.length,Mercenary:this.unitsByCostType.Mercenary.length},strengthRange:{min:Math.min(...t),max:Math.max(...t)},healthRange:{min:Math.min(...e),max:Math.max(...e)}}}getUniqueUnitTypes(){const t=new Set;return this.units.forEach(e=>{e.unit_types.forEach(n=>t.add(n))}),Array.from(t).sort()}getStatistics(){if(this.units.length===0)return{totalUnits:0,costTypeDistribution:{Leadership:0,Dominance:0,Authority:0,Mercenary:0},strengthStats:{min:0,max:0,avg:0},healthStats:{min:0,max:0,avg:0},topUnitsByStrength:[],topUnitsByHealth:[]};const t=this.units.map(n=>n.strength),e=this.units.map(n=>n.health);return{totalUnits:this.units.length,costTypeDistribution:{Leadership:this.unitsByCostType.Leadership.length,Dominance:this.unitsByCostType.Dominance.length,Authority:this.unitsByCostType.Authority.length,Mercenary:this.unitsByCostType.Mercenary.length},strengthStats:{min:Math.min(...t),max:Math.max(...t),avg:Math.round(t.reduce((n,i)=>n+i,0)/t.length)},healthStats:{min:Math.min(...e),max:Math.max(...e),avg:Math.round(e.reduce((n,i)=>n+i,0)/e.length)},topUnitsByStrength:[...this.units].sort((n,i)=>i.strength-n.strength).slice(0,10),topUnitsByHealth:[...this.units].sort((n,i)=>i.health-n.health).slice(0,10)}}}class O{constructor(t){u(this,"availableUnits");u(this,"unitsByName");u(this,"leadershipUnits");u(this,"dominanceUnits");u(this,"mercenaryUnits");this.availableUnits=[...t],this.unitsByName=new Map(t.map(e=>[e.name,e])),this.leadershipUnits=t.filter(e=>e.cost_type==="Leadership").sort((e,n)=>e.strength-n.strength),this.dominanceUnits=t.filter(e=>e.cost_type==="Dominance").sort((e,n)=>e.strength-n.strength),this.mercenaryUnits=t.filter(e=>f.isMercenary(e)).sort((e,n)=>e.strength-n.strength)}async optimizeArmy(t){const e=performance.now();console.log(`🔍 Optimizing army with L:${t.leadershipBudget} D:${t.dominanceBudget} M:${Object.keys(t.mercenaryLimits).length}`),console.log(`📋 Selected units: ${t.availableUnits.join(", ")}`);const n=[],i=this.generateGuaranteedValidCompositions(t);console.log(`Generated ${i.length} guaranteed valid army combinations`);let a=0;for(const d of i){a++;const h=this.evaluateComposition(d);n.push(h)}const s=performance.now();console.log(`Evaluated ${a} combinations, found ${n.length} valid stackings`);const r=this.availableUnits.filter(d=>t.availableUnits.includes(d.name)&&d.cost_type==="Leadership"),o=this.availableUnits.filter(d=>t.availableUnits.includes(d.name)&&d.cost_type==="Dominance"),l=this.availableUnits.filter(d=>t.availableUnits.includes(d.name)&&f.isMercenary(d)),c=n.filter(d=>{const h=r.some(y=>d.units[y.name]&&d.units[y.name]>0),p=o.some(y=>d.units[y.name]&&d.units[y.name]>0),g=l.some(y=>d.units[y.name]&&d.units[y.name]>0);return[r.length>0?h:!0,o.length>0?p:!0,l.length>0?g:!0].every(y=>y)});return c.sort((d,h)=>{const p=d.totalLeadershipCost/t.leadershipBudget+d.totalDominanceCost/t.dominanceBudget;return h.totalLeadershipCost/t.leadershipBudget+h.totalDominanceCost/t.dominanceBudget-p}),{compositions:c.length>0?[c[0]]:n.slice(0,1),totalCombinationsEvaluated:a,validStackingsFound:n.length,executionTimeMs:s-e}}generateGuaranteedValidCompositions(t){const e=[],n=this.availableUnits.filter(s=>t.availableUnits.includes(s.name)&&s.cost_type==="Leadership").sort((s,r)=>r.strength-s.strength),i=this.availableUnits.filter(s=>t.availableUnits.includes(s.name)&&s.cost_type==="Dominance").sort((s,r)=>r.strength-s.strength),a=this.availableUnits.filter(s=>t.availableUnits.includes(s.name)&&f.isMercenary(s));if(console.log(`Selected units: L:${n.length} D:${i.length} M:${a.length}`),console.log("Leadership units:",n.map(s=>s.name)),console.log("Dominance units:",i.map(s=>s.name)),console.log("Mercenary units:",a.map(s=>s.name)),console.log(`🎯 MUST use ALL selected units: L:${n.length} D:${i.length} M:${a.length}`),console.log(`Budgets: Leadership:${t.leadershipBudget} Dominance:${t.dominanceBudget}`),n.length>0&&i.length>0&&a.length>0&&t.leadershipBudget>0&&t.dominanceBudget>0){console.log("🔗 Generating ALL THREE types compositions");const s=[...n,...a];e.push(...this.generateCombinedStackedCompositions(s,i,t.leadershipBudget,t.dominanceBudget,t.mercenaryLimits))}else if(n.length>0&&a.length>0&&i.length===0&&t.leadershipBudget>0){console.log("🤝 Generating Leadership + Mercenary compositions (PROPER STACKING)");const s=[...n,...a],r=this.calculateProperStackingQuantities(s,t.leadershipBudget,t.mercenaryLimits);e.push(r)}else if(i.length>0&&a.length>0&&n.length===0&&t.dominanceBudget>0){console.log("🤝 Generating Dominance + Mercenary compositions (NEW SIMPLE STACKING)");const s=this.calculateProperStackingQuantitiesForDominance(i,t.dominanceBudget),r={};for(const l of a)r[l.name]=t.mercenaryLimits[l.name]||1;const o={...s,...r};e.push(o)}else if(n.length>0&&i.length>0&&a.length===0&&t.leadershipBudget>0&&t.dominanceBudget>0)console.log("🤝 Generating Leadership + Dominance compositions"),e.push(...this.generateCombinedStackedCompositions(n,i,t.leadershipBudget,t.dominanceBudget,{}));else if(n.length>0&&i.length===0&&a.length===0&&t.leadershipBudget>0){console.log("👑 Generating Leadership-only compositions (NEW PROPER STACKING)");const s=this.calculateProperStackingQuantities(n,t.leadershipBudget,{});e.push(s)}else if(i.length>0&&n.length===0&&a.length===0&&t.dominanceBudget>0){console.log("⚡ Generating Dominance-only compositions (NEW SIMPLE STACKING)");const s=this.calculateProperStackingQuantitiesForDominance(i,t.dominanceBudget);e.push(s)}else if(a.length>0&&n.length===0&&i.length===0){console.log("🗡️ Generating Mercenary-only compositions");const s={};for(const r of a){const o=t.mercenaryLimits[r.name]||1;s[r.name]=o}Object.keys(s).length>0&&e.push(s)}else console.log("❌ No valid combination of selected units and budgets");return n.length>0&&a.length>0&&t.leadershipBudget>0&&e.push(...this.generateMercenaryMixedCompositions(n,a,t.leadershipBudget,t.mercenaryLimits,"leadership_cost")),i.length>0&&a.length>0&&t.dominanceBudget>0&&e.push(...this.generateMercenaryMixedCompositions(i,a,t.dominanceBudget,t.mercenaryLimits,"dominance_cost")),e}generateStackedCompositionsWithMercenaries(t,e,n,i){console.log("�🚨🚨 NEW METHOD CALLED! 🚨🚨🚨"),console.log("�🗡️ Generating Leadership + Mercenary stacks (NEW PROPER STACKING)");const a=[...t,...e];console.log(`🚨 About to call calculateProperStackingQuantities with ${a.length} units`);const s=this.calculateProperStackingQuantities(a,n,i);return console.log("🚨 Got composition back:",s),[s]}calculateCleanStackingPattern(t,e){const n={};if(t.length===0)return n;const i=t[0];n[i.name]=1,console.log(`🎯 Starting with 1x ${i.name} (STR: ${i.strength})`);for(let a=1;a<t.length;a++){const s=t[a],r=t[a-1],o=r.health*(n[r.name]||1),l=Math.ceil((o+1)/s.health);n[s.name]=l,console.log(`📋 ${s.name}: need ${l} units (${l*s.health} HP) to exceed ${r.name} (${o} HP)`)}return n}calculateProperStackingQuantities(t,e,n){console.log(`🔧 SIMPLE STACKING: Starting with budget ${e}`);const i={},a=[...t].sort((d,h)=>h.strength-d.strength),s=a.filter(d=>d.cost_type==="Leadership"),r=a.filter(d=>f.isMercenary(d));if(a.length===0)return console.log("🔧 SIMPLE STACKING: No units selected"),i;console.log(`🔧 SIMPLE STACKING: Creating base pattern with ${a.length} units (${s.length} leadership + ${r.length} mercenary)`);const o=a[0],l={};l[o.name]=1;const c=o.health*1;console.log(`🔧 Base: 1x ${o.name} = ${c} HP (strongest)`);for(let d=1;d<a.length;d++){const h=a[d],p=Math.ceil((c+1)/h.health);l[h.name]=p;const g=f.isMercenary(h)?"mercenary":"leadership";console.log(`🔧 Base: ${p}x ${h.name} = ${p*h.health} HP (beats ${c}) [${g}]`)}console.log("🔧 Validating base pattern stacking order...");for(let d=0;d<a.length-1;d++){const h=a[d],p=a[d+1],g=h.health*l[h.name];let v=p.health*l[p.name];if(v<=g)if(f.isMercenary(p))console.log(`🔧 WARNING: ${p.name} mercenary limit (${l[p.name]}) gives ${v} HP, can't beat ${g} HP`);else{const y=Math.ceil((g+1)/p.health);l[p.name]=y,v=p.health*y,console.log(`🔧 Fixed: ${p.name} increased to ${y} units = ${v} HP (now beats ${g})`)}else console.log(`🔧 OK: ${p.name} ${l[p.name]} units = ${v} HP (beats ${g})`)}let m=0;for(const[d,h]of Object.entries(l)){const p=this.unitsByName.get(d);p&&p.cost_type==="Leadership"&&(m+=h*(p.leadership_cost??0))}if(console.log(`🔧 Base pattern leadership cost: ${m}`),m===0){console.log("🔧 No leadership costs, using mercenaries only");for(const[d,h]of Object.entries(l))i[d]=h}else{const d=Math.floor(e/m);console.log(`🔧 Can afford ${d} base stacks (${e} / ${m})`);for(const[h,p]of Object.entries(l)){const g=this.unitsByName.get(h);if(g&&f.isMercenary(g)){const v=p*d,y=n[h]||1;i[h]=Math.min(v,y),v>y?console.log(`🔧 Mercenary ${h}: wanted ${v}, capped at limit ${y}`):console.log(`🔧 Mercenary ${h}: scaled to ${v} (under limit ${y})`)}else i[h]=p*d}}return console.log("🔧 SIMPLE STACKING: Final composition:",i),i}calculateProperStackingQuantitiesForDominance(t,e){console.log(`🔧 DOMINANCE STACKING: Starting with budget ${e}`);const n={},i=[...t].sort((c,m)=>m.strength-c.strength);if(i.length===0)return console.log("🔧 DOMINANCE STACKING: No dominance units selected"),n;console.log(`🔧 DOMINANCE STACKING: Creating base pattern with ${i.length} dominance units`);const a=i[0],s={};s[a.name]=1;const r=a.health*1;console.log(`🔧 Base: 1x ${a.name} = ${r} HP (strongest)`);for(let c=1;c<i.length;c++){const m=i[c],d=Math.ceil((r+1)/m.health);s[m.name]=d,console.log(`🔧 Base: ${d}x ${m.name} = ${d*m.health} HP (beats ${r})`)}console.log("🔧 Validating dominance base pattern stacking order...");for(let c=0;c<i.length-1;c++){const m=i[c],d=i[c+1],h=m.health*s[m.name];let p=d.health*s[d.name];if(p<=h){const g=Math.ceil((h+1)/d.health);s[d.name]=g,p=d.health*g,console.log(`🔧 Fixed: ${d.name} increased to ${g} units = ${p} HP (now beats ${h})`)}else console.log(`🔧 OK: ${d.name} ${s[d.name]} units = ${p} HP (beats ${h})`)}let o=0;for(const[c,m]of Object.entries(s)){const d=this.unitsByName.get(c);d&&d.cost_type==="Dominance"&&(o+=m*d.dominance_cost)}if(console.log(`🔧 Base pattern dominance cost: ${o}`),o===0)return console.log("🔧 No dominance costs found"),n;const l=Math.floor(e/o);console.log(`🔧 Can afford ${l} base stacks (${e} / ${o})`);for(const[c,m]of Object.entries(s))n[c]=m*l;return console.log("🔧 DOMINANCE STACKING: Final composition:",n),n}calculateLeadershipCost(t){return Object.entries(t).reduce((e,[n,i])=>{const a=this.unitsByName.get(n);return a&&a.cost_type==="Leadership"?e+i*a.leadership_cost:e},0)}calculateMaxStacksByMercenaries(t,e){let n=1/0;for(const[i,a]of Object.entries(t)){const s=this.unitsByName.get(i);if(s&&f.isMercenary(s)){const r=e[i]||1,o=Math.floor(r/a);n=Math.min(n,o),console.log(`🗡️ ${i}: limit ${r}, base need ${a}, allows ${o} stacks`)}}return n===1/0?100:n}generateDominanceMercenaryCompositions(t,e,n,i){const a=[];console.log("⚡🗡️ Generating Dominance + Mercenary stacks");const s=[...t,...e].sort((d,h)=>h.strength-d.strength);if(s.length===0)return a;const r=this.calculateCleanStackingPattern(s,i);console.log("📊 Dominance + Mercenary base pattern:",r);const o=Object.entries(r).reduce((d,[h,p])=>{const g=this.unitsByName.get(h);return g&&g.cost_type==="Dominance"?d+p*g.dominance_cost:d},0);if(console.log(`💰 Dominance cost per stack: ${o}`),o>n){console.log("❌ Can't afford mercenary stack, falling back to pure strategies");const d={};for(const h of e)d[h.name]=i[h.name]||1;return a.push(d),t.length>0&&a.push(...this.generateStackedCompositions(t,n,"dominance_cost")),a}const l=Math.floor(n/o),c=this.calculateMaxStacksByMercenaries(r,i),m=Math.min(l,c);console.log(`🔢 Max Dominance+Mercenary stacks: ${m}`);for(let d=1;d<=Math.min(m,5);d++){const h={};for(const[p,g]of Object.entries(r)){const v=this.unitsByName.get(p);v&&f.isMercenary(v)?h[p]=Math.min(g*d,i[p]||1):h[p]=g*d}a.push(h)}if(c<l&&t.length>0){const d=n-m*o,h=this.generateStackedCompositions(t,d,"dominance_cost"),p={};for(const g of e)p[g.name]=i[g.name]||1;for(const g of h.slice(0,3)){const v={...p,...g};a.push(v)}}return a}generateStackedCompositions(t,e,n){const i=[];if(t.length===0||e<=0)return i;const a=t[0];console.log(`🎯 Strongest unit: ${a.name} (STR: ${a.strength})`);const s=this.calculateStackingPattern(t);console.log("📊 Base stacking pattern:",s);const r=Object.entries(s).reduce((l,[c,m])=>{const d=this.unitsByName.get(c);if(d){const h=d[n];return l+m*h}return l},0);if(console.log(`💰 Base pattern cost: ${r}`),r<=0)return i;const o=Math.floor(e/r);console.log(`🔢 Max multiplier: ${o}`);for(let l=1;l<=Math.min(o,10);l++){const c={};for(const[m,d]of Object.entries(s))c[m]=d*l;i.push(c)}return t.length>1&&i.push(...this.generateStackingVariations(t,e,n)),i}calculateStackingPattern(t){const e={};if(t.length===0)return e;const n=t[0];e[n.name]=1;for(let i=1;i<t.length;i++){const a=t[i],s=t[i-1],r=s.health*(e[s.name]||1),o=Math.ceil((r+1)/a.health);e[a.name]=o,console.log(`📋 ${a.name}: need ${o} units (${o*a.health} HP) to exceed ${s.name} (${r} HP)`)}return e}generateCombinedStackedCompositions(t,e,n,i,a={}){const s=[];console.log("🔗 Generating combined Leadership + Mercenary + Dominance stacks");const r=t.filter(k=>k.cost_type==="Leadership"),o=t.filter(k=>f.isMercenary(k));console.log("🗡️ Generating Leadership + Mercenary stacks (proper stacking approach)");const l=[...r,...o],m=[this.calculateProperStackingQuantities(l,n,a)];if(m.length===0)return s;const d=m[m.length-1];if(!d)return s;console.log("🎯 Using maximum Leadership composition for combination");const h=d,p=e[0];console.log(`🎯 Strongest Dominance unit: ${p.name} (STR: ${p.strength})`);const g=this.findClosestStrengthUnit(p,t);if(!g)return console.log("❌ No suitable Leadership unit found for comparison"),s;console.log(`🔍 Comparing to Leadership unit: ${g.name} (STR: ${g.strength})`);const v=h[g.name]||0,y=g.health*v;if(console.log(`📊 Comparison unit total health: ${y} (${v}x ${g.health})`),y<=0)return console.log("❌ Comparison unit not in Leadership composition"),s;const S=p.health;S>=y&&(console.log(`⚠️ Single Dominance unit too strong: ${S} HP >= ${y} HP`),console.log("🔧 Trying constrained Dominance stack anyway (may use weaker Dominance units)")),console.log("🔄 Creating independent Dominance stack to maximize budget usage (NEW SIMPLE STACKING)");const C=[this.calculateProperStackingQuantitiesForDominance(e,i)];if(C.length>0){const k=C[C.length-1],z={...h,...k};s.push(z),console.log("✅ Created independent L+M + D composition maximizing both budgets")}else console.log("⚠️ Using Leadership+Mercenary composition only"),s.push(h);return s}findClosestStrengthUnit(t,e){if(e.length===0)return null;let n=e[0],i=Math.abs(t.strength-n.strength);for(const a of e){const s=Math.abs(t.strength-a.strength);s<i&&(i=s,n=a)}return console.log(`🎯 Closest match: ${n.name} (STR: ${n.strength}) vs ${t.name} (STR: ${t.strength}), diff: ${i}`),n}calculateConstrainedDominanceStack(t,e,n){const i={};if(console.log(`🔒 Calculating Dominance stack with max health constraint: ${n}`),t.length===0||e<=0||n<=0)return i;const a=t[0],s=Math.floor((n-1)/a.health),r=Math.floor(e/a.dominance_cost),o=Math.min(s,r);if(o<=0)return console.log(`❌ Cannot fit any ${a.name} within constraints`),i;for(let l=Math.min(o,3);l>=1;l--){const c={};c[a.name]=l;let m=l*a.dominance_cost,d=l*a.health;console.log(`🧪 Testing ${l}x ${a.name} (${d} HP, ${m} cost)`);for(let p=1;p<t.length&&m<e;p++){const g=t[p],v=e-m,y=Math.ceil((d+1)/g.health),S=Math.floor(v/g.dominance_cost),x=Math.min(y,S);x>0&&(c[g.name]=x,m+=x*g.dominance_cost,console.log(`  ➕ Added ${x}x ${g.name} (${x*g.health} HP)`))}const h=Object.entries(c).reduce((p,[g,v])=>{const y=this.unitsByName.get(g);return y?p+v*y.health:p},0);if(h<n)return console.log(`✅ Valid Dominance stack: ${h} HP < ${n} HP limit`),c;console.log(`❌ Dominance stack too strong: ${h} HP >= ${n} HP limit`)}return console.log("❌ Could not create valid constrained Dominance stack"),i}generateMercenaryMixedCompositions(t,e,n,i,a){const s=[];console.log("🗡️ Generating mixed compositions with mercenaries");const r=this.generateStackedCompositions(t,n,a);if(r.length===0)return s;for(const o of r.slice(0,3)){const l=e.sort((y,S)=>S.strength-y.strength)[0];if(!l)continue;console.log(`🎯 Strongest Mercenary: ${l.name} (STR: ${l.strength})`);const c=this.findClosestStrengthUnit(l,t);if(!c){console.log("❌ No suitable base unit found for comparison");continue}const m=o[c.name]||0,d=c.health*m;if(console.log(`📊 Comparison base unit total health: ${d}`),d<=0){console.log("❌ Comparison unit not in base composition");continue}const h=l.health,p=i[l.name]||1,g=h*p;if(g>=d){console.log(`⚠️ Mercenary too strong: ${g} HP >= ${d} HP`),console.log("🔧 Reducing mercenary quantity to fit stacking order");const y=Math.floor((d-1)/h);if(y>0){console.log(`✅ Using ${y}x ${l.name} instead of ${p}`);const S={...o};S[l.name]=y;for(const x of e)if(x.name!==l.name){const C=i[x.name]||1;S[x.name]=C}s.push(S),console.log("✅ Created mixed composition with reduced mercenaries")}else console.log("❌ Even 1 mercenary too strong, skipping mercenary integration"),s.push(o);continue}const v={...o};for(const y of e){const S=i[y.name]||1;v[y.name]=S}s.push(v),console.log("✅ Created mixed composition with mercenaries")}return s}createAlternativeDominanceStack(t,e,n){const i={};console.log(`🔄 Creating alternative Dominance stack with max health: ${n}`);const a=[...t].sort((o,l)=>o.health-l.health);let s=0,r=0;for(const o of a){const l=Math.floor((n-r-1)/o.health),c=Math.floor((e-s)/o.dominance_cost),m=Math.min(l,c);m>0&&(i[o.name]=m,s+=m*o.dominance_cost,r+=m*o.health,console.log(`➕ Added ${m}x ${o.name} (${m*o.health} HP, ${m*o.dominance_cost} cost)`))}return console.log(`📊 Alternative Dominance stack: ${r} HP total, ${s} cost`),i}calculateMaximizedDominanceStack(t,e,n){console.log(`💰 Maximizing Dominance budget: ${e} with health limit: ${n}`);const i=this.createAlternativeDominanceStack(t,e,n);return Object.keys(i).length>0?i:this.calculateConstrainedDominanceStack(t,e,n)}generateStackingVariations(t,e,n){const i=[],a={},s=t[0],r=s[n];if(r>0){const o=Math.floor(e/r);a[s.name]=Math.min(o,5);let l=e-a[s.name]*r;for(let c=1;c<t.length&&l>0;c++){const m=t[c],d=m[n];if(d>0&&d<=l){const h=Math.floor(l/d/(t.length-c));h>0&&(a[m.name]=h,l-=h*d)}}i.push(a)}return i}generateGuaranteedDiverseCompositions_OLD(t){const e=[],n=this.availableUnits.filter(l=>t.availableUnits.includes(l.name)&&l.cost_type==="Leadership"),i=this.availableUnits.filter(l=>t.availableUnits.includes(l.name)&&l.cost_type==="Dominance"),a=this.availableUnits.filter(l=>t.availableUnits.includes(l.name)&&f.isMercenary(l)),s={};let r=0,o=0;for(const l of n)r+l.leadership_cost<=t.leadershipBudget&&(s[l.name]=1,r+=l.leadership_cost);for(const l of i)o+l.dominance_cost<=t.dominanceBudget&&(s[l.name]=1,o+=l.dominance_cost);for(const l of a){const c=t.mercenaryLimits[l.name]||1;s[l.name]=Math.min(1,c)}if(Object.keys(s).length>0&&e.push(s),n.length>0&&t.leadershipBudget>0){const l=n.sort((m,d)=>m.leadership_cost-d.leadership_cost)[0],c=Math.floor(t.leadershipBudget/l.leadership_cost);if(c>0){const m={};m[l.name]=Math.min(c,20);const d=t.leadershipBudget-m[l.name]*l.leadership_cost;for(const h of n.slice(1,3)){const p=Math.floor(d/h.leadership_cost/2);p>0&&(m[h.name]=p)}e.push(m)}}if(n.length>0||i.length>0){const l={};if(n.length>0&&t.leadershipBudget>0){const c=Math.floor(t.leadershipBudget/n.length);for(const m of n){const d=Math.floor(c/m.leadership_cost);d>0&&(l[m.name]=d)}}if(i.length>0&&t.dominanceBudget>0){const c=Math.floor(t.dominanceBudget/i.length);for(const m of i){const d=Math.floor(c/m.dominance_cost);d>0&&(l[m.name]=d)}}for(const c of a){const m=t.mercenaryLimits[c.name]||1;l[c.name]=Math.max(1,Math.floor(m/2))}Object.keys(l).length>0&&e.push(l)}return e}generateMercenaryCombinations(t){if(Object.keys(t).length===0)return[{}];let e=[{}];for(const[n,i]of Object.entries(t)){if(!this.unitsByName.has(n))continue;const a=[];for(const s of e)for(let r=0;r<=i;r++){const o={...s};r>0&&(o[n]=r),a.push(o)}e=a}return e}evaluateComposition(t){let e=0,n=0,i=0,a=0,s=0;const r=[];for(const[v,y]of Object.entries(t)){const S=this.unitsByName.get(v);if(!S)continue;const x=S.health*y,C=S.strength*y;e+=C,n+=x,i+=S.leadership_cost*y,a+=S.dominance_cost*y,f.isMercenary(S)&&(s+=y),r.push({unit:S,count:y,totalHealth:x,unitStrength:S.strength})}r.sort((v,y)=>v.unit.strength-y.unit.strength);let o=!0;const l=[];for(let v=0;v<r.length;v++){const{unit:y,count:S,totalHealth:x}=r[v];l.push({count:S,totalHealth:x,unit:y});for(let C=v+1;C<r.length;C++){const k=r[C].unit,z=r[C].totalHealth;if(y.strength===k.strength){const W=Math.max(x,z)*.1;if(Math.abs(x-z)<=W)continue}x<=z&&console.log(`❌ Stacking violation: ${y.name} (STR:${y.strength}, ${x} HP) <= ${k.name} (STR:${k.strength}, ${z} HP)`)}}const c=i+a+s;let m=c>0?e/c:0;m*=1.2;const h=1+(Object.keys(t).length-1)*.05;m*=h;let p=0;i>0&&p++,a>0&&p++,s>0&&p++;const g=1+(p-1)*.1;return m*=g,{units:t,totalStrength:e,totalHealth:n,totalLeadershipCost:i,totalDominanceCost:a,totalMercenaryCount:s,stackingOrder:l,isValidStacking:o,efficiencyScore:m}}explainStacking(t){const e=[],n=[],i=[],a=[];return t.stackingOrder.forEach(s=>{const r=s.unit;if(!r)return;const o={name:s.unit.name,count:s.count,totalHealth:s.totalHealth,strength:r.strength};f.isMercenary(r)?a.push(o):r.cost_type==="Leadership"?n.push(o):r.cost_type==="Dominance"&&i.push(o)}),e.push("🏆 OPTIMIZED ARMY COMPOSITION"),e.push("═".repeat(60)),e.push(""),e.push("📊 ARMY SUMMARY"),e.push("─".repeat(30)),e.push(`Total Units: ${Object.values(t.units).reduce((s,r)=>s+r,0).toLocaleString()}`),e.push(`Total Strength: ${t.totalStrength.toLocaleString()}`),e.push(`Total Health: ${t.totalHealth.toLocaleString()}`),e.push(`Budget Usage: L:${t.totalLeadershipCost} D:${t.totalDominanceCost} M:${t.totalMercenaryCount}`),e.push(""),a.length>0&&(e.push("🗡️ MERCENARY FORCES"),e.push("─".repeat(30)),a.forEach(s=>{e.push(`${s.count.toLocaleString()}x ${s.name}`),e.push(`   └─ ${s.totalHealth.toLocaleString()} HP total (STR: ${s.strength})`)}),e.push("")),n.length>0&&(e.push("👑 LEADERSHIP FORCES"),e.push("─".repeat(30)),n.sort((s,r)=>r.strength-s.strength),n.forEach(s=>{e.push(`${s.count.toLocaleString()}x ${s.name}`),e.push(`   └─ ${s.totalHealth.toLocaleString()} HP total (STR: ${s.strength})`)}),e.push("")),i.length>0&&(e.push("⚡ DOMINANCE FORCES"),e.push("─".repeat(30)),i.sort((s,r)=>r.strength-s.strength),i.forEach(s=>{e.push(`${s.count.toLocaleString()}x ${s.name}`),e.push(`   └─ ${s.totalHealth.toLocaleString()} HP total (STR: ${s.strength})`)}),e.push("")),e.push("⚔️ BATTLE ORDER (Weakest → Strongest)"),e.push("─".repeat(40)),t.stackingOrder.forEach((s,r)=>{const o=s.unit;if(!o)return;const l=f.isMercenary(o)?"🗡️":o.cost_type==="Leadership"?"👑":o.cost_type==="Dominance"?"⚡":"❓";e.push(`${r+1}. ${l} ${s.count.toLocaleString()}x ${s.unit.name} (${s.totalHealth.toLocaleString()} HP)`)}),e.join(`
`)}getAvailableUnits(){return[...this.availableUnits]}getUnitsByCostType(){return{Leadership:[...this.leadershipUnits],Dominance:[...this.dominanceUnits],Authority:[],Mercenary:[...this.mercenaryUnits]}}}const T={MAX_BATTLE_TURNS:5e4,MAX_ACTIONS_PER_TURN:1e3,GENERIC_ENEMY_DAMAGE:999999999};class rt{constructor(t=!0){u(this,"logs",[]);u(this,"startTime",0);u(this,"detailedLogging",!0);this.detailedLogging=t,this.startTime=Date.now()}logPlayerAction(t,e,n,i,a,s){const r=this.getEnemyDisplayName(e),o={turn:i,attacker:`${t.count}x ${t.unit.name}`,target:r,action:`attack ${r} for ${n.damageDealt} damage${n.bonusDamageDealt?` including ${n.bonusDamageDealt} bonus damage vs ${n.modifierName}`:""}${n.targetEliminated?" (ELIMINATED)":""}`,damageDealt:n.damageDealt,eliminated:n.targetEliminated,attackerSide:"player",timestamp:Date.now()-this.startTime};return this.detailedLogging&&(o.turnSummary=this.generateTurnSummary(i,a),o.actionDetails=this.generatePlayerActionDetails(t,e,n),s&&(o.stateSnapshot=this.createStateSnapshot(s))),this.logs.push(o),o}logEnemyAction(t,e,n,i,a,s){const r={turn:i,attacker:this.getEnemyDisplayName(t),target:e.unit.name,action:`attack ${e.unit.name} for ${n.damageDealt} damage${n.targetEliminated?" (ELIMINATED)":""}`,damageDealt:n.damageDealt,eliminated:n.targetEliminated,attackerSide:"enemy",timestamp:Date.now()-this.startTime};return this.detailedLogging&&(r.turnSummary=this.generateTurnSummary(i,a),r.actionDetails=this.generateEnemyActionDetails(t,e,n),s&&(r.stateSnapshot=this.createStateSnapshot(s))),this.logs.push(r),r}logTurnTransition(t,e,n){if(!this.detailedLogging)return;const i={turn:e,actionIndex:0,attackerName:"SYSTEM",attackerCount:0,targetName:"TURN_TRANSITION",targetType:"system",damageDealt:0,targetEliminated:!1,attackerSide:"system",timestamp:Date.now()-this.startTime,turnSummary:`Turn ${t} completed, advancing to Turn ${e}`,actionDetails:`Battle continues with ${this.countAlivePlayerGroups(n)} player groups vs ${this.countAttackableEnemies(n)} enemies`,stateSnapshot:this.createStateSnapshot(n)};this.logs.push(i)}logBattleStart(t,e,n){const i={turn:1,actionIndex:0,attackerName:"SYSTEM",attackerCount:0,targetName:"BATTLE_START",targetType:"system",damageDealt:0,targetEliminated:!1,attackerSide:"system",timestamp:0,turnSummary:"Battle begins",actionDetails:`${t.length} player groups vs ${e.length} enemies, ${n?"Player":"Enemy"} goes first`,stateSnapshot:{alivePlayerGroups:t.length,attackableEnemies:e.length,totalPlayerHealth:t.reduce((a,s)=>a+s.totalHealth,0)}};this.logs.push(i)}logBattleEnd(t,e,n="Battle completed"){const i={turn:e.currentTurn,actionIndex:e.currentAction,attackerName:"SYSTEM",attackerCount:0,targetName:"BATTLE_END",targetType:"system",damageDealt:e.totalDamageDealt,targetEliminated:!1,attackerSide:"system",timestamp:Date.now()-this.startTime,turnSummary:`Battle ended: ${t}`,actionDetails:`${n}. Total damage dealt: ${e.totalDamageDealt}`,stateSnapshot:this.createStateSnapshot(e)};this.logs.push(i)}getBattleLogs(){return[...this.logs]}getLogsForTurn(t){return this.logs.filter(e=>e.turn===t)}getLogsBySide(t){return this.logs.filter(e=>e.attackerSide===t)}generateBattleSummary(){const t=this.logs.filter(r=>r.attackerSide==="player"),e=this.logs.filter(r=>r.attackerSide==="enemy"),n=this.logs.filter(r=>r.targetEliminated),i=this.logs[this.logs.length-1],a=i?i.turn:0,s=this.logs.filter(r=>r.attackerSide!=="system").reduce((r,o)=>r+o.damageDealt,0);return{totalTurns:a,totalActions:t.length+e.length,totalDamageDealt:s,playerActionsCount:t.length,enemyActionsCount:e.length,eliminationsCount:n.length,battleDuration:a,outcome:this.determineBattleOutcome()}}exportLogs(t="json"){switch(t){case"json":return JSON.stringify(this.logs,null,2);case"csv":return this.exportToCSV();case"text":return this.exportToText();default:return JSON.stringify(this.logs,null,2)}}clearLogs(){this.logs=[],this.startTime=Date.now()}setDetailedLogging(t){this.detailedLogging=t}searchLogs(t){return this.logs.filter(e=>!(t.attacker&&!e.attackerName.toLowerCase().includes(t.attacker.toLowerCase())||t.target&&!e.targetName.toLowerCase().includes(t.target.toLowerCase())||t.minDamage&&e.damageDealt<t.minDamage||t.turnRange&&(e.turn<t.turnRange[0]||e.turn>t.turnRange[1])||t.eliminationOnly&&!e.targetEliminated))}getEnemyDisplayName(t){var e,n;switch(t.type){case"generic":return t.name||"Generic Enemy";case"infinite":return((e=t.unit)==null?void 0:e.name)||"Infinite Enemy";case"mortal":return((n=t.unit)==null?void 0:n.name)||"Mortal Enemy";default:return"Unknown Enemy"}}getEnemyCount(t){switch(t.type){case"generic":return 1;case"infinite":return 999999;case"mortal":return t.currentCount;default:return 0}}generateTurnSummary(t,e){return`Turn ${t}, Action ${e}`}generatePlayerActionDetails(t,e,n){const i=this.getEnemyDisplayName(e);let a=`${t.count}x ${t.unitName} attacks ${i}`;return a+=` for ${n.damageDealt} damage`,n.targetEliminated&&(a+=" (ELIMINATED)"),a}generateEnemyActionDetails(t,e,n){let a=`${this.getEnemyDisplayName(t)}`;return t.type==="mortal"&&(a+=` (${t.currentCount} units)`),a+=` attacks ${e.count}x ${e.unitName}`,a+=` for ${n.damageDealt} damage`,n.targetEliminated&&(a+=" (ELIMINATED)"),a}createStateSnapshot(t){return{alivePlayerGroups:this.countAlivePlayerGroups(t),attackableEnemies:this.countAttackableEnemies(t),totalPlayerHealth:t.playerGroups.reduce((e,n)=>e+n.totalHealth,0)}}countAlivePlayerGroups(t){return t.playerGroups.filter(e=>e.totalHealth>0).length}countAttackableEnemies(t){return t.enemies.filter(e=>{switch(e.type){case"generic":case"infinite":return!0;case"mortal":return e.currentCount>0;default:return!1}}).length}determineBattleOutcome(){const t=[...this.logs].reverse().find(e=>e.attackerSide==="system"&&e.targetName==="BATTLE_END");return t&&t.turnSummary?t.turnSummary.replace("Battle ended: ",""):"Unknown"}exportToCSV(){const t=["Turn","Action","Attacker Side","Attacker","Target","Damage","Eliminated","Timestamp"],e=this.logs.map(n=>[n.turn,n.actionIndex,n.attackerSide,`${n.attackerCount}x ${n.attackerName}`,n.targetName,n.damageDealt,n.targetEliminated?"Yes":"No",n.timestamp]);return[t,...e].map(n=>n.join(",")).join(`
...
`;return e}}class ot{constructor(t){u(this,"state");u(this,"battleLogger");this.state=this.initializeBattleState(t),this.battleLogger=new rt}initializeBattleState(t){return{currentTurn:1,currentAction:0,playerGroups:t.playerArmy.stackingOrder.map(e=>({...e})),enemies:t.enemies.map(e=>({...e})),unitsActedThisTurn:{players:new Set,enemies:new Set},combatLog:[],battleEnded:!1,totalDamageDealt:0}}deepCloneState(t){return{...t,unitsActedThisTurn:{players:new Set(t.unitsActedThisTurn.players),enemies:new Set(t.unitsActedThisTurn.enemies)},playerGroups:t.playerGroups.map(e=>({...e})),enemies:t.enemies.map(e=>({...e})),combatLog:[...t.combatLog]}}getBattleState(){return this.deepCloneState(this.state)}applyStateUpdate(t){if(!t||typeof t.currentTurn!="number"||typeof t.currentAction!="number")throw new Error("Invalid state update: missing required fields");this.state=t}getAlivePlayerGroups(){return this.state.playerGroups.filter(t=>t.totalHealth>0)}getAttackableEnemies(){return this.state.enemies.filter(t=>{switch(t.type){case"generic":return!0;case"infinite":return!0;case"mortal":return t.currentCount>0;default:return!1}})}updatePlayerGroup(t,e,n=0){const i=this.state.playerGroups.find(a=>a.unit.name===t);i&&(i.totalHealth=Math.max(0,e),n>0&&(i.count=Math.max(0,i.count-n)))}updateMortalEnemy(t,e){const n=this.state.enemies[t];n&&n.type==="mortal"&&(n.currentCount=Math.max(0,n.currentCount-e))}applyCompleteAttack(t,e){var s,r;const n=this.deepCloneState(t),i={damageDealt:e.damageDealt,bonusDamageDealt:(s=e.damageBreakdown)==null?void 0:s.bonusDamage,modifierName:(r=e.damageBreakdown)!=null&&r.appliedModifiers&&e.damageBreakdown.appliedModifiers.length>0?e.damageBreakdown.appliedModifiers[0].target_type:void 0,targetEliminated:e.targetEliminated,attackerEliminated:!1,combatAction:e.combatAction},a=this.isPlayerGroup(e.attacker)?this.battleLogger.logPlayerAction(e.attacker,e.target,i,t.currentTurn,t.currentAction,t):this.battleLogger.logEnemyAction(e.attacker,e.target,i,t.currentTurn,t.currentAction,t);if(n.combatLog.push(a),n.totalDamageDealt+=e.damageDealt,this.isPlayerGroup(e.attacker))n.unitsActedThisTurn.players.add(e.attacker.unit.name);else{const o=n.enemies.findIndex(l=>l.groupIndex===e.attacker.groupIndex);o>=0&&n.unitsActedThisTurn.enemies.add(o)}if(n.currentAction++,e.targetEliminated){if(this.isPlayerGroup(e.target)){const o=n.playerGroups.find(l=>l.unit.name===e.target.unit.name);o&&(o.totalHealth=0,o.count=0)}else if(e.target.type==="mortal"){const o=n.enemies.findIndex(l=>l.groupIndex===e.target.groupIndex);o>=0&&n.enemies[o].type==="mortal"&&(n.enemies[o].currentCount=0)}}else if(this.isPlayerGroup(e.target)){const o=n.playerGroups.find(l=>l.unit.name===e.target.unit.name);if(o&&e.damageDealt>0){o.totalHealth=Math.max(0,o.totalHealth-e.damageDealt);const l=o.unit.health,c=Math.floor(e.damageDealt/l);o.count=Math.max(0,o.count-c)}}else if(e.target.type==="mortal"){const o=n.enemies.findIndex(l=>l.groupIndex===e.target.groupIndex);if(o>=0&&n.enemies[o].type==="mortal"){const l=n.enemies[o],c=Math.floor(e.damageDealt/l.unit.health);l.currentCount=Math.max(0,l.currentCount-c)}}return n}isPlayerGroup(t){return"unit"in t&&"totalHealth"in t&&!("type"in t)}applyAttackResult(t,e){const n=this.deepCloneState(t);if(n.combatLog.push({...e.combatAction,turn:t.currentTurn}),n.totalDamageDealt+=e.damageDealt,e.targetEliminated)if(e.combatAction.attacker.includes("x ")){const i=n.enemies.findIndex(a=>a.type==="mortal"&&this.getEnemyDisplayName(a)===e.combatAction.target);i>=0&&n.enemies[i].type==="mortal"&&(n.enemies[i].currentCount=0)}else{const i=n.playerGroups.find(a=>a.unit.name===e.combatAction.target);i&&(i.totalHealth=0,i.count=0)}else{const i=n.playerGroups.find(a=>a.unit.name===e.combatAction.target);if(i&&e.damageDealt>0){i.totalHealth=Math.max(0,i.totalHealth-e.damageDealt);const a=i.unit.health,s=Math.floor(e.damageDealt/a);i.count=Math.max(0,i.count-s)}}return n}getEnemyDisplayName(t){switch(t.type){case"generic":return t.name;case"infinite":return t.unit.name;case"mortal":return t.unit.name;default:return"Unknown Enemy"}}addCombatAction(t){this.state.combatLog.push({...t,turn:this.state.currentTurn})}addDamageDealt(t){this.state.totalDamageDealt+=t}checkBattleEndPure(t,e=T.MAX_BATTLE_TURNS){const n=t.playerGroups.filter(c=>c.totalHealth>0),i=t.enemies.filter(c=>{switch(c.type){case"generic":return!0;case"infinite":return!0;case"mortal":return c.currentCount>0;default:return!1}}),a=n.length===0,r=t.enemies.every(c=>c.type==="mortal")&&i.length===0,o=t.currentTurn>=e;return{...t,battleEnded:a||r||o}}checkBattleEnd(){const t=this.getBattleState(),e=this.checkBattleEndPure(t);this.applyStateUpdate(e)}canEnemyAttack(t){switch(t.type){case"generic":return!0;case"infinite":return!0;case"mortal":return t.currentCount>0;default:return!1}}getBattleOutcome(t=T.MAX_BATTLE_TURNS){const e=this.getAlivePlayerGroups(),n=this.getAttackableEnemies();return e.length===0?"player_eliminated":n.length===0&&this.state.enemies.every(i=>i.type==="mortal")?"player_victory":(this.state.currentTurn>=t,"stalemate")}isBattleEnded(){return this.state.battleEnded}getCurrentTurn(){return this.state.currentTurn}getCurrentAction(){return this.state.currentAction}getTotalDamageDealt(){return this.state.totalDamageDealt}getCombatLog(){return[...this.state.combatLog]}endBattle(){this.state.battleEnded=!0}resetBattle(t){this.state=this.initializeBattleState(t)}}class lt{selectNextPlayerAttack(t){const e=t.playerGroups.filter(s=>s.totalHealth>0&&!t.unitsActedThisTurn.players.has(s.unit.name));if(e.length===0)return null;const n=this.getAttackableEnemies(t);if(n.length===0)return null;let i=null,a=0;for(const s of e)for(const r of n){const o=this.calculatePlayerDamageToEnemy(s,r);if(o.finalDamage>a){a=o.finalDamage;let l=!1;if(r.type==="mortal"){const c=r.unit.health*r.currentCount;l=o.finalDamage>=c}i={attacker:s,target:r,damageDealt:o.finalDamage,damageBreakdown:o,targetEliminated:l,combatAction:{}}}}return i}selectNextEnemyAttack(t){const e=t.enemies.filter((s,r)=>this.canEnemyAttack(s)&&!t.unitsActedThisTurn.enemies.has(r));if(e.length===0)return null;const n=t.playerGroups.filter(s=>s.totalHealth>0);if(n.length===0)return null;let i=null,a=0;for(const s of e)for(const r of n){const o=this.calculateEnemyDamageToPlayer(s,r);if(o.finalDamage>a){a=o.finalDamage;const l=o.finalDamage>=r.totalHealth;i={attacker:s,target:r,damageDealt:o.finalDamage,damageBreakdown:o,targetEliminated:l,combatAction:{}}}}return i}getEnemyDisplayName(t){switch(t.type){case"generic":return t.name;case"infinite":return t.unit.name;case"mortal":return`${t.unit.name} (${t.currentCount}/${t.count})`;default:return"Unknown Enemy"}}selectNextPlayer(t){const e=t.playerGroups.filter(s=>s.totalHealth>0&&!t.unitsActedThisTurn.players.has(s.unit.name));if(e.length===0)return null;const n=this.getAttackableEnemies(t);if(n.length===0)return null;let i=null,a=0;for(const s of e){const r=this.calculatePlayerMaxDamage(s,n);r>a&&(a=r,i=s)}return i}selectNextEnemy(t){const e=t.enemies.filter((s,r)=>this.canEnemyAttack(s)&&!t.unitsActedThisTurn.enemies.has(r));if(e.length===0)return null;const n=t.playerGroups.filter(s=>s.totalHealth>0);if(n.length===0)return null;let i=null,a=0;for(const s of e){const r=this.calculateEnemyMaxDamage(s,n);r>a&&(a=r,i=s)}return i}calculatePlayerMaxDamage(t,e){let n=0;for(const i of e){const a=this.calculatePlayerDamageToEnemy(t,i);n=Math.max(n,a)}return n}calculateEnemyMaxDamage(t,e){let n=0;for(const i of e){const a=this.calculateEnemyDamageToPlayer(t,i);n=Math.max(n,a)}return n}calculatePlayerDamageToEnemy(t,e){const n=t.count*t.unit.strength;let i=n;const a=this.createDamageBreakdown(n);if((e.type==="infinite"||e.type==="mortal")&&e.unit){const s=this.getBestAttackModifier(t,e.unit);s&&(i=this.applyAttackModifiers(n,s,a))}if(e.type==="mortal"){const s=e.unit.health*e.currentCount;i=Math.min(i,s)}return a.finalDamage=i,a}calculateEnemyDamageToPlayer(t,e){let n,i;if(t.type==="generic")n=T.GENERIC_ENEMY_DAMAGE,i=this.createDamageBreakdown(n);else if(t.type==="infinite"){const a=e.totalHealth;i=this.createDamageBreakdown(a);const s=this.getBestEnemyAttackModifier(t.unit,e);s&&s.value>0?n=this.applyAttackModifiers(a,s,i):n=a}else if(t.type==="mortal"){const a=t.currentCount*t.unit.strength;i=this.createDamageBreakdown(a);const s=this.getBestEnemyAttackModifier(t.unit,e);s&&s.value>0?n=this.applyAttackModifiers(a,s,i):n=a}else n=0,i=this.createDamageBreakdown(0);return i.finalDamage=Math.min(n,e.totalHealth),i}getBestAttackModifier(t,e){if(!t.unit||!t.unit.attack_modifiers||t.unit.attack_modifiers.length===0)return null;let n=null,i=0;for(const a of t.unit.attack_modifiers)e.unit_types&&e.unit_types.includes(a.target_type)&&(i=Math.max(i,a.value),n=a);return n}getBestEnemyAttackModifier(t,e){if(!t||!t.attack_modifiers||t.attack_modifiers.length===0)return null;let n=null,i=0;for(const a of t.attack_modifiers)e.unit.unit_types&&e.unit.unit_types.includes(a.target_type)&&(i=Math.max(i,a.value),n=a);return n}getAttackableEnemies(t){return t.enemies.filter(e=>this.canEnemyAttack(e))}canEnemyAttack(t){switch(t.type){case"generic":return!0;case"infinite":return!0;case"mortal":return t.currentCount>0;default:return!1}}createDamageBreakdown(t){return{baseDamage:t,bonusDamage:0,finalDamage:t,appliedModifiers:[]}}applyAttackModifiers(t,e,n){const i=1+e.value/100,a=Math.floor(t*i);return n.bonusDamage=Math.round(t*(e.value/100)),n.appliedModifiers=[e],a}selectBestTargetForPlayer(t,e){if(e.length===0)return null;let n=null,i=0;for(const a of e){const s=this.calculatePlayerDamageToEnemy(t,a);s>i&&(i=s,n=a)}return n}selectBestTargetForEnemy(t,e){if(e.length===0)return null;let n=null,i=0;for(const a of e){const s=this.calculateEnemyDamageToPlayer(t,a);s>i&&(i=s,n=a)}return n}}class ct{canAttack(t){return!0}calculateDamage(t,e){return T.GENERIC_ENEMY_DAMAGE}processAttack(t,e){const n=this.calculateDamage(t,e),i=!0,a={turn:0,attacker:this.getDisplayName(t),target:e.unit.name,action:`attack and eliminate ${e.unit.name}`,damageDealt:n,eliminated:i};return{damageDealt:n,targetEliminated:i,attackerEliminated:!1,combatAction:a}}isEliminated(t){return!1}getDisplayName(t){return t.name}getStrength(t){return T.GENERIC_ENEMY_DAMAGE}getEnemyType(){return"generic"}getMaxPotentialDamage(t,e){return T.GENERIC_ENEMY_DAMAGE}calculateTotalPotentialDamage(t,e){return T.GENERIC_ENEMY_DAMAGE*e.length}calculateActualDamage(t,e){return{healthLost:e.totalHealth,unitsKilled:e.count}}hasTargetPreference(t){return!1}getTargetPriority(t,e){return 1}canBeCounterAttacked(t){return!1}}class dt{canAttack(t){return!0}calculateDamage(t,e){const n=t.unit.strength,i=this.getBestAttackModifier(t,e);if(i!==0){const a=1+i/100;return Math.floor(n*a)}return n}processAttack(t,e){const i=this.calculateActualDamage(t,e).healthLost,a=i>=e.totalHealth,s={turn:0,attacker:this.getDisplayName(t),target:e.unit.name,action:`attack ${e.unit.name} for ${i} damage${a?" (ELIMINATED)":""}`,damageDealt:i,eliminated:a};return{damageDealt:i,targetEliminated:a,attackerEliminated:!1,combatAction:s}}isEliminated(t){return!1}getDisplayName(t){return t.unit.name}getStrength(t){return t.unit.strength}calculateActualDamage(t,e){const n=this.calculateDamage(t,e),i=Math.min(Math.floor(n/e.unit.health),e.count);return{healthLost:Math.min(n,e.totalHealth),unitsKilled:i}}getBestAttackModifier(t,e){var n;if(!t.unit.attack_modifiers||t.unit.attack_modifiers.length===0)return 0;if((n=e.unit)!=null&&n.unit_types){let i=0;for(const a of t.unit.attack_modifiers)e.unit.unit_types.includes(a.target_type)&&a.modifier_type==="Strength"&&(i=Math.max(i,a.value));return i}return 0}hasTargetPreference(t){return t.unit.attack_modifiers&&t.unit.attack_modifiers.length>0}getTargetPriority(t,e){const i=this.getBestAttackModifier(t,e);return i>0?1+i/100:1}canBeCounterAttacked(t){return!0}getHealth(t){return t.unit.health}getUnitTypes(t){return t.unit.unit_types||[]}getAttackModifiers(t){return t.unit.attack_modifiers||[]}getEnemyType(){return"infinite"}getMaxPotentialDamage(t,e){const n=t.unit.strength;if(!e||e.length===0)return n;let i=n;for(const a of e){const s=this.calculateDamage(t,a);i=Math.max(i,s)}return i}calculateTotalPotentialDamage(t,e){let n=0;for(const i of e)n+=this.calculateDamage(t,i);return n}}class mt{canAttack(t){return t.currentCount>0}calculateDamage(t,e){if(t.currentCount<=0)return 0;const n=t.currentCount*t.unit.strength,i=this.getBestAttackModifier(t,e);if(i!==0){const a=1+i/100;return Math.floor(n*a)}return n}processAttack(t,e){const i=this.calculateActualDamage(t,e).healthLost,a=i>=e.totalHealth,s={turn:0,attacker:this.getDisplayName(t),target:e.unit.name,action:`attack ${e.unit.name} for ${i} damage${a?" (ELIMINATED)":""}`,damageDealt:i,eliminated:a};return{damageDealt:i,targetEliminated:a,attackerEliminated:!1,combatAction:s}}isEliminated(t){return t.currentCount<=0}getDisplayName(t){return`${t.unit.name} (${t.currentCount}/${t.count})`}getStrength(t){return t.currentCount*t.unit.strength}calculateActualDamage(t,e){const n=this.calculateDamage(t,e),i=Math.min(Math.floor(n/e.unit.health),e.count);return{healthLost:Math.min(n,e.totalHealth),unitsKilled:i}}processDamageTaken(t,e){if(e<=0||t.currentCount<=0)return{unitsKilled:0,remainingCount:t.currentCount,enemyEliminated:this.isEliminated(t)};const n=Math.min(Math.floor(e/t.unit.health),t.currentCount);return t.currentCount=Math.max(0,t.currentCount-n),{unitsKilled:n,remainingCount:t.currentCount,enemyEliminated:this.isEliminated(t)}}getBestAttackModifier(t,e){var n;if(!t.unit.attack_modifiers||t.unit.attack_modifiers.length===0)return 0;if((n=e.unit)!=null&&n.unit_types){let i=0;for(const a of t.unit.attack_modifiers)e.unit.unit_types.includes(a.target_type)&&a.modifier_type==="Strength"&&(i=Math.max(i,a.value));return i}return 0}hasTargetPreference(t){return t.unit.attack_modifiers&&t.unit.attack_modifiers.length>0}getTargetPriority(t,e){const i=this.getBestAttackModifier(t,e);return i>0?1+i/100:1}canBeCounterAttacked(t){return t.currentCount>0}getTotalHealth(t){return t.currentCount*t.unit.health}getUnitHealth(t){return t.unit.health}getUnitTypes(t){return t.unit.unit_types||[]}getAttackModifiers(t){return t.unit.attack_modifiers||[]}getCurrentCount(t){return t.currentCount}getOriginalCount(t){return t.count}getEnemyType(){return"mortal"}getMaxPotentialDamage(t,e){if(t.currentCount<=0)return 0;const n=t.currentCount*t.unit.strength;if(!e||e.length===0)return n;let i=n;for(const a of e){const s=this.calculateDamage(t,a);i=Math.max(i,s)}return i}calculateTotalPotentialDamage(t,e){if(t.currentCount<=0)return 0;let n=0;for(const i of e)n+=this.calculateDamage(t,i);return n}resetToOriginalCount(t){t.currentCount=t.count}}const I=class I{constructor(){u(this,"handlers",new Map);this.initializeHandlers()}static getInstance(){return I.instance||(I.instance=new I),I.instance}initializeHandlers(){this.handlers.set("generic",new ct),this.handlers.set("infinite",new dt),this.handlers.set("mortal",new mt)}getHandler(t){const e=this.handlers.get(t);if(!e)throw new Error(`No handler found for enemy type: ${t}`);return e}getHandlerForEnemy(t){return this.getHandler(t.type)}hasHandler(t){return this.handlers.has(t)}getSupportedEnemyTypes(){return Array.from(this.handlers.keys())}validateHandlers(){const t=["generic","infinite","mortal"],e=[];for(const n of t)this.hasHandler(n)||e.push(n);return{isValid:e.length===0,missingTypes:e}}createEnemyConfiguration(t){if(!t.type||typeof t.type!="string")throw new Error("Enemy configuration must have a valid type");const e=t.type;if(!this.hasHandler(e))throw new Error(`Unsupported enemy type: ${e}`);switch(e){case"generic":return this.createGenericEnemy(t);case"infinite":return this.createInfiniteEnemy(t);case"mortal":return this.createMortalEnemy(t);default:throw new Error(`Unknown enemy type: ${e}`)}}createGenericEnemy(t){if(!t.name||typeof t.name!="string")throw new Error("Generic enemy must have a name");return{type:"generic",name:t.name,groupIndex:t.groupIndex||0}}createInfiniteEnemy(t){if(!t.unit||typeof t.unit!="object")throw new Error("Infinite enemy must have unit data");const e=t.unit;if(!e.name||typeof e.name!="string")throw new Error("Infinite enemy unit must have a name");if(typeof e.strength!="number"||e.strength<0)throw new Error("Infinite enemy unit must have valid strength");if(typeof e.health!="number"||e.health<=0)throw new Error("Infinite enemy unit must have valid health");return{type:"infinite",unit:{...e,unit_types:e.unit_types||[],attack_modifiers:e.attack_modifiers||[]},groupIndex:t.groupIndex||0}}createMortalEnemy(t){if(!t.unit||typeof t.unit!="object")throw new Error("Mortal enemy must have unit data");if(typeof t.count!="number"||t.count<=0)throw new Error("Mortal enemy must have a positive count");const e=t.unit;if(!e.name||typeof e.name!="string")throw new Error("Mortal enemy unit must have a name");if(typeof e.strength!="number"||e.strength<0)throw new Error("Mortal enemy unit must have valid strength");if(typeof e.health!="number"||e.health<=0)throw new Error("Mortal enemy unit must have valid health");return{type:"mortal",unit:{...e,unit_types:e.unit_types||[],attack_modifiers:e.attack_modifiers||[]},count:t.count,currentCount:t.currentCount||t.count,groupIndex:t.groupIndex||0}}resetHandlers(){}getHandlerStats(){const t={};for(const[e,n]of this.handlers)t[e]={type:n.getEnemyType(),available:!0};return t}cloneEnemy(t){switch(t.type){case"generic":return{...t};case"infinite":return{...t,unit:{...t.unit}};case"mortal":return{...t,unit:{...t.unit},currentCount:t.count};default:throw new Error(`Cannot clone unknown enemy type: ${t.type}`)}}createMultipleEnemies(t){const e=[];for(let n=0;n<t.length;n++)try{const i=this.createEnemyConfiguration({...t[n],groupIndex:t[n].groupIndex||n});e.push(i)}catch(i){throw new Error(`Error creating enemy at index ${n}: ${i}`)}return e}};u(I,"instance");let H=I;class ut{shouldPlayerActNext(t,e){const n=this.getAvailablePlayerGroups(t),i=this.getAvailableEnemies(t);if(n.length===0)return!1;if(i.length===0)return!0;const a=t.currentAction%2===0;return e?a:!a}getAvailablePlayerGroups(t){return t.playerGroups.filter(e=>e.totalHealth>0&&!t.unitsActedThisTurn.players.has(e.unit.name))}getAvailableEnemies(t){return t.enemies.filter((e,n)=>this.canEnemyAttack(e)&&!t.unitsActedThisTurn.enemies.has(n))}markUnitAsActed(t,e){const n={players:new Set(t.unitsActedThisTurn.players),enemies:new Set(t.unitsActedThisTurn.enemies)};if(this.isPlayerGroup(e))n.players.add(e.unit.name);else{const i=t.enemies.findIndex(a=>a.groupIndex===e.groupIndex);i>=0?n.enemies.add(i):console.warn("Could not find enemy index for marking as acted:",e)}return{...t,currentAction:t.currentAction+1,unitsActedThisTurn:n}}isTurnComplete(t){const e=this.getAvailablePlayerGroups(t),n=this.getAvailableEnemies(t);return e.length===0&&n.length===0}shouldBattleEnd(t){const e=t.playerGroups.filter(i=>i.totalHealth>0),n=t.enemies.filter(i=>this.canEnemyAttack(i));return e.length===0||n.length===0}advanceToNextTurn(t){return{...t,currentTurn:t.currentTurn+1,currentAction:0,unitsActedThisTurn:{players:new Set,enemies:new Set}}}canEnemyAttack(t){switch(t.type){case"generic":return!0;case"infinite":return!0;case"mortal":return t.currentCount>0;default:return!1}}isPlayerGroup(t){return"unit"in t&&"count"in t&&"totalHealth"in t}getTurnStats(t){return{currentTurn:t.currentTurn,currentAction:t.currentAction,actionsThisTurn:t.unitsActedThisTurn.players.size+t.unitsActedThisTurn.enemies.size,playersActedThisTurn:t.unitsActedThisTurn.players.size,enemiesActedThisTurn:t.unitsActedThisTurn.enemies.size,availablePlayerGroups:this.getAvailablePlayerGroups(t).length,availableEnemies:this.getAvailableEnemies(t).length,turnComplete:this.isTurnComplete(t)}}validateTurnState(t){const e=[],n=[];t.currentTurn<1&&e.push(`Invalid turn number: ${t.currentTurn} (should be >= 1)`),t.currentAction<0&&e.push(`Invalid action number: ${t.currentAction} (should be >= 0)`);const i=t.unitsActedThisTurn.players.size+t.unitsActedThisTurn.enemies.size;i>t.currentAction&&n.push(`More units marked as acted (${i}) than current action count (${t.currentAction})`);for(const a of t.unitsActedThisTurn.players){const s=t.playerGroups.find(r=>r.unit.name===a);s?s.totalHealth<=0&&n.push(`Dead player ${a} marked as acted this turn`):n.push(`Player ${a} marked as acted but not found in battle`)}for(const a of t.unitsActedThisTurn.enemies){const s=t.enemies[a];s?this.canEnemyAttack(s)||n.push(`Enemy ${s.type} at index ${a} marked as acted but cannot attack`):n.push(`Enemy at index ${a} marked as acted but not found`)}return{isValid:e.length===0,errors:e,warnings:n}}getAlternationAnalysis(t,e){const n=this.getAvailablePlayerGroups(t),i=this.getAvailableEnemies(t);let a="";const s=n.length+t.unitsActedThisTurn.players.size,r=i.length+t.unitsActedThisTurn.enemies.size,o=Math.max(s+r,t.currentAction);for(let m=0;m<o;m++){const d=this.shouldPlayerActNext({...t,currentAction:m},e);a+=d?"P":"E"}const l="P".repeat(t.unitsActedThisTurn.players.size)+"E".repeat(t.unitsActedThisTurn.enemies.size),c=this.shouldPlayerActNext(t,e)?"player":"enemy";return{expectedPattern:a,actualPattern:l,isCorrectAlternation:!0,nextShouldBe:c}}resetTurn(t){return{...t,currentTurn:1,currentAction:0,unitsActedThisTurn:{players:new Set,enemies:new Set}}}getTurnSummary(t){const e=this.getTurnStats(t);return`Turn ${e.currentTurn}, Action ${e.currentAction}: ${e.playersActedThisTurn}P + ${e.enemiesActedThisTurn}E acted, ${e.availablePlayerGroups}P + ${e.availableEnemies}E available`}}class F{constructor(){u(this,"battleState");u(this,"attackerSelector");u(this,"enemyFactory");u(this,"turnManager");this.attackerSelector=new lt,this.enemyFactory=H.getInstance(),this.turnManager=new ut,this.validateEnemyHandlers()}simulateBattle(t){return this.battleState=new ot(t),this.validateConfiguration(t),this.runBattleLoop(t.playerGoesFirst,t),this.buildBattleResult(t)}runBattleLoop(t,e){let n=0;const i=e.maxBattleTurns??T.MAX_BATTLE_TURNS,a=e.maxActionsPerTurn??T.MAX_ACTIONS_PER_TURN,s=i*a;for(;!this.battleState.isBattleEnded()&&n<s;){const r=this.battleState.getBattleState();this.turnManager.shouldPlayerActNext(r,t)?this.processPlayerAction(r):this.processEnemyAction(r),n++;const l=this.battleState.getBattleState();if(this.turnManager.shouldBattleEnd(l)){const d=this.battleState.checkBattleEndPure(l,i);this.battleState.applyStateUpdate(d);break}const c=this.battleState.checkBattleEndPure(l,i);this.battleState.applyStateUpdate(c);const m=this.battleState.getBattleState();if(!this.battleState.isBattleEnded()&&this.turnManager.isTurnComplete(m)){const d=this.turnManager.advanceToNextTurn(m);this.battleState.applyStateUpdate(d)}}n>=s&&this.battleState.endBattle()}processPlayerAction(t){const e=this.attackerSelector.selectNextPlayerAttack(t);if(!e)return;const n=this.battleState.applyCompleteAttack(t,e);this.battleState.applyStateUpdate(n)}processEnemyAction(t){const e=this.attackerSelector.selectNextEnemyAttack(t);if(!e)return;const n=this.battleState.applyCompleteAttack(t,e);this.battleState.applyStateUpdate(n)}validateEnemyHandlers(){const t=this.enemyFactory.validateHandlers();if(!t.isValid)throw new Error(`Missing enemy type handlers: ${t.missingTypes.join(", ")}`)}validateConfiguration(t){var e;if(!t.playerArmy||!t.playerArmy.stackingOrder||t.playerArmy.stackingOrder.length===0)throw new Error("Player army must have at least one unit group");if(!t.enemies||t.enemies.length===0)throw new Error("Battle must have at least one enemy");for(const n of t.enemies)if(n.type==="mortal"&&(!n.count||n.count<=0))throw new Error(`Mortal enemy ${((e=n.unit)==null?void 0:e.name)||"Unknown"} must have a positive count`)}buildBattleResult(t){const e=this.battleState.getBattleState(),n=t.maxBattleTurns??T.MAX_BATTLE_TURNS,a={result:this.battleState.getBattleOutcome(n),survivingPlayerGroups:this.battleState.getAlivePlayerGroups(),survivingEnemies:this.battleState.getAttackableEnemies(),totalTurns:this.battleState.getCurrentTurn(),totalActions:e.currentAction+(this.battleState.getCurrentTurn()-1)*T.MAX_ACTIONS_PER_TURN};return{outcome:a,combatLog:this.battleState.getCombatLog(),totalDamageDealt:this.battleState.getTotalDamageDealt(),battleDuration:Math.ceil(a.totalTurns)}}getBattleState(){var t;return((t=this.battleState)==null?void 0:t.getBattleState())||{}}isBattleActive(){return this.battleState?!this.battleState.isBattleEnded():!1}}const ht=Object.freeze(Object.defineProperty({__proto__:null,UnifiedBattleSimulation:F},Symbol.toStringTag,{value:"Module"}));class pt{constructor(t){u(this,"algorithm");this.algorithm=t||new gt}setAlgorithm(t){this.algorithm=t}reportProgress(t,e){t.onProgress&&t.onProgress(e)}checkCancellation(t){var e;if((e=t.signal)!=null&&e.aborted)throw new Error("Operation was cancelled by user")}async optimizeForDamage(t,e){const n=performance.now(),i=12e4;console.log(`🎯 Starting damage optimization with ${this.algorithm.name}`),console.log(`📊 Constraints: L:${t.leadershipBudget} D:${t.dominanceBudget} vs ${t.enemyGroupCount} enemies`),console.log(`⏱️ Maximum processing time: ${i/1e3} seconds`),this.reportProgress(t,{phase:"initializing",progress:0,message:"Initializing damage optimizer...",elapsedMs:0}),this.validateOptimizationConstraints(t),this.reportProgress(t,{phase:"generating",progress:10,message:"Generating army combinations...",elapsedMs:performance.now()-n});const a=await this.algorithm.generateCombinations(t,e);console.log(`🔄 Generated ${a.length} army combinations to evaluate`),this.reportProgress(t,{phase:"evaluating",progress:20,message:"Evaluating army combinations...",combinationsGenerated:a.length,totalCombinations:a.length,combinationsEvaluated:0,totalToEvaluate:a.length,elapsedMs:performance.now()-n});const s=[];let r=0;for(let m=0;m<a.length;m++){this.checkCancellation(t);const d=performance.now();if(d-n>i){console.warn(`⏱️ Optimization timeout after ${(d-n)/1e3}s - stopping at ${r} combinations`);break}const h=a[m];try{const p=await this.evaluateArmyComposition(h,t.enemyGroupCount,e,t.specificEnemyUnits);s.push(p),r++}catch(p){console.warn("⚠️ Failed to evaluate army composition:",p)}if(r%3===0&&await new Promise(p=>setTimeout(p,0)),r%10===0||r===a.length){const p=performance.now()-n,g=20+Math.floor(r/a.length*60),v=r>0?p/r*(a.length-r):void 0;this.reportProgress(t,{phase:"evaluating",progress:g,message:`Evaluating combinations... (${r}/${a.length})`,combinationsGenerated:a.length,totalCombinations:a.length,combinationsEvaluated:r,totalToEvaluate:a.length,elapsedMs:p,estimatedRemainingMs:v})}if(r%25===0){const p=(performance.now()-n)/1e3;console.log(`📊 Progress: ${r}/${a.length} combinations (${p.toFixed(1)}s elapsed)`)}}this.reportProgress(t,{phase:"finalizing",progress:90,message:"Finalizing results...",combinationsGenerated:a.length,totalCombinations:a.length,combinationsEvaluated:r,totalToEvaluate:a.length,elapsedMs:performance.now()-n});const o=s.sort((m,d)=>{const h=d.averageDamagePerBattle-m.averageDamagePerBattle;return Math.abs(h)>.01?h:d.damageEfficiencyScore-m.damageEfficiencyScore}),c=performance.now()-n;return console.log(`✅ Optimization complete: ${o.length} valid results in ${c.toFixed(2)}ms`),this.reportProgress(t,{phase:"finalizing",progress:100,message:"Optimization complete!",combinationsGenerated:a.length,totalCombinations:a.length,combinationsEvaluated:r,totalToEvaluate:a.length,elapsedMs:c}),{rankedResults:o,combinationsEvaluated:r,optimizationTimeMs:c,algorithmUsed:this.algorithm.name,wasTruncated:a.length>(t.maxCombinations||50)}}async evaluateArmyComposition(t,e,n,i){const a=new F;let s;if(i&&i.length>0){const g=i.map((C,k)=>({type:C.isMortal?"mortal":"infinite",unit:{name:C.name,strength:C.strength,health:C.health,unit_types:C.unit_types||[],attack_modifiers:C.attack_modifiers||[]},count:C.count||1,currentCount:C.count||1,groupIndex:k})),v={playerArmy:{stackingOrder:JSON.parse(JSON.stringify(t.stackingOrder)),totalStrength:t.totalStrength,totalHealth:t.totalHealth},enemies:JSON.parse(JSON.stringify(g)),playerGoesFirst:!0},y=a.simulateBattle(v),S={playerArmy:{stackingOrder:JSON.parse(JSON.stringify(t.stackingOrder)),totalStrength:t.totalStrength,totalHealth:t.totalHealth},enemies:JSON.parse(JSON.stringify(g)),playerGoesFirst:!1},x=a.simulateBattle(S);s={bestCase:y,worstCase:x}}else{const g=Array.from({length:e},(C,k)=>({type:"generic",name:`Generic Enemy ${k+1}`,groupIndex:k})),v={playerArmy:{stackingOrder:JSON.parse(JSON.stringify(t.stackingOrder)),totalStrength:t.totalStrength,totalHealth:t.totalHealth},enemies:JSON.parse(JSON.stringify(g)),playerGoesFirst:!0},y=a.simulateBattle(v),S={playerArmy:{stackingOrder:JSON.parse(JSON.stringify(t.stackingOrder)),totalStrength:t.totalStrength,totalHealth:t.totalHealth},enemies:JSON.parse(JSON.stringify(g)),playerGoesFirst:!1},x=a.simulateBattle(S);s={bestCase:y,worstCase:x}}const r=this.calculateSilverCost(t,n),o=this.calculateFoodConsumption(t,n),l=this.calculateRevivalCost(t,n),c=s.bestCase.totalDamageDealt,m=s.worstCase.totalDamageDealt,d=(c+m)/2,h=t.totalLeadershipCost+t.totalDominanceCost+r,p=h>0?d/h:0;return{armyComposition:t,battleAnalysis:s,totalSilverCost:r,totalFoodConsumption:o,totalRevivalCost:l,averageDamagePerBattle:d,damageEfficiencyScore:p}}calculateSilverCost(t,e){const n=new Map(e.map(a=>[a.name,a]));let i=0;for(const[a,s]of Object.entries(t.units)){const r=n.get(a);r&&(i+=(r.revival_cost_silver??0)*s)}return i}calculateFoodConsumption(t,e){const n=new Map(e.map(a=>[a.name,a]));let i=0;for(const[a,s]of Object.entries(t.units)){const r=n.get(a);r&&(i+=(r.food_consumption??0)*s)}return i}calculateRevivalCost(t,e){return this.calculateSilverCost(t,e)}validateOptimizationConstraints(t){if(t.enemyGroupCount<1||t.enemyGroupCount>100)throw new Error("Enemy group count must be between 1 and 100");if(t.leadershipBudget<0)throw new Error("Leadership budget cannot be negative");if(t.dominanceBudget<0)throw new Error("Dominance budget cannot be negative");if(!t.availableUnits||t.availableUnits.length===0)throw new Error("At least one unit type must be available for optimization");if(t.maxCombinations&&t.maxCombinations<1)throw new Error("Maximum combinations must be at least 1")}}class gt{constructor(){u(this,"name","Systematic Combination Testing")}async generateCombinations(t,e){const n=performance.now(),i=6e4;console.log("🔍 Generating combinations using systematic testing algorithm");const a=e.filter(l=>t.availableUnits.includes(l.name));console.log(`📋 Available units for optimization: ${a.length}`);const s=t.maxCombinations||50,r=this.generateUnitCombinations(a.map(l=>l.name),s);console.log(`🔄 Testing ${r.length} different unit combinations (user requested: ${s})`);const o=[];for(let l=0;l<r.length;l++){const c=performance.now();if(c-n>i){console.warn(`⏱️ Generation timeout after ${(c-n)/1e3}s - stopping at ${l} combinations`);break}const m=r[l];try{const d=await this.testCombinationWithStackingAlgorithm(m,t,e);d&&o.push(d)}catch(d){console.warn(`⚠️ Failed to test combination [${m.join(", ")}]:`,d)}if(l%5===0&&await new Promise(d=>setTimeout(d,0)),l%20===0&&l>0){const d=(performance.now()-n)/1e3;console.log(`🔄 Generation progress: ${l}/${r.length} combinations tested (${d.toFixed(1)}s)`)}}return console.log(`✅ Generated ${o.length} valid army combinations for evaluation`),o}generateUnitCombinations(t,e){const n=Math.pow(2,t.length)-1;if(console.log(`📊 Total possible combinations: ${n}, user requested: ${e}`),n>e)return this.generateLimitedCombinations(t,e);const i=[];for(let a=1;a<=n;a++){const s=[];for(let r=0;r<t.length;r++)a&1<<r&&s.push(t[r]);i.push(s)}return i.sort((a,s)=>s.length-a.length),console.log(`🎯 Generated all ${i.length} combinations, ordered largest to smallest`),console.log(`   User requested: ${e} combinations (all possible combinations fit within limit)`),i}generateLimitedCombinations(t,e){const n=[];n.push([...t]);for(let i=0;i<t.length&&n.length<e;i++){const a=t.filter((s,r)=>r!==i);n.push(a)}for(let i=0;i<t.length&&n.length<e;i++)for(let a=i+1;a<t.length&&n.length<e;a++){const s=t.filter((r,o)=>o!==i&&o!==a);s.length>0&&n.push(s)}for(let i=0;i<t.length&&n.length<e;i++)for(let a=i+1;a<t.length&&n.length<e;a++)for(let s=a+1;s<t.length&&n.length<e;s++){const r=t.filter((o,l)=>l!==i&&l!==a&&l!==s);r.length>0&&n.push(r)}if(n.length<e){const i=Math.floor(t.length/2);for(let s=0;s<10&&n.length<e;s++){const r=this.getRandomCombination(t,i);n.some(o=>o.length===r.length&&o.every(l=>r.includes(l)))||n.push(r)}const a=Math.max(1,Math.floor(t.length/4));for(let s=0;s<5&&n.length<e;s++){const r=this.getRandomCombination(t,a);n.some(o=>o.length===r.length&&o.every(l=>r.includes(l)))||n.push(r)}}return console.log(`🎯 Generated ${n.length} top-down combinations from ${t.length} units`),console.log(`   Strategy: Started with all ${t.length} units, then systematically removed units`),console.log(`   User requested: ${e} combinations (time-based limits still apply)`),n}getRandomCombination(t,e){return[...t].sort(()=>Math.random()-.5).slice(0,e)}async testCombinationWithStackingAlgorithm(t,e,n){try{const i=new O(n),a={leadershipBudget:e.leadershipBudget,dominanceBudget:e.dominanceBudget,mercenaryLimits:e.mercenaryLimits,availableUnits:t},s=await i.optimizeArmy(a);return s.compositions&&s.compositions.length>0?s.compositions[0]:null}catch(i){return console.warn(`Failed to test combination [${t.join(", ")}]:`,i),null}}}class K{constructor(){u(this,"enemyUnits",[]);u(this,"enemyUnitsByName",new Map);u(this,"enemyUnitsByType",new Map);this.resetData()}async loadPresetEnemyUnits(){return this.loadEnemyUnits(Y.ENEMY_UNITS)}async loadEnemyUnits(t){try{let e;if(typeof t=="string"){console.log(`Loading enemy units from: ${t}`);const n=await fetch(t);if(!n.ok)throw new Error(`Failed to fetch enemy units: ${n.status} ${n.statusText}`);e=await n.json()}else e=t;if(!Array.isArray(e))throw new Error("Enemy unit data must be an array");return this.enemyUnits=e.map(n=>this.validateAndNormalizeEnemyUnit(n)),this.buildLookups(),console.log(`✅ Loaded ${this.enemyUnits.length} enemy units successfully`),this.enemyUnits}catch(e){throw console.error("❌ Error loading enemy units:",e),e}}validateAndNormalizeEnemyUnit(t){const e={name:t.name||"Unknown Enemy",unit_types:Array.isArray(t.unit_types)?t.unit_types:[],health:Number(t.health)||0,strength:Number(t.strength)||0,attack_modifiers:Array.isArray(t.attack_modifiers)?t.attack_modifiers:[]};return(!Array.isArray(e.unit_types)||e.unit_types.length===0)&&(console.warn(`Enemy unit ${e.name} has no unit types, adding 'Unknown'`),e.unit_types=["Unknown"]),e.health<=0&&(console.warn(`Enemy unit ${e.name} has invalid health: ${e.health}`),e.health=1),e.strength<0&&(console.warn(`Enemy unit ${e.name} has negative strength: ${e.strength}`),e.strength=0),e.attack_modifiers&&Array.isArray(e.attack_modifiers)&&(e.attack_modifiers=e.attack_modifiers.filter(n=>!n||typeof n!="object"?(console.warn(`Enemy unit ${e.name} has invalid attack modifier object`),!1):!n.target_type||typeof n.value!="number"?(console.warn(`Enemy unit ${e.name} has invalid attack modifier: ${JSON.stringify(n)}`),!1):!0)),e}buildLookups(){this.resetData(),this.enemyUnitsByName=new Map(this.enemyUnits.map(t=>[t.name,t])),this.enemyUnits.forEach(t=>{t.unit_types.forEach(e=>{this.enemyUnitsByType.has(e)||this.enemyUnitsByType.set(e,[]),this.enemyUnitsByType.get(e).push(t)})}),this.enemyUnitsByType.forEach(t=>{t.sort((e,n)=>n.strength-e.strength)})}resetData(){this.enemyUnitsByName.clear(),this.enemyUnitsByType.clear()}getAllEnemyUnits(){return[...this.enemyUnits]}getEnemyUnitByName(t){return this.enemyUnitsByName.get(t)}getEnemyUnitsByType(t){return[...this.enemyUnitsByType.get(t)||[]]}getUniqueEnemyUnitTypes(){return Array.from(this.enemyUnitsByType.keys()).sort()}filterEnemyUnits(t){let e=this.enemyUnits;return t.unitTypes&&t.unitTypes.length>0&&(e=e.filter(n=>t.unitTypes.some(i=>n.unit_types.includes(i)))),t.minStrength!==void 0&&(e=e.filter(n=>n.strength>=t.minStrength)),t.maxStrength!==void 0&&(e=e.filter(n=>n.strength<=t.maxStrength)),t.minHealth!==void 0&&(e=e.filter(n=>n.health>=t.minHealth)),t.maxHealth!==void 0&&(e=e.filter(n=>n.health<=t.maxHealth)),e}searchEnemyUnits(t){if(!t.trim())return this.getAllEnemyUnits();const e=t.toLowerCase();return this.enemyUnits.filter(n=>n.name.toLowerCase().includes(e))}getEnhancedEnemyUnits(){return this.enemyUnits.map(t=>({...t,get strengthPerHealth(){return f.getStrengthPerHealth(t)},get effectivenessScore(){return f.getEffectivenessScore(t)}}))}getEnemyUnitSummary(){if(this.enemyUnits.length===0)return{totalUnits:0,byUnitType:{},strengthRange:{min:0,max:0,average:0},healthRange:{min:0,max:0,average:0}};const t=this.enemyUnits.map(i=>i.strength),e=this.enemyUnits.map(i=>i.health),n={};return this.enemyUnitsByType.forEach((i,a)=>{n[a]=i.length}),{totalUnits:this.enemyUnits.length,byUnitType:n,strengthRange:{min:Math.min(...t),max:Math.max(...t),average:Math.round(t.reduce((i,a)=>i+a,0)/t.length)},healthRange:{min:Math.min(...e),max:Math.max(...e),average:Math.round(e.reduce((i,a)=>i+a,0)/e.length)}}}getStatistics(){if(this.enemyUnits.length===0)return{totalUnits:0,unitTypeDistribution:{},strengthStats:{min:0,max:0,avg:0},healthStats:{min:0,max:0,avg:0},topUnitsByStrength:[],topUnitsByHealth:[],unitsWithAttackModifiers:0};const t=this.enemyUnits.map(a=>a.strength),e=this.enemyUnits.map(a=>a.health),n={};this.enemyUnitsByType.forEach((a,s)=>{n[s]=a.length});const i=this.enemyUnits.filter(a=>a.attack_modifiers&&Array.isArray(a.attack_modifiers)&&a.attack_modifiers.length>0).length;return{totalUnits:this.enemyUnits.length,unitTypeDistribution:n,strengthStats:{min:Math.min(...t),max:Math.max(...t),avg:Math.round(t.reduce((a,s)=>a+s,0)/t.length)},healthStats:{min:Math.min(...e),max:Math.max(...e),avg:Math.round(e.reduce((a,s)=>a+s,0)/e.length)},topUnitsByStrength:[...this.enemyUnits].sort((a,s)=>s.strength-a.strength).slice(0,10),topUnitsByHealth:[...this.enemyUnits].sort((a,s)=>s.health-a.health).slice(0,10),unitsWithAttackModifiers:i}}getEnemyUnitsWithModifiersAgainst(t){return this.enemyUnits.filter(e=>!e.attack_modifiers||!Array.isArray(e.attack_modifiers)?!1:t.some(n=>e.attack_modifiers.some(i=>i.target_type.toLowerCase()===n.toLowerCase())))}getMostEffectiveAgainst(t,e=5){return this.enemyUnits.map(n=>({unit:n,effectiveness:this.calculateEffectivenessAgainst(n,t)})).sort((n,i)=>i.effectiveness-n.effectiveness).slice(0,e).map(n=>n.unit)}calculateEffectivenessAgainst(t,e){let n=f.getEffectivenessScore(t);return t.attack_modifiers&&Array.isArray(t.attack_modifiers)&&e.forEach(i=>{const a=f.getAttackModifierAgainst(t,i);n+=a*.1}),n}}const D=class D{constructor(t={}){u(this,"storageKey");u(this,"metadataKey");u(this,"maxUnits");u(this,"validateOnLoad");this.storageKey=t.storagePrefix?`${t.storagePrefix}_user_enemy_units`:D.DEFAULT_STORAGE_KEY,this.metadataKey=t.storagePrefix?`${t.storagePrefix}_enemy_units_metadata`:D.METADATA_KEY,this.maxUnits=t.maxUnits||D.DEFAULT_MAX_UNITS,this.validateOnLoad=t.validateOnLoad!==!1}isStorageAvailable(){try{const t="__storage_test__";return localStorage.setItem(t,t),localStorage.removeItem(t),!0}catch{return!1}}getAllUserEnemyUnits(){if(!this.isStorageAvailable())return console.warn("localStorage is not available"),[];try{const t=localStorage.getItem(this.storageKey);if(!t)return[];const n=JSON.parse(t).map(i=>({...i,createdAt:new Date(i.createdAt),modifiedAt:new Date(i.modifiedAt)}));return this.validateOnLoad?n.filter(i=>{const a=U.validateUserEnemyUnit(i);return a.isValid?!0:(console.warn(`Invalid stored enemy unit removed: ${i.name}`,a.errors),!1)}):n}catch(t){return console.error("Error loading user enemy units from storage:",t),[]}}saveAllUserEnemyUnits(t){if(!this.isStorageAvailable())return console.warn("localStorage is not available"),!1;try{return localStorage.setItem(this.storageKey,JSON.stringify(t)),this.updateMetadata(),!0}catch(e){return console.error("Error saving user enemy units to storage:",e),!1}}addUserEnemyUnit(t){const e=U.validateEnemyUnit(t);if(!e.isValid)return{success:!1,error:`Validation failed: ${e.errors.join(", ")}`};const n=this.getAllUserEnemyUnits();if(n.length>=this.maxUnits)return{success:!1,error:`Maximum number of units (${this.maxUnits}) reached`};if(n.some(s=>s.name.toLowerCase()===t.name.toLowerCase()))return{success:!1,error:`A unit with the name "${t.name}" already exists`};const i=f.createUserEnemyUnit(t);return n.push(i),this.saveAllUserEnemyUnits(n)?{success:!0,unit:i}:{success:!1,error:"Failed to save unit to storage"}}updateUserEnemyUnit(t,e){const n=this.getAllUserEnemyUnits(),i=n.findIndex(c=>c.id===t);if(i===-1)return{success:!1,error:"Unit not found"};const a=n[i],s={...a,...e},r=U.validateUserEnemyUnit(s);if(!r.isValid)return{success:!1,error:`Validation failed: ${r.errors.join(", ")}`};if(e.name&&n.some((c,m)=>m!==i&&c.name.toLowerCase()===e.name.toLowerCase()))return{success:!1,error:`A unit with the name "${e.name}" already exists`};const o=f.updateUserEnemyUnit(a,e);return n[i]=o,this.saveAllUserEnemyUnits(n)?{success:!0,unit:o}:{success:!1,error:"Failed to save updated unit to storage"}}deleteUserEnemyUnit(t){const e=this.getAllUserEnemyUnits(),n=e.findIndex(a=>a.id===t);return n===-1?{success:!1,error:"Unit not found"}:(e.splice(n,1),this.saveAllUserEnemyUnits(e)?{success:!0}:{success:!1,error:"Failed to save changes to storage"})}getUserEnemyUnitById(t){return this.getAllUserEnemyUnits().find(n=>n.id===t)||null}searchUserEnemyUnits(t){const e=this.getAllUserEnemyUnits();if(!t.trim())return e;const n=t.toLowerCase();return e.filter(i=>i.name.toLowerCase().includes(n))}clearAllUserEnemyUnits(){if(!this.isStorageAvailable())return{success:!1,error:"localStorage is not available"};try{return localStorage.removeItem(this.storageKey),localStorage.removeItem(this.metadataKey),{success:!0}}catch{return{success:!1,error:"Failed to clear storage"}}}exportUserEnemyUnits(){try{const t=this.getAllUserEnemyUnits(),e={version:"1.0",exportDate:new Date().toISOString(),units:t.map(n=>{var i,a;return{name:n.name,unit_types:n.unit_types,health:n.health,strength:n.strength,attack_modifiers:n.attack_modifiers,createdAt:((i=n.createdAt)==null?void 0:i.toISOString())??new Date().toISOString(),modifiedAt:((a=n.modifiedAt)==null?void 0:a.toISOString())??new Date().toISOString()}})};return{success:!0,data:JSON.stringify(e,null,2)}}catch{return{success:!1,error:"Failed to export units"}}}importUserEnemyUnits(t,e={}){try{const n=JSON.parse(t);if(!n.units||!Array.isArray(n.units))return{success:!1,errors:["Invalid import format: units array not found"]};const i=e.replace?[]:this.getAllUserEnemyUnits(),a=[];let s=0,r=0;for(const l of n.units){const c=U.validateForImport(l);if(!c.isValid){a.push(`Unit "${l.name||"Unknown"}": ${c.errors.join(", ")}`),r++;continue}if(i.some(h=>h.name.toLowerCase()===l.name.toLowerCase()))if(e.skipDuplicates){r++;continue}else{a.push(`Unit "${l.name}" already exists`),r++;continue}if(i.length>=this.maxUnits){a.push(`Maximum number of units (${this.maxUnits}) reached`);break}const d=f.createUserEnemyUnit({name:l.name,unit_types:l.unit_types,health:l.health,strength:l.strength,attack_modifiers:l.attack_modifiers||[]});i.push(d),s++}return this.saveAllUserEnemyUnits(i)?{success:!0,imported:s,skipped:r,errors:a.length>0?a:void 0}:{success:!1,errors:["Failed to save imported units to storage"]}}catch{return{success:!1,errors:["Invalid JSON format"]}}}getStorageStats(){var s;const t=this.getAllUserEnemyUnits(),e=new Date;e.setHours(0,0,0,0);const n=t.filter(r=>r.createdAt&&r.createdAt>=e).length;let i=null;t.length>0&&(i=new Date(Math.max(...t.map(r=>{var o;return((o=r.modifiedAt)==null?void 0:o.getTime())??0}))));const a=this.isStorageAvailable()?(((s=localStorage.getItem(this.storageKey))==null?void 0:s.length)||0)*2:0;return{totalUnits:t.length,storageSize:a,lastModified:i,unitsCreatedToday:n}}updateMetadata(){if(this.isStorageAvailable())try{const t={lastModified:new Date().toISOString(),version:"1.0"};localStorage.setItem(this.metadataKey,JSON.stringify(t))}catch(t){console.warn("Failed to update metadata:",t)}}getAvailableSpace(){return Math.max(0,this.maxUnits-this.getAllUserEnemyUnits().length)}isNearCapacity(t=.9){return this.getAllUserEnemyUnits().length>=this.maxUnits*t}};u(D,"DEFAULT_STORAGE_KEY","army_calculator_user_enemy_units"),u(D,"METADATA_KEY","army_calculator_enemy_units_metadata"),u(D,"DEFAULT_MAX_UNITS",100);let N=D;class J{constructor(t){u(this,"container",null);u(this,"props");u(this,"loader");u(this,"storage");u(this,"presetUnits",[]);u(this,"userUnits",[]);u(this,"filteredUnits",[]);u(this,"currentFilter","");u(this,"currentCategory","all");u(this,"currentSelectedUnits",[]);this.props=t,this.loader=new K,this.storage=new N,this.currentSelectedUnits=t.selectedUnits?[...t.selectedUnits]:[]}async mount(t){this.container=t,await this.loadData(),this.render(),this.attachEventListeners()}async loadData(){try{this.presetUnits=await this.loader.loadPresetEnemyUnits(),this.userUnits=this.storage.getAllUserEnemyUnits(),this.updateFilteredUnits()}catch(t){console.error("Error loading enemy unit data:",t),this.presetUnits=[],this.userUnits=[],this.filteredUnits=[]}}updateFilteredUnits(){let t=[];switch(this.currentCategory){case"preset":t=[...this.presetUnits];break;case"user":t=[...this.userUnits];break;case"all":default:t=[...this.presetUnits,...this.userUnits];break}if(this.currentFilter.trim()){const e=this.currentFilter.toLowerCase();this.filteredUnits=t.filter(n=>n.name.toLowerCase().includes(e)||n.unit_types.some(i=>i.toLowerCase().includes(e)))}else this.filteredUnits=t;this.filteredUnits.sort((e,n)=>e.name.localeCompare(n.name))}render(){if(!this.container)return;const t=this.props.title||"Select Enemy Unit";this.container.innerHTML=`
    ...
    `,this.addStyles()}renderUnitList(){return this.filteredUnits.length===0?`
      ...
      `:this.filteredUnits.map(t=>{var i;const e=this.props.mode==="multiple"?this.currentSelectedUnits.some(a=>a.name===t.name):((i=this.props.selectedUnit)==null?void 0:i.name)===t.name,n="id"in t;return`
          ...
          <div class="unit-card-header">
            <div class="unit-info">
              ...
              <div class="unit-types">
                ${t.unit_types.map(a=>`<span class="unit-type-tag">${a}</span>`).join("")}
              </div>
            </div>
            ...
            ${t.attack_modifiers&&t.attack_modifiers.length>0?`
              <div class="attack-modifiers">
                ...
                <div class="modifiers-list">
                  ${t.attack_modifiers.map(a=>`<span class="modifier-tag">+${a.value.toLocaleString()} vs ${a.target_type}</span>`).join("")}
                </div>
              </div>
            `:""}
          </div>
    ...
    `});this.unifiedBattleService=new F}mount(t,e){this.container=t,this.currentArmy=e,this.render(),this.attachEventListeners(),this.showSimulationControls()}initialize(t){}render(){this.container&&(this.container.innerHTML=`
    ...
    `,document.head.appendChild(t)}displayPreCalculatedResults(t){if(console.log("BattleSimulationComponent: displayPreCalculatedResults called",t),console.log("BattleSimulationComponent: bestCase structure:",t.bestCase),console.log("BattleSimulationComponent: worstCase structure:",t.worstCase),!this.container){console.log("BattleSimulationComponent: no container");return}if(t.bestCase&&t.worstCase)this.currentBestCase=t.bestCase,this.currentWorstCase=t.worstCase,console.log("BattleSimulationComponent: currentBestCase totalDamageDealt:",this.currentBestCase.totalDamageDealt),console.log("BattleSimulationComponent: currentWorstCase totalDamageDealt:",this.currentWorstCase.totalDamageDealt);else{console.warn("BattleSimulationComponent: Invalid battle analysis format");return}const e=this.container.querySelector("#simulation-results");if(!e){console.log("BattleSimulationComponent: simulation-results container not found");return}console.log("BattleSimulationComponent: found results container",e),e.classList.remove("hidden"),this.displayResults(),this.showResults(!0);const n=this.container.querySelector(".simulation-controls"),i=this.container.querySelector(".enemy-input-container");n&&(n.style.display="none"),i&&(i.style.display="none");const a=this.container.querySelector("#simulation-note");a&&(a.innerHTML=`
      ...
      `,a.classList.remove("hidden"))}showSimulationControls(){if(!this.container)return;const t=this.container.querySelector(".simulation-controls"),e=this.container.querySelector(".enemy-input-container");t&&(t.style.display="block"),e&&(e.style.display="block")}}class w{static convertToStackingGroups(t){return t.stackingOrder.filter(e=>e.count>0).sort((e,n)=>e.totalHealth-n.totalHealth)}static convertToBattleConfiguration(t){const e=this.convertToStackingGroups(t.playerArmy),n=t.enemyArmy.stackingOrder.filter(i=>i.count>0).reduce((i,a)=>i+Math.min(a.count,100),0);return{playerArmy:{units:{},stackingOrder:e,totalStrength:e.reduce((i,a)=>i+a.count*a.unit.strength,0),totalHealth:e.reduce((i,a)=>i+a.totalHealth,0),totalLeadershipCost:0,totalDominanceCost:0,totalMercenaryCount:0,isValidStacking:!0,efficiencyScore:0},enemyGroupCount:Math.min(n,100),playerGoesFirst:t.playerGoesFirst}}static validateArmyConfiguration(t){const e=[],n=[];let i=0,a=!1;t.stackingOrder.length===0&&e.push("Army must have at least one unit type");for(const o of t.stackingOrder){if(!o.unit){e.push("Invalid unit configuration");continue}o.count<=0?e.push(`Unit "${o.unit.name}" must have a positive quantity`):o.count>1e4&&n.push(`Unit "${o.unit.name}" has a very large quantity (${o.count})`),i+=o.count,o.count>1e5&&(a=!0)}!a&&i>5e4&&n.push(`Army size is very large (${i} total units). This may affect performance.`);const s=t.stackingOrder.map(o=>o.unit.name),r=s.filter((o,l)=>s.indexOf(o)!==l);return r.length>0&&e.push(`Duplicate units found: ${Array.from(new Set(r)).join(", ")}`),{isValid:e.length===0,errors:e,warnings:n,totalUnits:i,hasInfiniteUnits:a}}static createEmptyArmy(t,e){return{stackingOrder:[],totalStrength:0,totalHealth:0,name:e,side:t}}static addUnitToArmy(t,e,n,i=!1){const a=i?_.INFINITE_UNIT_VALUE:n,s=e.health*a,r=t.stackingOrder.findIndex(d=>d.unit.name===e.name),o=[...t.stackingOrder],l={count:a,totalHealth:s,unit:e};r>=0?o[r]=l:o.push(l);const c=o.reduce((d,h)=>d+h.count*h.unit.strength,0),m=o.reduce((d,h)=>d+h.totalHealth,0);return{...t,stackingOrder:o,totalStrength:c,totalHealth:m}}static removeUnitFromArmy(t,e){const n=t.stackingOrder.filter(s=>s.unit.name!==e),i=n.reduce((s,r)=>s+r.count*r.unit.strength,0),a=n.reduce((s,r)=>s+r.totalHealth,0);return{...t,stackingOrder:n,totalStrength:i,totalHealth:a}}static getArmySummary(t){if(t.stackingOrder.length===0)return"No units configured";const e=t.stackingOrder.length,n=t.stackingOrder.filter(a=>a.count>1e5).length,i=t.stackingOrder.filter(a=>a.count<=1e5).reduce((a,s)=>a+s.count,0);return n>0?`${e} unit types (${n} infinite, ${i} finite)`:`${e} unit types, ${i} total units`}}const _={MAX_FINITE_UNITS:1e4,MAX_ARMY_UNIT_TYPES:50,INFINITE_UNIT_VALUE:999999999,MAX_ENEMY_GROUPS:100};class yt{constructor(t){u(this,"container",null);u(this,"props");u(this,"playerUnitSelection",this.createEmptySelection());u(this,"enemyUnitSelection",this.createEmptySelection());this.props=t}mount(t){this.container=t,this.render(),this.attachEventListeners()}unmount(){this.container&&(this.container.innerHTML="",this.container=null)}updateProps(t){this.props={...this.props,...t},this.container&&((t.playerArmy||t.enemyArmy)&&this.updateArmyLists(),(t.availableUnits||t.availableEnemyUnits||t.disabled!==void 0)&&(this.render(),this.attachEventListeners()))}createEmptySelection(){return{selectedUnit:null,quantity:1,isInfinite:!1,isValid:!1}}render(){this.container&&(this.container.innerHTML=`
    ...
    `,this.addStyles())}renderUnitOptions(t="player"){return(t==="player"?this.props.availableUnits:this.props.availableEnemyUnits||this.props.availableUnits).sort((n,i)=>n.name.localeCompare(i.name)).map(n=>`
      ...
      `).join("")}getUnitTooltip(t){return`Health: ${t.health}, Strength: ${t.strength}, Types: ${t.unit_types.join(", ")}`}renderArmyList(t,e){return t.stackingOrder.length===0?'<p class="empty-army">No units added</p>':t.stackingOrder.map(n=>{const i=n.count>=_.INFINITE_UNIT_VALUE;return`
    ...
    `,n.classList.remove("hidden")}resetPlayerSelection(){var n,i;this.playerUnitSelection=this.createEmptySelection();const t=(n=this.container)==null?void 0:n.querySelector("#player-unit-select"),e=(i=this.container)==null?void 0:i.querySelector("#player-quantity");t&&(t.value=""),e&&(e.value="1")}resetEnemySelection(){var i,a,s;this.enemyUnitSelection=this.createEmptySelection();const t=(i=this.container)==null?void 0:i.querySelector("#enemy-unit-select"),e=(a=this.container)==null?void 0:a.querySelector("#enemy-quantity"),n=(s=this.container)==null?void 0:s.querySelector("#enemy-infinite");t&&(t.value=""),e&&(e.value="1",e.disabled=!1),n&&(n.checked=!1)}addStyles(){const t="dual-army-input-styles";if(document.getElementById(t))return;const e=document.createElement("style");e.id=t,e.textContent=`
      .dual-army-input {
        max-width: 1200px;
        margin: 0 auto;
      }
...
`)}`),alert(i)}}handleClearAll(){if(this.userUnits.length===0){alert("No units to clear.");return}if(confirm(`Are you sure you want to delete ALL ${this.userUnits.length} custom enemy units? This action cannot be undone.`)){const t=this.storage.clearAllUserEnemyUnits();t.success?(this.selectedUnits.clear(),this.loadData(),this.refreshUnitsList(),alert("All custom enemy units have been deleted.")):alert(`Failed to clear units: ${t.error}`)}}downloadJson(t,e){const n=new Blob([t],{type:"application/json"}),i=URL.createObjectURL(n),a=document.createElement("a");a.href=i,a.download=e,document.body.appendChild(a),a.click(),document.body.removeChild(a),URL.revokeObjectURL(i)}refreshUnitsList(){const t=document.getElementById("units-list");t&&(t.innerHTML=this.renderUnitsList(),document.querySelectorAll(".unit-select-checkbox").forEach(n=>{n.addEventListener("change",this.handleCheckboxChange.bind(this))}),document.querySelectorAll("[data-action]").forEach(n=>{n.addEventListener("click",this.handleUnitAction.bind(this))}));const e=document.querySelector(".results-info");e&&(e.textContent=`Showing ${this.filteredUnits.length} of ${this.userUnits.length} units${this.selectedUnits.size>0?` (${this.selectedUnits.size} selected)`:""}`)}refreshSelectionUI(){document.querySelectorAll(".unit-select-checkbox").forEach(i=>{const a=i,s=a.dataset.unitId;s&&(a.checked=this.selectedUnits.has(s))}),document.querySelectorAll(".unit-item").forEach(i=>{const a=i.dataset.unitId;a&&(this.selectedUnits.has(a)?i.classList.add("selected"):i.classList.remove("selected"))});const t=document.getElementById("bulk-actions-btn");t&&(t.textContent=`📋 Bulk Actions (${this.selectedUnits.size})`,t.disabled=this.selectedUnits.size===0);const e=document.getElementById("select-none");e&&(e.disabled=this.selectedUnits.size===0);const n=document.querySelector(".results-info");n&&(n.textContent=`Showing ${this.filteredUnits.length} of ${this.userUnits.length} units${this.selectedUnits.size>0?` (${this.selectedUnits.size} selected)`:""}`)}unmount(){this.container&&(this.container.innerHTML="")}}const j={tabletSmall:768,tabletLarge:1024};class St{constructor(){u(this,"currentMode","desktop");u(this,"listeners",[]);this.updateLayoutMode(),this.setupResizeListener()}getCurrentMode(){return this.currentMode}isMobile(){return this.currentMode==="mobile"}isTablet(){return this.currentMode==="tablet"}isDesktop(){return this.currentMode==="desktop"}isTouchDevice(){return"ontouchstart"in window||navigator.maxTouchPoints>0}getViewportWidth(){return window.innerWidth}addLayoutChangeListener(t){this.listeners.push(t)}removeLayoutChangeListener(t){const e=this.listeners.indexOf(t);e>-1&&this.listeners.splice(e,1)}updateLayoutMode(){const t=this.getViewportWidth();let e;t<j.tabletSmall?e="mobile":t<j.tabletLarge?e="tablet":e="desktop",e!==this.currentMode&&(this.currentMode=e,this.notifyListeners())}setupResizeListener(){let t;window.addEventListener("resize",()=>{clearTimeout(t),t=window.setTimeout(()=>{this.updateLayoutMode()},150)})}notifyListeners(){this.listeners.forEach(t=>t(this.currentMode))}}class P{static addSwipeSupport(t,e,n,i=50){if(!("ontouchstart"in window))return;let a=0,s=0,r=0;t.addEventListener("touchstart",o=>{const l=o.touches[0];a=l.clientX,s=l.clientY,r=Date.now()},{passive:!0}),t.addEventListener("touchend",o=>{if(o.changedTouches.length===0)return;const l=o.changedTouches[0],c=l.clientX,m=l.clientY,d=Date.now(),h=c-a,p=m-s;d-r<500&&Math.abs(h)>i&&Math.abs(p)<Math.abs(h)*.5&&(h>0&&n?(o.preventDefault(),n()):h<0&&e&&(o.preventDefault(),e()))},{passive:!1})}static addTouchSupport(t,e){if(t.addEventListener("click",e),"ontouchstart"in window){let n;t.addEventListener("touchstart",i=>{n=Date.now(),t.classList.add("touch-active")}),t.addEventListener("touchend",i=>{t.classList.remove("touch-active"),Date.now()-n<200&&(i.preventDefault(),e())}),t.addEventListener("touchcancel",()=>{t.classList.remove("touch-active")})}}static optimizeScrolling(t){t.style.webkitOverflowScrolling="touch",t.style.scrollBehavior="smooth",t.classList.add("scroll-momentum")}static addHapticFeedback(t){t.addEventListener("touchstart",()=>{t.style.transform="scale(0.98)",t.style.transition="transform 0.1s ease"}),t.addEventListener("touchend",()=>{t.style.transform="scale(1)"}),t.addEventListener("touchcancel",()=>{t.style.transform="scale(1)"})}static addPullToRefresh(t,e,n=80){if(!("ontouchstart"in window))return;let i=0,a=0,s=!1,r=null;const o=()=>{r||(r=document.createElement("div"),r.className="pull-refresh-indicator",r.innerHTML=`
    ...
    `,document.head.appendChild(t)}static cleanup(){this.observers.forEach(t=>t.disconnect()),this.observers.clear(),this.rafId&&(cancelAnimationFrame(this.rafId),this.rafId=null)}}u(M,"metrics",{renderTime:0,interactionTime:0,scrollPerformance:0}),u(M,"observers",new Map),u(M,"rafId",null);E.isMobile()&&document.addEventListener("DOMContentLoaded",()=>{M.initialize(),M.addMobileCSSOptimizations()});E.addLayoutChangeListener(b=>{b!=="mobile"?M.cleanup():(M.initialize(),M.addMobileCSSOptimizations())});class L{static initialize(){this.createScreenReaderAnnouncer(),this.setupFocusManagement(),this.enhanceTabNavigation(),this.addTouchAccessibility(),this.setupKeyboardNavigation()}static createScreenReaderAnnouncer(){this.announcer||(this.announcer=document.createElement("div"),this.announcer.setAttribute("aria-live","polite"),this.announcer.setAttribute("aria-atomic","true"),this.announcer.className="sr-only",this.announcer.style.cssText=`
    ...
    `,document.head.appendChild(t)}async loadInitialData(){try{await this.unitLoader.loadPresetUnits(),this.displayUnitList(),this.updateOptimizeButton()}catch(t){console.error("Failed to load unit data:",t)}}attachEventListeners(){const t=document.getElementById("stacking-mode-btn"),e=document.getElementById("damage-mode-btn"),n=document.getElementById("enemy-units-btn"),i=document.getElementById("unit-search"),a=document.getElementById("unit-type-filter"),s=document.getElementById("optimize-btn"),r=document.getElementById("clear-btn"),o=document.getElementById("select-all-visible"),l=document.getElementById("clear-selection"),c=document.getElementById("leadership-budget"),m=document.getElementById("dominance-budget"),d=document.getElementById("select-enemy-units-btn"),h=document.getElementById("enemy-count");t&&t.addEventListener("click",()=>this.switchMode("stacking")),e&&e.addEventListener("click",()=>this.switchMode("damage")),n&&n.addEventListener("click",()=>this.switchMode("enemy-units"));const p=document.getElementById("manual-battle-btn");p&&p.addEventListener("click",()=>this.switchMode("manual-battle")),d&&d.addEventListener("click",()=>this.openEnemyUnitSelector()),i&&i.addEventListener("input",()=>this.filterAndDisplayUnits()),a&&a.addEventListener("change",()=>this.filterAndDisplayUnits()),s&&s.addEventListener("click",()=>this.optimizeArmy()),r&&r.addEventListener("click",()=>this.clearSelection()),o&&o.addEventListener("click",()=>this.selectAllVisible()),l&&l.addEventListener("click",()=>this.clearSelection()),c&&c.addEventListener("input",()=>this.updateOptimizeButton()),m&&m.addEventListener("input",()=>this.updateOptimizeButton()),h&&h.addEventListener("input",()=>this.handleEnemyGroupsChange()),document.addEventListener("click",g=>{const v=g.target;v.classList.contains("filter-tab")&&this.handleFilterTabClick(v)})}displayUnitList(){this.setupUnitTypeFilter(),this.updateFilterTabCounts(),this.filterAndDisplayUnits()}setupUnitTypeFilter(){const t=document.getElementById("unit-type-filter");if(!t)return;const e=this.unitLoader.getUniqueUnitTypes();t.innerHTML='<option value="">All Unit Types</option>',e.forEach(n=>{const i=document.createElement("option");i.value=n,i.textContent=n,t.appendChild(i)})}updateFilterTabCounts(){const t=this.unitLoader.getAllUnits();document.querySelectorAll(".filter-tab").forEach(n=>{const i=n.getAttribute("data-filter");let a=0;i==="all"?a=t.length:a=t.filter(s=>this.getMainCategory(s)===i).length,n.textContent=`${i==="all"?"All":i} (${a})`})}handleFilterTabClick(t){document.querySelectorAll(".filter-tab").forEach(e=>e.classList.remove("active")),t.classList.add("active"),this.filterAndDisplayUnits()}filterAndDisplayUnits(){var a,s,r;const t=((a=document.getElementById("unit-search"))==null?void 0:a.value)||"",e=((s=document.querySelector(".filter-tab.active"))==null?void 0:s.getAttribute("data-filter"))||"all",n=((r=document.getElementById("unit-type-filter"))==null?void 0:r.value)||"";let i=this.unitLoader.getAllUnits();if(e!=="all"&&(i=i.filter(o=>this.getMainCategory(o)===e)),n&&(i=i.filter(o=>o.unit_types.includes(n))),t){const o=t.toLowerCase();i=i.filter(l=>l.name.toLowerCase().includes(o)||l.unit_types.some(c=>c.toLowerCase().includes(o)))}this.renderGroupedUnits(i),this.updateSelectedSummary()}renderGroupedUnits(t){const e=document.getElementById("unit-groups");if(!e)return;if(e.innerHTML="",t.length===0){e.innerHTML='<div class="no-units">No units match your filters</div>';return}const n=this.createHierarchicalGroups(t);Object.entries(n).forEach(([i,a])=>{const s=this.createMainCategoryElement(i,a);e.appendChild(s)}),this.attachAllEventListeners(n)}createHierarchicalGroups(t){const e={Guardsmen:{},Specialists:{},"Engineer Corps":{},Monsters:{},Mercenaries:{}};return t.forEach(n=>{const i=this.getMainCategory(n),a=this.getSubCategory(n),s=this.getUnitFamily(n);e[i][a]||(e[i][a]={}),e[i][a][s]||(e[i][a][s]=[]),e[i][a][s].push(n)}),Object.values(e).forEach(n=>{Object.values(n).forEach(i=>{Object.values(i).forEach(a=>{a.sort((s,r)=>s.strength-r.strength)})})}),e}getMainCategory(t){if(t.cost_type==="Mercenary"||(t.authority_cost??0)>0)return"Mercenaries";const e=t.unit_types;return e.includes("Engineer corps")||e.includes("Siege engine")?"Engineer Corps":e.includes("Guardsman")?"Guardsmen":e.includes("Specialist")?"Specialists":e.includes("Beast")||e.includes("Dragon")||e.includes("Giant")||e.includes("Elemental")||e.includes("ELEMENTAL")||e.includes("Flying")&&!e.includes("Human")?"Monsters":e.includes("Human")&&(e.includes("Melee")||e.includes("Ranged")||e.includes("Mounted"))?"Guardsmen":"Specialists"}getSubCategory(t){const e=t.unit_types,n=t.name.toUpperCase(),i=this.getMainCategory(t);if(i==="Mercenaries")return e.includes("Guardsman")?"Elite Forces":"Special Forces";if(i==="Engineer Corps"){if(n.includes("CATAPULT"))return"Catapults";if(n.includes("BALLISTA"))return"Ballistae";if(n.includes("JOSEPHINE"))return"Heavy Artillery";if(e.includes("Siege engine"))return"Siege Engines"}if(i==="Monsters"){if(e.includes("Dragon"))return"Dragons";if(e.includes("Giant"))return"Giants";if(e.includes("Beast"))return"Beasts";if(e.includes("Elemental")||e.includes("ELEMENTAL"))return"Elementals";if(e.includes("Flying"))return"Flying"}if(i==="Guardsmen"||i==="Specialists"){if(e.includes("Ranged"))return"Ranged";if(e.includes("Melee"))return"Melee";if(e.includes("Mounted"))return"Mounted";if(e.includes("Flying")||e.includes("Beast"))return"Flying";if(e.includes("Scout"))return"Scouts"}return e.includes("Human")?"Infantry":"Other"}getUnitFamily(t){let e=t.name;return e=e.replace(/\s+(I{1,3}|IV|V|VI{0,2}|VII)$/,""),e.includes("HEAVY "),e}createMainCategoryElement(t,e){const n=document.createElement("div");n.className="main-category";const i=this.countUnitsInCategory(e),a=this.countSelectedUnitsInCategory(e);return n.innerHTML=`
      ...
      <div class="main-category-content collapsed">
        ${Object.entries(e).map(([s,r])=>this.createSubCategoryHTML(t,s,r)).join("")}
      </div>
    `,n}createSubCategoryHTML(t,e,n){const i=Object.values(n).reduce((s,r)=>s+r.length,0),a=Object.values(n).reduce((s,r)=>s+r.filter(o=>this.selectedUnits.has(o.name)).length,0);return`
    ...
    `}attachAllEventListeners(t){document.querySelectorAll(".main-category").forEach((e,n)=>{const a=Object.keys(t)[n];if(a){const s=t[a];this.attachMainCategoryListeners(e,a,s)}}),document.querySelectorAll(".sub-category").forEach(e=>{var a;const n=e.getAttribute("data-category"),i=e.getAttribute("data-subcategory");if(n&&i&&((a=t[n])!=null&&a[i])){const s=t[n][i];this.attachSubCategoryListeners(e,s)}}),document.querySelectorAll(".unit-family").forEach(e=>{const n=e.getAttribute("data-family");let i=[];Object.values(t).forEach(a=>{Object.values(a).forEach(s=>{s[n]&&(i=s[n])})}),i.length>0&&this.attachUnitFamilyListeners(e,i)})}countUnitsInCategory(t){return Object.values(t).reduce((e,n)=>e+Object.values(n).reduce((i,a)=>i+a.length,0),0)}countSelectedUnitsInCategory(t){return Object.values(t).reduce((e,n)=>e+Object.values(n).reduce((i,a)=>i+a.filter(s=>this.selectedUnits.has(s.name)).length,0),0)}attachMainCategoryListeners(t,e,n){const i=t.querySelector(".main-category-header"),a=t.querySelector(".main-category-content"),s=t.querySelector(".expand-icon");if(!i||!a||!s){console.warn("Missing main-category elements for",e,{header:!!i,content:!!a,expandIcon:!!s});return}i.addEventListener("click",l=>{if(l.target.classList.contains("btn")){l.stopPropagation();return}console.log("Main category header clicked:",e,"collapsed:",a.classList.contains("collapsed")),a.classList.toggle("collapsed"),s.textContent=a.classList.contains("collapsed")?"▼":"▲"});const r=t.querySelector(".select-category"),o=t.querySelector(".deselect-category");r&&r.addEventListener("click",l=>{l.stopPropagation(),this.selectAllInCategory(n)}),o&&o.addEventListener("click",l=>{l.stopPropagation(),this.deselectAllInCategory(n)})}attachSubCategoryListeners(t,e){const n=t.querySelector(".sub-category-header"),i=t.querySelector(".sub-category-content"),a=t.querySelector(".expand-icon");if(!n||!i||!a){console.warn("Missing sub-category elements:",{header:!!n,content:!!i,expandIcon:!!a});return}n.addEventListener("click",o=>{if(o.target.classList.contains("btn")){o.stopPropagation();return}console.log("Sub-category header clicked, toggling:",i.classList.contains("collapsed")),i.classList.toggle("collapsed"),a.textContent=i.classList.contains("collapsed")?"▼":"▲"});const s=t.querySelector(".select-subcategory"),r=t.querySelector(".deselect-subcategory");s&&s.addEventListener("click",o=>{o.stopPropagation(),this.selectAllInFamilies(e)}),r&&r.addEventListener("click",o=>{o.stopPropagation(),this.deselectAllInFamilies(e)})}attachUnitFamilyListeners(t,e){const n=t.querySelector(".unit-family-header"),i=t.querySelector(".unit-family-content"),a=t.querySelector(".expand-icon");n.addEventListener("click",l=>{l.target.classList.contains("btn")||(i.classList.toggle("collapsed"),a.textContent=i.classList.contains("collapsed")?"▼":"▲")});const s=t.querySelector(".select-family"),r=t.querySelector(".deselect-family");s&&s.addEventListener("click",l=>{l.stopPropagation(),this.selectAllUnits(e)}),r&&r.addEventListener("click",l=>{l.stopPropagation(),this.deselectAllUnits(e)}),t.querySelectorAll(".unit-card").forEach(l=>{l.addEventListener("click",()=>{const c=l.getAttribute("data-unit");if(c){const m=this.unitLoader.getUnitByName(c);m&&this.toggleUnitSelection(m)}})})}getUnitCost(t){switch(t.cost_type){case"Leadership":return t.leadership_cost??0;case"Dominance":return t.dominance_cost??0;case"Authority":case"Mercenary":return t.authority_cost??0;default:return 0}}toggleUnitSelection(t){this.selectedUnits.has(t.name)?(this.selectedUnits.delete(t.name),(t.cost_type==="Mercenary"||t.cost_type==="Authority")&&delete this.mercenaryLimits[t.name]):(this.selectedUnits.add(t.name),(t.cost_type==="Mercenary"||t.cost_type==="Authority")&&(this.mercenaryLimits[t.name]=1)),this.updateSelectionDisplay(),this.updateMercenaryLimits(),this.updateOptimizeButton(),E.isMobile()&&this.addFloatingActionButton()}updateSelectionDisplay(){document.querySelectorAll(".unit-card").forEach(t=>{const e=t.getAttribute("data-unit");e&&(this.selectedUnits.has(e)?t.classList.add("selected"):t.classList.remove("selected"))}),this.updateAllCounters(),this.updateSelectedSummary()}updateAllCounters(){document.querySelectorAll(".main-category").forEach((t,e)=>{const n=t.querySelector(".category-title h3");if(n){const a=["Guardsmen","Specialists","Engineer Corps","Monsters","Mercenaries"][e];if(a){const{selected:s,total:r}=this.countUnitsInMainCategory(a),l=(n.textContent||"").replace(/\s*\(\d+\/\d+\)/,"");n.textContent=`${l} (${s}/${r})`}}}),document.querySelectorAll(".sub-category").forEach(t=>{const e=t.querySelector(".subcategory-title h4"),n=t.getAttribute("data-category"),i=t.getAttribute("data-subcategory");if(e&&n&&i){const{selected:a,total:s}=this.countUnitsInSubCategory(n,i),o=(e.textContent||"").replace(/\s*\(\d+\/\d+\)/,"");e.textContent=`${o} (${a}/${s})`}}),document.querySelectorAll(".unit-family").forEach(t=>{const e=t.querySelector(".family-title h5"),n=t.getAttribute("data-family");if(e&&n){const{selected:i,total:a}=this.countUnitsInFamily(n),r=(e.textContent||"").replace(/\s*\(\d+\/\d+\)/,"");e.textContent=`${r} (${i}/${a})`}})}countUnitsInMainCategory(t){const n=this.unitLoader.getAllUnits().filter(a=>this.getMainCategory(a)===t);return{selected:n.filter(a=>this.selectedUnits.has(a.name)).length,total:n.length}}countUnitsInSubCategory(t,e){const i=this.unitLoader.getAllUnits().filter(s=>this.getMainCategory(s)===t&&this.getSubCategory(s)===e);return{selected:i.filter(s=>this.selectedUnits.has(s.name)).length,total:i.length}}countUnitsInFamily(t){const n=this.unitLoader.getAllUnits().filter(a=>this.getUnitFamily(a)===t);return{selected:n.filter(a=>this.selectedUnits.has(a.name)).length,total:n.length}}updateSelectedSummary(){const t=document.getElementById("selected-count");t&&(t.textContent=`${this.selectedUnits.size} units selected`)}selectAllVisible(){document.querySelectorAll(".unit-card").forEach(e=>{const n=e.getAttribute("data-unit");if(n){const i=this.unitLoader.getUnitByName(n);i&&(this.selectedUnits.add(i.name),(i.cost_type==="Mercenary"||i.cost_type==="Authority")&&(this.mercenaryLimits[i.name]=1))}}),this.filterAndDisplayUnits(),this.updateMercenaryLimits(),this.updateOptimizeButton()}selectAllInCategory(t){Object.values(t).forEach(e=>{this.selectAllInFamilies(e)})}deselectAllInCategory(t){Object.values(t).forEach(e=>{this.deselectAllInFamilies(e)})}selectAllInFamilies(t){Object.values(t).forEach(e=>{this.selectAllUnits(e)})}deselectAllInFamilies(t){Object.values(t).forEach(e=>{this.deselectAllUnits(e)})}selectAllUnits(t){t.forEach(e=>{this.selectedUnits.add(e.name),(e.cost_type==="Mercenary"||e.cost_type==="Authority")&&(this.mercenaryLimits[e.name]=1)}),this.updateSelectionDisplay(),this.updateMercenaryLimits(),this.updateOptimizeButton()}deselectAllUnits(t){t.forEach(e=>{this.selectedUnits.delete(e.name),(e.cost_type==="Mercenary"||e.cost_type==="Authority")&&delete this.mercenaryLimits[e.name]}),this.updateSelectionDisplay(),this.updateMercenaryLimits(),this.updateOptimizeButton()}updateMercenaryLimits(){const t=document.getElementById("mercenary-limits");if(!t)return;const e=Array.from(this.selectedUnits).map(n=>this.unitLoader.getUnitByName(n)).filter(n=>n&&(n.cost_type==="Mercenary"||n.cost_type==="Authority"));if(e.length===0){t.innerHTML='<p class="text-muted">Select mercenary units to set limits</p>';return}t.innerHTML="",e.forEach(n=>{if(!n)return;const i=document.createElement("div");i.className="mercenary-item";const a=n.cost_type==="Authority"?"⚔️":"🗡️",s=n.cost_type==="Authority"?`AUTH: ${n.authority_cost}`:`AUTH: ${n.authority_cost}`;i.innerHTML=`
      ...
      `,i.querySelector("input").addEventListener("change",o=>{const l=o.target;this.mercenaryLimits[l.dataset.unit]=parseInt(l.value)||1}),t.appendChild(i)})}updateOptimizeButton(){const t=document.getElementById("optimize-btn"),e=document.getElementById("leadership-budget"),n=document.getElementById("dominance-budget");if(!t||!e||!n)return;const i=this.selectedUnits.size>0,a=parseInt(e.value)>0||parseInt(n.value)>0||Object.keys(this.mercenaryLimits).length>0;t.disabled=!i||!a}async optimizeArmy(){try{this.currentMode==="stacking"?(this.showLoadingModal(),await this.optimizeForStacking(),this.hideLoadingModal()):await this.optimizeForDamage()}catch(t){console.error("Optimization failed:",t),alert("Optimization failed. Please check your inputs and try again."),this.hideLoadingModal(),this.hideProgressModal()}}async optimizeForStacking(){const t=this.unitLoader.getAvailableUnits(Array.from(this.selectedUnits));this.optimizer=new O(t);const e=document.getElementById("leadership-budget"),n=document.getElementById("dominance-budget"),i={leadershipBudget:parseInt(e.value)||0,dominanceBudget:parseInt(n.value)||0,mercenaryLimits:{...this.mercenaryLimits},availableUnits:Array.from(this.selectedUnits)},a=await this.optimizer.optimizeArmy(i);this.displayStackingResults(a)}async optimizeForDamage(){const t=this.unitLoader.getAvailableUnits(Array.from(this.selectedUnits)),e=document.getElementById("leadership-budget"),n=document.getElementById("dominance-budget"),i=document.getElementById("enemy-count"),a=document.getElementById("max-combinations"),s={leadershipBudget:parseInt(e.value)||0,dominanceBudget:parseInt(n.value)||0,mercenaryLimits:{...this.mercenaryLimits},availableUnits:Array.from(this.selectedUnits),enemyGroupCount:parseInt(i.value)||5,maxCombinations:parseInt(a.value)||50,specificEnemyUnits:this.selectedEnemyUnits.length>0?[...this.selectedEnemyUnits]:void 0};await this.runDamageOptimizationWithProgress(s,t)}async runDamageOptimizationWithProgress(t,e){this.optimizationAbortController=new AbortController,E.isMobile()?B.showMobileLoading("Optimizing army composition..."):this.showProgressModal();try{this.damageOptimizer||(this.damageOptimizer=new pt);const n={...t,signal:this.optimizationAbortController.signal,onProgress:a=>{this.updateProgressModal(a.progress,a.message,{combinationsEvaluated:a.combinationsEvaluated,totalToEvaluate:a.totalToEvaluate,phase:a.phase,estimatedRemainingMs:a.estimatedRemainingMs})}},i=await this.damageOptimizer.optimizeForDamage(n,e);await this.delay(500),E.isMobile()?B.hideMobileLoading():this.hideProgressModal(),this.displayDamageResults(i)}catch(n){E.isMobile()?B.hideMobileLoading():this.hideProgressModal(),n instanceof Error&&n.message.includes("cancelled")?console.log("Optimization cancelled by user"):(console.error("Damage optimization failed:",n),alert(`Optimization failed: ${n instanceof Error?n.message:"Unknown error"}`))}}delay(t){return new Promise(e=>setTimeout(e,t))}displayStackingResults(t){const e=document.getElementById("optimization-stats"),n=document.getElementById("army-compositions"),i=document.getElementById("results-section"),a=document.getElementById("stacking-results"),s=document.getElementById("damage-results");!e||!n||!i||(a&&a.classList.remove("hidden"),s&&s.classList.add("hidden"),e.innerHTML=`
      <div class="stat-card">
    ...
    `,n.innerHTML="",t.rankedResults.length===0?n.innerHTML='<p class="text-center text-muted">No valid army compositions found. Try adjusting your constraints.</p>':t.rankedResults.slice(0,10).forEach((o,l)=>{const c=this.createDamageArmyElement(o,l+1);n.appendChild(c)}),i.classList.remove("hidden"),A.showSection("results-section"),E.isMobile()||setTimeout(()=>{i.scrollIntoView({behavior:"smooth",block:"start"})},100)}showBattleSimulationWithResults(t){const e=document.getElementById("battle-simulation-container");!e||!this.currentOptimizedArmy||(e.classList.remove("hidden"),A.showSection("battle-simulation-container"),this.battleSimulation||(this.battleSimulation=new G,this.battleSimulation.initialize(this.unitLoader),this.battleSimulation.mount(e,this.currentOptimizedArmy)),this.battleSimulation.displayPreCalculatedResults(t),E.isMobile()||e.scrollIntoView({behavior:"smooth",block:"nearest"}))}showBattleSimulation(){if(!this.currentOptimizedArmy)return;const t=document.getElementById("battle-simulation-container");t&&(t.classList.remove("hidden"),this.battleSimulation||(this.battleSimulation=new G,this.battleSimulation.initialize(this.unitLoader)),this.battleSimulation.mount(t,this.currentOptimizedArmy),A.showSection("battle-simulation-container"),E.isMobile()||setTimeout(()=>{t.scrollIntoView({behavior:"smooth",block:"start"})},100))}createCompositionElement(t,e){var l;const n=document.createElement("div");n.className="army-composition";const i=((l=this.optimizer)==null?void 0:l.explainStacking(t))||"No stacking explanation available",a=`
...
`).map(c=>c.includes("🏆 OPTIMIZED ARMY COMPOSITION")?`<h3 class="army-title">${c}</h3>`:c.includes("═".repeat(60))?'<hr class="title-divider">':c.includes("📊 ARMY SUMMARY")||c.includes("🗡️ MERCENARY FORCES")||c.includes("👑 LEADERSHIP FORCES")||c.includes("⚡ DOMINANCE FORCES")||c.includes("⚔️ BATTLE ORDER")?`<h4 class="section-header">${c}</h4>`:c.includes("─".repeat(30))||c.includes("─".repeat(40))?'<hr class="section-divider">':c.includes("└─")?`<div class="unit-detail">${c}</div>`:c.trim()&&!c.includes("═")&&!c.includes("─")?`<div class="unit-line">${c}</div>`:c.trim()===""?'<div class="spacing"></div>':"").filter(c=>c!=="").join(""),r=`
    ...
    `;n.innerHTML=a+'<div class="composition-content">'+s+"</div>"+r;const o=n.querySelector(".simulate-btn");return o&&o.addEventListener("click",()=>{this.currentOptimizedArmy=t,this.showBattleSimulation()}),n}createDamageArmyElement(t,e){const n=document.createElement("div");n.className="damage-army-card",n.setAttribute("data-army-index",(e-1).toString());const i=t.armyComposition.totalDominanceCost===0?"Leadership":t.armyComposition.totalLeadershipCost===0?"Dominance":"Mixed",a=i==="Leadership"?"🛡️":i==="Dominance"?"👹":"⚔️";return n.addEventListener("click",()=>this.selectDamageArmy(t,e-1)),n.innerHTML=`
      ...
      <div class="damage-army-content">
        <div class="army-composition-summary">
          ...
          <div class="unit-list">
            ${Object.entries(t.armyComposition.units).map(([s,r])=>`<div class="unit-item">
...
`).map(o=>o.trim()===""?'<div class="spacing"></div>':o.includes("Total")||o.includes("Budget")?`<div class="summary-line"><strong>${o}</strong></div>`:o.includes("→")?`<div class="unit-line">${o}</div>`:o.includes("✓")||o.includes("Valid")?`<div class="validation-line success">${o}</div>`:`<div class="explanation-line">${o}</div>`).join("")}
    ...
    `,e.classList.remove("hidden"),e.scrollIntoView({behavior:"smooth",block:"nearest"})}formatCombatLog(t){return!t||t.length===0?'<div class="no-combat-log">No combat actions recorded</div>':t.map((e,n)=>{const i=e.attacker&&!e.attacker.includes("Enemy");return`
      ...
      `,document.body.appendChild(t);const e=document.getElementById("cancel-optimization-btn");e&&e.addEventListener("click",()=>{this.cancelOptimization()})}t.classList.remove("hidden"),this.optimizationStartTime=performance.now(),this.updateProgressModal(0,"Initializing..."),this.startProgressTimer()}updateProgressModal(t,e,n){const i=document.getElementById("progress-fill"),a=document.getElementById("progress-text"),s=document.getElementById("progress-percentage"),r=document.getElementById("progress-combinations"),o=document.getElementById("progress-phase"),l=document.getElementById("progress-remaining");if(i&&(i.style.width=`${t}%`),a&&(a.textContent=e),s&&(s.textContent=`${Math.round(t)}%`),r&&n){const c=n.combinationsEvaluated||0,m=n.totalToEvaluate||0;r.textContent=`${c.toLocaleString()} / ${m.toLocaleString()} combinations`}if(o&&(n!=null&&n.phase)&&(o.textContent=n.phase.charAt(0).toUpperCase()+n.phase.slice(1)),l&&(n!=null&&n.estimatedRemainingMs)){const c=Math.ceil(n.estimatedRemainingMs/1e3),m=Math.floor(c/60),d=c%60;l.textContent=`(~${m}:${d.toString().padStart(2,"0")} remaining)`}else l&&(l.textContent="")}startProgressTimer(){this.progressUpdateInterval=window.setInterval(()=>{const t=performance.now()-this.optimizationStartTime,e=Math.floor(t/1e3),n=Math.floor(e/60),i=e%60,a=document.getElementById("progress-elapsed");a&&(a.textContent=`${n.toString().padStart(2,"0")}:${i.toString().padStart(2,"0")}`)},1e3)}stopProgressTimer(){this.progressUpdateInterval&&(clearInterval(this.progressUpdateInterval),this.progressUpdateInterval=null)}cancelOptimization(){this.optimizationAbortController&&(this.optimizationAbortController.abort(),this.hideProgressModal(),alert("Optimization cancelled by user."))}hideProgressModal(){const t=document.getElementById("progress-modal");t&&t.classList.add("hidden"),this.stopProgressTimer(),this.optimizationAbortController=null}initializeMobileOptimizations(){$.optimizeCombatLogs(),$.optimizeUnitCards(),this.addTouchSupportToUnitCards(),E.addLayoutChangeListener(t=>{this.handleLayoutModeChange(t)})}addTouchSupportToUnitCards(){document.querySelectorAll(".unit-card").forEach(e=>{e instanceof HTMLElement&&P.addHapticFeedback(e)})}handleLayoutModeChange(t){setTimeout(()=>{$.optimizeCombatLogs(),$.optimizeUnitCards(),this.addTouchSupportToUnitCards(),t==="mobile"&&this.initializeAdvancedMobileFeatures()},100)}initializeAdvancedMobileFeatures(){E.isMobile()&&(M.initialize(),L.initialize(),this.addPullToRefresh(),this.addFloatingActionButton(),L.enhanceFormAccessibility(),setTimeout(()=>{L.addDynamicLabels()},500))}addPullToRefresh(){const t=document.querySelector(".main-content");t&&P.addPullToRefresh(t,async()=>{L.announce("Refreshing data..."),await new Promise(e=>setTimeout(e,1e3)),$.optimizeCombatLogs(),$.optimizeUnitCards(),L.addDynamicLabels(),L.announce("Data refreshed")})}addFloatingActionButton(){this.selectedUnits.size>0?B.showFloatingActionButton({icon:"⚡",label:"Quick Optimize",onClick:()=>{L.announce("Starting quick optimization"),this.optimizeArmy()},position:"bottom-right",color:"primary"}):B.hideFloatingActionButton()}initializeEnemyUnitsManager(){const t=document.getElementById("enemy-units-container");t&&(this.enemyUnitManager||(this.enemyUnitManager=new Et({mode:"embedded"})),this.enemyUnitManager.mount(t))}async initializeManualBattleSimulation(){const t=document.getElementById("manual-battle-container");t&&(this.manualBattleSimulation||(this.manualBattleSimulation=new bt({unitLoader:this.unitLoader,onBattleComplete:e=>{console.log("Manual battle completed:",e)}})),await this.manualBattleSimulation.mount(t))}openEnemyUnitSelector(){const t=document.getElementById("enemy-count"),e=parseInt((t==null?void 0:t.value)||"5");V(async()=>{const{EnemyUnitSelector:n}=await Promise.resolve().then(()=>ft);return{EnemyUnitSelector:n}},void 0).then(({EnemyUnitSelector:n})=>{const i=document.createElement("div");i.id="enemy-unit-selector-modal",i.style.position="fixed",i.style.top="0",i.style.left="0",i.style.right="0",i.style.bottom="0",i.style.zIndex="2000",document.body.appendChild(i);const a=new n({onSelect:s=>{this.handleEnemyUnitSelected(s)},onCancel:()=>{this.closeEnemyUnitSelector(i,a)},mode:"multiple",title:`Select Enemy Units for Battle Optimization (${this.selectedEnemyUnits.length}/${e} selected)`,maxSelections:e,selectedUnits:[...this.selectedEnemyUnits]});this.currentEnemyUnitSelector=a,this.currentEnemyUnitSelectorContainer=i,a.mount(i)}).catch(n=>{console.error("Failed to load EnemyUnitSelector:",n),alert("Failed to open enemy unit selector. Please try again.")})}handleEnemyUnitSelected(t){const e=document.getElementById("enemy-count"),n=parseInt((e==null?void 0:e.value)||"5"),i=this.selectedEnemyUnits.findIndex(a=>a.name===t.name);i>=0?this.selectedEnemyUnits.splice(i,1):this.selectedEnemyUnits.length<n?this.selectedEnemyUnits.push(t):(this.selectedEnemyUnits.shift(),this.selectedEnemyUnits.push(t)),this.updateEnemyUnitDisplay(),this.updateEnemyUnitSelectorTitle()}closeEnemyUnitSelector(t,e){try{e&&typeof e.unmount=="function"&&e.unmount(),t&&t.parentNode&&t.parentNode.removeChild(t),this.currentEnemyUnitSelector=null,this.currentEnemyUnitSelectorContainer=null}catch(n){console.error("Error closing enemy unit selector:",n)}}updateEnemyUnitSelectorTitle(){if(this.currentEnemyUnitSelector&&typeof this.currentEnemyUnitSelector.updateTitle=="function"){const t=document.getElementById("enemy-count"),e=parseInt((t==null?void 0:t.value)||"5"),n=`Select Enemy Units for Battle Optimization (${this.selectedEnemyUnits.length}/${e} selected)`;this.currentEnemyUnitSelector.updateTitle(n),typeof this.currentEnemyUnitSelector.updateSelectedUnits=="function"&&this.currentEnemyUnitSelector.updateSelectedUnits(this.selectedEnemyUnits)}}handleEnemyGroupsChange(){if(this.currentMode==="damage"){const t=document.getElementById("enemy-count"),e=t&&parseInt(t.value)||1;this.selectedEnemyUnits.length>e&&(this.selectedEnemyUnits=this.selectedEnemyUnits.slice(0,e)),this.updateEnemyUnitDisplay(),this.updateEnemyUnitSelectorTitle()}}updateEnemyUnitDisplay(){const t=document.getElementById("select-enemy-units-btn");if(t){const e=document.getElementById("enemy-count"),n=parseInt((e==null?void 0:e.value)||"5");if(this.selectedEnemyUnits.length===0)t.innerHTML=`
          👹 Select Enemy Units
